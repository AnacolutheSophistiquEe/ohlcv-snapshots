...
**Generated** : 2026-08-13T00:30:02.025812+00:00  
...
**Subtitle** : indeterminate · volatilite low · $9.59  

> 🟡 **WAIT-FOR-DIP** — spot +1.6 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot $9.59 (+1.6% vs entrée) · entrée $9.44 · stop $9.22 · T1 $9.66 · R/R 1.0  
> ↳ P(T1 av. stop) 47 % _(réel 5 s)_ · EV/risk 0.057 _(réel 5 s)_ (GBM 0.058) · ¼-Kelly 0.023 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −2.26% cohérent avec le bruit 5 s (EV-optimal ≈ −1.5%)  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal 153 % hors [0,100] (R² max 0.96). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- Entry (zone de repli) : $9.39–$9.48 (mid $9.44)
- Spot actuel : $9.59 (+1.6% au-dessus de la zone — repli à attendre)
- Stop : $9.22 (stop swing_plan-based (-12.52%))
- Targets : T1 $9.66 · R/R 1.0 | T2 $10.02 · R/R 2.64 | T3 $10.38 · R/R 4.27
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $9.22


## Edge, scénarios & sizing

- EV/risk : 0.058 | EV/share : $0.012 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 50 % | T2 33 % | T3 33 %
...
- Régime probabiliste (posterior HMM, intraday) : bull 62.8 | bear 8.8 | side 28.4  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 288.0 (= 30 part(s) × prix) · cible 288.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −1.611% → cible +2.429% / stop −2.255%, p_fill 79%, n_eff≈30.8) : P(cible|rempli) **47%** · **EV/risk +0.057** (×p_fill ; si rempli +0.16% du capital)
  - **swing** (entrée dip −3.54% → cible +18.62% / stop −9.309%, p_fill 62%, n_eff≈28.2) : P(cible|rempli) **9%** · **EV/risk -0.030** (×p_fill ; si rempli -0.45% du capital)
  - **deep** (entrée dip −5.463% → cible +30.711% / stop −15.356%, p_fill 77%, n_eff≈29.3) : P(cible|rempli) **7%** · **EV/risk +0.119** (×p_fill ; si rempli +2.38% du capital)
...
- **MACD** : hist 0.208  _(pas de croisement recent)_
- **BB** : %B 0.79 · largeur 33.2%
- **ATR** : 0.71 (13.0e pct 1a)  _(volatilite basse)_
- **OBV/CMF** : OBV rising · CMF 0.093  _(accumulation)_
- **Vol ratio** : 0.94  _(volume normal)_
- **Choppiness** : 52.5  _(transition)_
- **MA** : MA20 8.74 · MA50 9.58 · MA200 15.08  _(prix > MA20)_
- **Dist MA** : MA20 +9.7% · MA50 +0.1% · MA200 -36.4%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (85391 bytes source)._  
