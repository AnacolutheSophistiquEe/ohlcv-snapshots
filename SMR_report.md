...
**Generated** : 2026-08-12T00:28:37.831230+00:00  
...
> ↳ spot $9.89 (+0.6% vs entrée) · entrée $9.83 · stop $9.62 · T1 $10.16 · R/R 1.57  
> ↳ P(T1 av. stop) 45 % _(réel 5 s)_ · EV/risk 0.131 _(réel 5 s)_ (GBM 0.069) · ¼-Kelly 0.024 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −2.16% cohérent avec le bruit 5 s (EV-optimal ≈ −1.5%)  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal 162 % hors [0,100] (R² max 0.96). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- Entry (zone de repli) : $9.77–$9.89 (mid $9.83)
- Spot actuel : $9.89 (+0.6% au-dessus de la zone — repli à attendre)
- Stop : $9.62 (stop swing_plan-based (-11.96%))
- Targets : T1 $10.16 · R/R 1.57 | T2 $10.48 · R/R 3.1 | T3 $10.81 · R/R 4.67
...
- EV/risk : 0.069 | EV/share : $0.015 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 60.9 | bear 8.5 | side 30.6  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 287.0 (= 29 part(s) × prix) · cible 288.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.62% → cible +3.335% / stop −2.163%, p_fill 88%, n_eff≈35.9) : P(cible|rempli) **45%** · **EV/risk +0.131** (×p_fill ; si rempli +0.32% du capital)
  - **swing** (entrée dip −1.369% → cible +21.475% / stop −10.738%, p_fill 85%, n_eff≈34.5) : P(cible|rempli) **10%** · **EV/risk -0.015** (×p_fill ; si rempli -0.19% du capital)
  - **deep** (entrée dip −2.006% → cible +30.987% / stop −15.495%, p_fill 88%, n_eff≈34.2) : P(cible|rempli) **1%** · **EV/risk -0.210** (×p_fill ; si rempli -3.72% du capital)
...
- **MA** : MA20 8.68 · MA50 9.65 · MA200 15.22  _(prix > MA20)_
- **Dist MA** : MA20 +14.0% · MA50 +2.5% · MA200 -35.0%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (86852 bytes source)._  
