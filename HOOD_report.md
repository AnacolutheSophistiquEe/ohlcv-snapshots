...
**Generated** : 2026-08-19T00:31:14.470874+00:00  
**Santé technique** : 5/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite low · $91.53  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot $91.53 (+5.9% vs entrée) · entrée $86.47 · stop $81.99 · T1 $89.80 · R/R 0.74  
> ↳ P(T1 av. stop) 59 % _(réel 5 s)_ · EV/risk -0.006 _(réel 5 s)_ (GBM -0.047) · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈214) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : $85.80–$87.13 (mid $86.47)
- Spot actuel : $91.53 (+5.9% au-dessus de la zone — repli à attendre)
- Stop : $81.99 (stop swing_plan-based (-10.42%))
- Targets : T1 $89.80 · R/R 0.74 | T2 $93.13 · R/R 1.49 | T3 $96.46 · R/R 2.23
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $81.99


## Edge, scénarios & sizing

- EV/risk : -0.047 | EV/share : $-0.210 | p_fill : —
...
- Régime probabiliste (posterior HMM, swing) : bull 75.1 | bear 16.9 | side 8.0  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 275.0 (= 3 part(s) × prix) · cible 288.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −2.516% → cible +5.014% / stop −3.0%, p_fill 41%, n_eff≈19.1) : P(cible|rempli) **14%** · **EV/risk +0.065** (×p_fill ; si rempli +0.47% du capital)
  - **swing** (entrée dip −5.533% → cible +3.854% / stop −5.173%, p_fill 29%, n_eff≈12.9) : P(cible|rempli) **59%** · **EV/risk -0.006** (×p_fill ; si rempli -0.12% du capital)
  - **deep** (entrée dip −8.55% → cible +5.45% / stop −8.015%, p_fill 41%, n_eff≈14.1) : P(cible|rempli) **70%** · **EV/risk +0.063** (×p_fill ; si rempli +1.21% du capital)
...
- **MACD** : hist 0.309  _(pas de croisement recent)_
- **BB** : %B 0.36 · largeur 18.8%
- **ATR** : 4.47 (17.0e pct 1a)  _(volatilite basse)_
- **OBV/CMF** : OBV rising · CMF -0.2  _(distribution)_
- **Vol ratio** : 0.8  _(volume normal)_
- **Choppiness** : 50.1  _(transition)_
- **MA** : MA20 93.98 · MA50 99.43 · MA200 96.75  _(prix < MA20)_
- **Dist MA** : MA20 -2.6% · MA50 -7.9% · MA200 -5.4%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (90930 bytes source)._  
