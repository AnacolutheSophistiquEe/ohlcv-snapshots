...
**Generated** : 2026-07-31T00:29:10.779567+00:00  
**Santé technique** : 4/10 — **Rating** : Pass  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · $86.60  

> 🟡 **WAIT-FOR-DIP** — spot +1.4 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot $86.60 (+1.4% vs entrée) · entrée $85.42 · stop $81.15 · T1 $87.27 · R/R 0.43  
> ↳ P(T1 av. stop) 61 % _(réel 5 s)_ · EV/risk 0.02 _(réel 5 s)_ (GBM 0.006) · ¼-Kelly 0.039 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −5.0% cohérent avec le bruit 5 s (EV-optimal ≈ −5.0%)  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal -42 % hors [0,100] (R² max 0.88). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- Entry (zone de repli) : $85.05–$85.79 (mid $85.42)
- Spot actuel : $86.60 (+1.4% au-dessus de la zone — repli à attendre)
- Stop : $81.15 (stop swing_plan-based (-5.35%))
- Targets : T1 $87.27 · R/R 0.43 | T2 $89.12 · R/R 0.87 | T3 $90.97 · R/R 1.3
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $81.15


## Edge, scénarios & sizing

- EV/risk : 0.006 | EV/share : $0.028 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 8.4 | bear 11.3 | side 80.3  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −1.368% → cible +2.165% / stop −5.0%, p_fill 76%, n_eff≈29.7) : P(cible|rempli) **61%** · **EV/risk +0.020** (×p_fill ; si rempli +0.13% du capital)
  - **swing** (entrée dip −3.002% → cible +4.842% / stop −2.421%, p_fill 58%, n_eff≈22.0) : P(cible|rempli) **36%** · **EV/risk +0.009** (×p_fill ; si rempli +0.04% du capital)
  - **deep** (entrée dip −4.645% → cible +6.848% / stop −3.424%, p_fill 51%, n_eff≈18.3) : P(cible|rempli) **27%** · **EV/risk -0.138** (×p_fill ; si rempli -0.92% du capital)
...
- **MACD** : hist -2.992  _(pas de croisement recent)_
- **BB** : %B 0.01 · largeur 35.9%
- **ATR** : 6.24 (56.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV falling · CMF -0.193  _(distribution)_
- **Vol ratio** : 1.31  _(volume normal)_
- **Choppiness** : 40.0  _(transition)_
- **MA** : MA20 105.0 · MA50 96.39 · MA200 99.56  _(prix < MA20)_
- **Dist MA** : MA20 -17.5% · MA50 -10.2% · MA200 -13.0%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (88942 bytes source)._  
