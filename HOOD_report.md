...
**Generated** : 2026-07-20T00:31:04.650985+00:00  
**Santé technique** : 4/10 — **Rating** : Neutral  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : trending · volatilite normal · $99.96  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-07-23 — ECB Monetary Policy Decision (J-2 sess · macro taux)  
> ↳ spot $99.96 (+1.7% vs entrée) · entrée $98.33 · stop $95.72 · T1 $103.57 · R/R 2.01  
> ↳ P(T1 av. stop) 55 % _(réel 5 s)_ · EV/risk 0.535 _(réel 5 s)_ (GBM -0.068) · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈214) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : $97.29–$99.38 (mid $98.33)
- Spot actuel : $99.96 (+1.7% au-dessus de la zone — repli à attendre)
- Stop : $95.72 (stop swing_plan-based (-4.24%))
- Targets : T1 $103.57 · R/R 2.01 | T2 $108.80 · R/R 4.01 | T3 $114.04 · R/R 6.02
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $95.72


## Edge, scénarios & sizing

- EV/risk : -0.068 | EV/share : $-0.178 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 29 % | T2 15 % | T3 11 %
- Kelly (position) : f* 0.0 | ¼-Kelly 0.0 _(fraction du capital ; ¼-Kelly recommandé ; Kelly ≤ 0 ⇒ mise optimale nulle ⇒ Pass, même si l'EV blended scale-out reste marginalement positive)_
- Calibration des probas : _first-passage empirique daily (historique réel, n≈214) · non recalibrée track-record (n=0)_
- Régime probabiliste (posterior HMM, swing) : bull 19.3 | bear 8.6 | side 72.1  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.742% → cible +2.38% / stop −3.0%, p_fill 79%, n_eff≈31.6) : P(cible|rempli) **30%** · **EV/risk -0.123** (×p_fill ; si rempli -0.47% du capital)
  - **swing** (entrée dip −1.622% → cible +5.322% / stop −2.661%, p_fill 81%, n_eff≈32.5) : P(cible|rempli) **55%** · **EV/risk +0.535** (×p_fill ; si rempli +1.75% du capital)
  - **deep** (entrée dip −2.511% → cible +7.527% / stop −3.763%, p_fill 63%, n_eff≈28.6) : P(cible|rempli) **47%** · **EV/risk +0.245** (×p_fill ; si rempli +1.46% du capital)
...
- **MACD** : hist -1.503  _(bearish_recent)_
- **BB** : %B 0.24 · largeur 26.0%
- **ATR** : 6.91 (70.0e pct 1a)  _(volatilite au-dessus de la moyenne (tiers haut))_
- **OBV/CMF** : OBV falling · CMF -0.038  _(neutre)_
- **Vol ratio** : 1.02  _(volume normal)_
- **Choppiness** : 53.7  _(transition)_
- **MA** : MA20 107.29 · MA50 93.02 · MA200 101.75  _(prix < MA20)_
- **Dist MA** : MA20 -6.8% · MA50 +7.5% · MA200 -1.8%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (90919 bytes source)._  
