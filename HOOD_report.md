...
**Generated** : 2026-08-20T00:28:29.808945+00:00  
**Santé technique** : 7/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite low · $95.77  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot $95.77 (+1.2% vs entrée) · entrée $94.63 · stop $90.05 · T1 $98.51 · R/R 0.85  
> ↳ P(T1 av. stop) 51 % _(réel 5 s)_ · EV/risk -0.012 _(réel 5 s)_ (GBM -0.034) · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈214) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : $93.86–$95.41 (mid $94.63)
- Spot actuel : $95.77 (+1.2% au-dessus de la zone — repli à attendre)
- Stop : $90.05 (stop swing_plan-based (-5.97%))
- Targets : T1 $98.51 · R/R 0.85 | T2 $102.39 · R/R 1.69 | T3 $106.27 · R/R 2.54
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $90.05
...
- Régime probabiliste (posterior HMM, swing) : bull 77.1 | bear 14.7 | side 8.2  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 479.0 (= 5 part(s) × prix) · cible 512.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.536% → cible +1.834% / stop −3.0%, p_fill 78%, n_eff≈33.4) : P(cible|rempli) **44%** · **EV/risk -0.049** (×p_fill ; si rempli -0.19% du capital)
  - **swing** (entrée dip −1.185% → cible +4.101% / stop −4.843%, p_fill 78%, n_eff≈35.1) : P(cible|rempli) **51%** · **EV/risk -0.012** (×p_fill ; si rempli -0.08% du capital)
  - **deep** (entrée dip −1.832% → cible +5.799% / stop −7.312%, p_fill 86%, n_eff≈34.0) : P(cible|rempli) **54%** · **EV/risk -0.047** (×p_fill ; si rempli -0.40% du capital)
...
- **MACD** : hist 0.402  _(pas de croisement recent)_
- **BB** : %B 0.65 · largeur 15.8%
- **ATR** : 4.58 (19.0e pct 1a)  _(volatilite basse)_
- **OBV/CMF** : OBV rising · CMF -0.167  _(distribution)_
- **Vol ratio** : 1.35  _(volume normal)_
- **Choppiness** : 51.1  _(transition)_
- **MA** : MA20 93.54 · MA50 99.65 · MA200 96.53  _(prix > MA20)_
- **Dist MA** : MA20 +2.4% · MA50 -3.9% · MA200 -0.8%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (107698 bytes source)._  
