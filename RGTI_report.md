...
**Generated** : 2026-08-10T00:26:59.809550+00:00  
...
**Subtitle** : indeterminate · volatilite low · $17.94  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-08-12 — US CPI (headline) (J-1 sess · macro taux)  
> ↳ spot $17.94 (+1.0% vs entrée) · entrée $17.77 · stop $17.24 · T1 $18.84 · R/R 2.02  
> ↳ P(T1 av. stop) 30 % _(réel 5 s)_ · EV/risk 0.116 _(réel 5 s)_ (GBM 0.258) · ¼-Kelly 0.052 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −3.0% cohérent avec le bruit 5 s (EV-optimal ≈ −2.0%)  
...
- 🔴 **Santé haussière vs sur-extension** — Santé technique 7/10 élevée alors que : %B 1.04 (collé à la bande haute) ; extension étirée (≥2×ATR au-dessus de la MA20) — le score mesure la santé durable, PAS le timing ; entrée au prix actuel défavorable.
...
- Entry (zone de repli) : $17.64–$17.90 (mid $17.77)
- Spot actuel : $17.94 (+1.0% au-dessus de la zone — repli à attendre)
- Stop : $17.24 (stop swing_plan-based (-12.16%))
- Targets : T1 $18.84 · R/R 2.02 | T2 $19.27 · R/R 2.83 | T3 $19.71 · R/R 3.66
...
- EV/risk : 0.258 | EV/share : $0.138 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 39 % | T2 39 % | T3 39 %
- Kelly (position) : f* 0.207 | ¼-Kelly 0.052 _(fraction du capital ; ¼-Kelly recommandé ; Kelly ≤ 0 ⇒ mise optimale nulle ⇒ Pass, même si l'EV blended scale-out reste marginalement positive)_
...
- Sizing : notional réel 395.0 (= 22 part(s) × prix) · cible 400.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.933% → cible +6.009% / stop −3.005%, p_fill 75%, n_eff≈33.9) : P(cible|rempli) **30%** · **EV/risk +0.116** (×p_fill ; si rempli +0.46% du capital)
  - **swing** (entrée dip −2.061% → cible +20.623% / stop −10.312%, p_fill 73%, n_eff≈32.0) : P(cible|rempli) **7%** · **EV/risk -0.295** (×p_fill ; si rempli -4.14% du capital)
  - **deep** (entrée dip −3.187% → cible +11.469% / stop −10.9%, p_fill 85%, n_eff≈33.4) : P(cible|rempli) **41%** · **EV/risk -0.195** (×p_fill ; si rempli -2.51% du capital)
...
- **BB** : %B 1.04 · largeur 31.3%
- **ATR** : 1.26 (20.0e pct 1a)  _(volatilite basse)_
- **OBV/CMF** : OBV rising · CMF -0.046  _(neutre)_
- **Vol ratio** : 1.34  _(volume normal)_
- **Choppiness** : 49.2  _(transition)_
- **MA** : MA20 15.33 · MA50 18.55 · MA200 21.14  _(prix > MA20)_
- **Dist MA** : MA20 +17.0% · MA50 -3.3% · MA200 -15.1%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (93774 bytes source)._  
