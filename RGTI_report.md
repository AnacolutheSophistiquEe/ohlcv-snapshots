...
**Generated** : 2026-07-15T00:28:03.980018+00:00  
...
**Subtitle** : indeterminate · volatilite normal · $16.11  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot $16.11 (+2.4% vs entrée) · entrée $15.73 · stop $15.19 · T1 $16.81 · R/R 2.0  
> ↳ P(T1 av. stop) 16 % _(réel 5 s)_ · EV/risk -0.169 _(réel 5 s)_ (GBM 0.103) · ¼-Kelly 0.038 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −3.44% cohérent avec le bruit 5 s (EV-optimal ≈ −2.0%)  
...
- Entry (zone de repli) : $15.64–$15.81 (mid $15.73)
- Spot actuel : $16.11 (+2.4% au-dessus de la zone — repli à attendre)
- Stop : $15.19 (stop swing_plan-based (-8.15%))
- Targets : T1 $16.81 · R/R 2.0 | T2 $16.91 · R/R 2.19 | T3 $17.02 · R/R 2.39
...
- EV/risk : 0.103 | EV/share : $0.056 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 36 % | T2 36 % | T3 36 %
- Kelly (position) : f* 0.15 | ¼-Kelly 0.038 _(fraction du capital ; ¼-Kelly recommandé ; Kelly ≤ 0 ⇒ mise optimale nulle ⇒ Pass, même si l'EV blended scale-out reste marginalement positive)_
- Calibration des probas : _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_
- Régime probabiliste (posterior HMM, intraday) : bull 14.2 | bear 71.1 | side 14.7  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −2.382% → cible +6.878% / stop −3.44%, p_fill 60%, n_eff≈25.1) : P(cible|rempli) **16%** · **EV/risk -0.169** (×p_fill ; si rempli -0.97% du capital)
  - **swing** (entrée dip −5.241% → cible +6.139% / stop −3.07%, p_fill 63%, n_eff≈23.7) : P(cible|rempli) **29%** · **EV/risk -0.108** (×p_fill ; si rempli -0.53% du capital)
  - **deep** (entrée dip −8.1% → cible +8.682% / stop −4.341%, p_fill 52%, n_eff≈19.4) : P(cible|rempli) **14%** · **EV/risk -0.285** (×p_fill ; si rempli -2.40% du capital)
...
- **MACD** : hist -0.336  _(pas de croisement recent)_
- **BB** : %B 0.17 · largeur 43.4%
- **ATR** : 1.34 (28.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV falling · CMF -0.217  _(distribution)_
- **Vol ratio** : 0.74  _(volume normal)_
- **Choppiness** : 44.4  _(transition)_
- **MA** : MA20 18.79 · MA50 20.12 · MA200 23.53  _(prix < MA20)_
- **Dist MA** : MA20 -14.2% · MA50 -19.9% · MA200 -31.5%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (87622 bytes source)._  
