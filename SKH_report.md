...
**Generated** : 2026-09-10T21:58:58.063699+00:00  
> ⚠️ **Données suspectes** : barres source hors échelle (prix/vol) — bulletin NON FIABLE, re-télécharger les données KR.  

**Santé technique** : 7/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · ₩1853000.00  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-09-11 — US CPI (headline) (J-1 sess · macro taux)  
> ↳ spot ₩1853000.00 (+1.4% vs entrée) · entrée ₩1827230.78 · stop ₩1731835.58 · T1 ₩1933602.37 · R/R 1.12  
> ↳ P(T1 av. stop) 34 % _(réel 5 s)_ · EV/risk -0.269 _(réel 5 s)_ (GBM 0.368) · ¼-Kelly 0.043 · _first-passage empirique daily (historique réel, n≈209) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩1805956.46–₩1848505.10 (mid ₩1827230.78)
- Spot actuel : ₩1853000.00 (+1.4% au-dessus de la zone — repli à attendre)
- Stop : ₩1731835.58 (stop swing_plan-based (-6.54%))
- Targets : T1 ₩1933602.37 · R/R 1.12 | T2 ₩2039973.96 · R/R 2.23 | T3 ₩2146345.55 · R/R 3.35
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩1731835.58
...
- **Au stop du plan (6.54 %)** : le gap seul le franchit 1.149 % des séances (14 fois sur 1218).
   - exécution **1.782 pt plus bas** dans le cas TYPIQUE (médiane), 3.68 au p90, **4.32 au pire**
   - perte réelle **8.515 %** en moyenne _(tirée par la queue)_, jusqu'à **10.86 %** — au lieu des 6.54 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1219 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.0535** [0.0271 ; 0.0946] _(largeur 6.8 pt, n_eff 173.1)_
   - swing : **0.3939** [0.3434 ; 0.4461] _(largeur 10.3 pt, n_eff 345.6)_
   - deep : **0.3505** [0.3016 ; 0.4019] _(largeur 10.0 pt, n_eff 345.6)_
- ⚠ 5 s / deep : probabilite(s) EXACTEMENT nulle(s) : p_no_touch. Ce n'est PAS « jamais » — c'est « aucune occurrence sur 35.5 observations effectives », dont la borne haute a 95 % vaut environ 8.4 %.
- ⚠ **5 s — échantillon insuffisant sur : intraday (30.8 pt), swing (30.5 pt), deep (30.9 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
- **VaR/CVaR à 1 j (fenêtre adaptative, 250 séances)** : VaR **-8.77 %** | CVaR **-11.36 %** | vol 5.72 %/j
   - _fenêtre arrêtée : rupture de regime a 240 seances en arriere (volatilite 4.23 % contre 6.85 % aujourd'hui, rapport 0.62)_
...
- **β de baisse : 1.4088** (β de hausse 1.6138, asymétrie 0.8729) vs KS11 — 552 séances de repli, historique complet


## Edge, scénarios & sizing

- EV/risk : 0.368 | EV/share : ₩35124.610 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 57 % | T2 37 % | T3 21 %
- Kelly (position) : f* 0.171 | ¼-Kelly 0.043 _(fraction du capital ; ¼-Kelly recommandé ; Kelly ≤ 0 ⇒ mise optimale nulle ⇒ Pass, même si l'EV blended scale-out reste marginalement positive)_
- Calibration des probas : _first-passage empirique daily (historique réel, n≈209) · non recalibrée track-record (n=0)_
- Régime probabiliste (posterior HMM, swing) : bull 62.8 | bear 5.7 | side 31.5  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.63% → cible +2.603% / stop −8.0%, p_fill 86%, n_eff≈37.2) : P(cible|rempli) **38%** · **EV/risk -0.115** (×p_fill ; si rempli -1.07% du capital)
  - **swing** (entrée dip −1.392% → cible +5.821% / stop −5.221%, p_fill 79%, n_eff≈35.0) : P(cible|rempli) **34%** · **EV/risk -0.269** (×p_fill ; si rempli -1.78% du capital)
  - **deep** (entrée dip −2.148% → cible +8.233% / stop −7.892%, p_fill 91%, n_eff≈35.5) : P(cible|rempli) **38%** · **EV/risk -0.281** (×p_fill ; si rempli -2.43% du capital)
...
- **MACD** : hist 34908.418  _(pas de croisement recent)_
- **BB** : %B 0.98 · largeur 20.6%
- **ATR** : 95395.2 (64.0e pct 1a)  _(volatilite au-dessus de la moyenne (tiers haut))_
- **OBV/CMF** : OBV rising · CMF -0.104  _(distribution)_
- **Vol ratio** : 1.17  _(volume normal)_
- **Choppiness** : 52.6  _(transition)_
- **MA** : MA20 1687270.21 · MA50 1771330.34 · MA200 1330033.02  _(prix > MA20)_
- **Dist MA** : MA20 +9.8% · MA50 +4.6% · MA200 +39.3%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (489321 bytes source)._  
