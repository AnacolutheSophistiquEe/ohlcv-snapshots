...
**Generated** : 2026-08-31T00:14:37.414713+00:00  
> ⚠️ **Données suspectes** : barres source hors échelle (prix/vol) — bulletin NON FIABLE, re-télécharger les données KR.  

**Santé technique** : 6/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · ₩1653000.00  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot ₩1653000.00 (+10.3% vs entrée) · entrée ₩1498836.32 · stop ₩1345181.04 · T1 ₩1806146.88 · R/R 2.0  
> ↳ P(T1 av. stop) 0 % _(réel 5 s)_ · EV/risk -0.125 _(réel 5 s)_ (GBM 0.357) · ¼-Kelly 0.003 · _first-passage empirique daily (historique réel, n≈207) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩1468460.89–₩1529211.75 (mid ₩1498836.32)
- Spot actuel : ₩1653000.00 (+10.3% au-dessus de la zone — repli à attendre)
- Stop : ₩1345181.04 (stop swing_plan-based (-18.62%))
- Targets : T1 ₩1806146.88 · R/R 2.0 | T2 ₩1879616.99 · R/R 2.48 | T3 ₩1953087.11 · R/R 2.96
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩1345181.04
...
- **Au stop du plan (18.62 %)** : le gap seul le franchit 0.0 % des séances (0 fois sur 1217).
   - exécution **— pt plus bas** dans le cas TYPIQUE (médiane), — au p90, **— au pire**
   - perte réelle **— %** en moyenne _(tirée par la queue)_, jusqu'à **— %** — au lieu des 18.62 % annoncés par la distance
   - coût AMORTI sur toutes les séances : 0.0 % _(ce que le gap coûte en moyenne, pas ce qu'il coûte le jour où il frappe)_
   - ⚠ seulement 0 franchissement(s) observé(s) : montants indicatifs, pas des espérances fiables. La médiane résiste mieux que la moyenne à un si petit nombre.
  - ⚠ **Sur un titre gap-prone, la réponse est une TAILLE plus faible, PAS un stop plus large** : élargir échange de la fréquence contre de la sévérité (T1). Ne jamais proposer d'élargir un stop en invoquant le gap.
- Chocs d'ouverture : p05 -3.344 % | p01 -7.0 % | pire -10.86 % _(sur 1217 séances)_
- **P(stop avant cible)** _(source : daily, 1218 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.068** [0.0375 ; 0.1128] _(largeur 7.5 pt, n_eff 173.1)_
   - swing : **0.2319** [0.1898 ; 0.2785] _(largeur 8.9 pt, n_eff 345.6)_
   - deep : **0.2044** [0.1645 ; 0.2493] _(largeur 8.5 pt, n_eff 345.6)_
- ⚠ 5 s / swing : probabilite(s) EXACTEMENT nulle(s) : p_target_first. Ce n'est PAS « jamais » — c'est « aucune occurrence sur 13.3 observations effectives », dont la borne haute a 95 % vaut environ 22.6 %.
...
- ⚠ **5 s — échantillon insuffisant sur : intraday (30.1 pt), swing (49.0 pt), deep (46.4 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
...
- EV/risk : 0.357 | EV/share : ₩54813.167 | p_fill : —
...
- Régime probabiliste (posterior HMM, swing) : bull 19.7 | bear 8.5 | side 71.8  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −4.239% → cible +6.553% / stop −8.0%, p_fill 42%, n_eff≈23.3) : P(cible|rempli) **10%** · **EV/risk -0.008** (×p_fill ; si rempli -0.15% du capital)
  - **swing** (entrée dip −9.324% → cible +20.503% / stop −10.252%, p_fill 33%, n_eff≈13.3) : P(cible|rempli) **0%** · **EV/risk -0.125** (×p_fill ; si rempli -3.91% du capital)
  - **deep** (entrée dip −14.415% → cible +42.739% / stop −18.0%, p_fill 28%, n_eff≈13.5) : P(cible|rempli) **0%** · **EV/risk -0.111** (×p_fill ; si rempli -7.20% du capital)
...
- **MACD** : hist 36721.479  _(pas de croisement recent)_
- **BB** : %B 0.62 · largeur 26.5%
- **ATR** : 120234.03 (69.0e pct 1a)  _(volatilite au-dessus de la moyenne (tiers haut))_
- **OBV/CMF** : OBV rising · CMF -0.144  _(distribution)_
- **Vol ratio** : 0.76  _(volume normal)_
- **Choppiness** : 52.7  _(transition)_
- **MA** : MA20 1601520.67 · MA50 1949304.49 · MA200 1279274.07  _(prix > MA20)_
- **Dist MA** : MA20 +3.2% · MA50 -15.2% · MA200 +29.2%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (624240 bytes source)._  
