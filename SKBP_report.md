...
**Generated** : 2026-08-04T00:20:22.888063+00:00  
**Santé technique** : 6/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : range · volatilite normal · ₩78400.00  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot ₩78400.00 (+1.4% vs entrée) · entrée ₩77300.00 · stop ₩76042.14 · T1 ₩78602.71 · R/R 1.04  
> ↳ P(T1 av. stop) 44 % _(réel 5 s)_ · EV/risk -0.042 _(réel 5 s)_ (GBM -0.031) · ¼-Kelly 0.005 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩77039.46–₩77560.54 (mid ₩77300.00)
- Spot actuel : ₩78400.00 (+1.4% au-dessus de la zone — repli à attendre)
- Stop : ₩76042.14 (stop swing_plan-based (-8.43%))
- Targets : T1 ₩78602.71 · R/R 1.04 | T2 ₩79905.43 · R/R 2.07 | T3 ₩81208.14 · R/R 3.11
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩76042.14


## Edge, scénarios & sizing

- EV/risk : -0.031 | EV/share : ₩-39.133 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 29.1 | bear 63.4 | side 7.5  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −1.406% → cible +1.685% / stop −1.627%, p_fill 62%, n_eff≈26.3) : P(cible|rempli) **44%** · **EV/risk -0.042** (×p_fill ; si rempli -0.11% du capital)
  - **swing** (entrée dip −3.082% → cible +3.768% / stop −5.518%, p_fill 49%, n_eff≈21.7) : P(cible|rempli) **53%** · **EV/risk -0.039** (×p_fill ; si rempli -0.45% du capital)
  - **deep** (entrée dip −4.768% → cible +5.329% / stop −8.424%, p_fill 61%, n_eff≈25.2) : P(cible|rempli) **57%** · **EV/risk +0.035** (×p_fill ; si rempli +0.49% du capital)
...
- **MACD** : hist 333.356  _(pas de croisement recent)_
- **BB** : %B 0.4 · largeur 13.5%
- **ATR** : 4192.86 (53.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV rising · CMF -0.112  _(distribution)_
- **Vol ratio** : 0.92  _(volume normal)_
- **Choppiness** : 65.9  _(marche en range (choppy))_
- **MA** : MA20 79430.0 · MA50 85136.0 · MA200 106008.5  _(prix < MA20)_
- **Dist MA** : MA20 -1.3% · MA50 -7.9% · MA200 -26.0%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (84040 bytes source)._  
