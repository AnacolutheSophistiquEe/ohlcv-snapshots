...
**Generated** : 2026-08-31T00:22:09.641543+00:00  
...
> ↳ spot ₩88000.00 (+4.1% vs entrée) · entrée ₩84535.00 · stop ₩80542.14 · T1 ₩87521.55 · R/R 0.75  
> ↳ P(T1 av. stop) 65 % _(réel 5 s)_ · EV/risk 0.045 _(réel 5 s)_ (GBM -0.074) · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈207) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩83937.69–₩85132.31 (mid ₩84535.00)
- Spot actuel : ₩88000.00 (+4.1% au-dessus de la zone — repli à attendre)
- Stop : ₩80542.14 (stop swing_plan-based (-8.47%))
- Targets : T1 ₩87521.55 · R/R 0.75 | T2 ₩90508.10 · R/R 1.5 | T3 ₩93494.65 · R/R 2.24
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩80542.14
...
- **Au stop du plan (8.47 %)** : le gap seul le franchit 0.0 % des séances (0 fois sur 1217).
   - exécution **— pt plus bas** dans le cas TYPIQUE (médiane), — au p90, **— au pire**
   - perte réelle **— %** en moyenne _(tirée par la queue)_, jusqu'à **— %** — au lieu des 8.47 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1218 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.4312** [0.3591 ; 0.5056] _(largeur 14.7 pt, n_eff 173.1)_
   - swing : **0.3527** [0.3037 ; 0.4041] _(largeur 10.0 pt, n_eff 345.6)_
   - deep : **0.3622** [0.3128 ; 0.4139] _(largeur 10.1 pt, n_eff 345.6)_
- ⚠ **5 s — échantillon insuffisant sur : intraday (32.9 pt), swing (44.3 pt), deep (30.4 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
...
- **β de baisse : 0.6027** (β de hausse 0.4547, asymétrie 1.3257) vs KS11 — 554 séances de repli, historique complet


## Edge, scénarios & sizing

- EV/risk : -0.074 | EV/share : ₩-296.254 | p_fill : —
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −1.785% → cible +4.531% / stop −2.265%, p_fill 62%, n_eff≈24.1) : P(cible|rempli) **1%** · **EV/risk +0.004** (×p_fill ; si rempli +0.01% du capital)
  - **swing** (entrée dip −3.932% → cible +3.533% / stop −4.723%, p_fill 35%, n_eff≈15.5) : P(cible|rempli) **65%** · **EV/risk +0.045** (×p_fill ; si rempli +0.61% du capital)
  - **deep** (entrée dip −6.084% → cible +4.996% / stop −7.247%, p_fill 42%, n_eff≈16.8) : P(cible|rempli) **88%** · **EV/risk +0.198** (×p_fill ; si rempli +3.43% du capital)
...
- **MACD** : hist 313.505  _(pas de croisement recent)_
- **BB** : %B 0.67 · largeur 16.9%
- **ATR** : 3992.86 (39.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV rising · CMF 0.131  _(accumulation)_
- **Vol ratio** : 0.79  _(volume normal)_
- **Choppiness** : 55.6  _(transition)_
- **MA** : MA20 85475.0 · MA50 83588.0 · MA200 103982.5  _(prix > MA20)_
- **Dist MA** : MA20 +3.0% · MA50 +5.3% · MA200 -15.4%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (616801 bytes source)._  
