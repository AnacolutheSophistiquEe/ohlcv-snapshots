...
**Generated** : 2026-08-04T21:41:43.740741+00:00  
**Santé technique** : 8/10 — **Rating** : Pass  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite high · €356.40  

> 🟡 **WAIT-FOR-DIP** — spot +0.9 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot €356.40 (+0.9% vs entrée) · entrée €353.20 · stop €343.57 · T1 €361.78 · R/R 0.89  
> ↳ P(T1 av. stop) 54 % _(réel 5 s)_ · EV/risk 0.027 _(réel 5 s)_ (GBM 0.014) · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈216) · non recalibrée track-record (n=0)_  
...
- 🔴 **Santé haussière vs sur-extension** — Santé technique 8/10 élevée alors que : RSI 72.6 > 70 (surachat) ; %B 1.07 (collé à la bande haute) ; extension étirée (≥2×ATR au-dessus de la MA20) — le score mesure la santé durable, PAS le timing ; entrée au prix actuel défavorable.
...
- Entry (zone de repli) : €351.48–€354.91 (mid €353.20)
- Spot actuel : €356.40 (+0.9% au-dessus de la zone — repli à attendre)
- Stop : €343.57 (stop swing_plan-based (-3.6%))
- Targets : T1 €361.78 · R/R 0.89 | T2 €370.36 · R/R 1.78 | T3 €378.94 · R/R 2.67
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €343.57


## Edge, scénarios & sizing

- EV/risk : 0.014 | EV/share : €0.134 | p_fill : —
...
- Régime probabiliste (posterior HMM, swing) : bull 5.0 | bear 38.0 | side 57.0  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.408% → cible +1.086% / stop −2.0%, p_fill 78%, n_eff≈31.5) : P(cible|rempli) **41%** · **EV/risk -0.070** (×p_fill ; si rempli -0.18% du capital)
  - **swing** (entrée dip −0.898% → cible +2.429% / stop −2.726%, p_fill 71%, n_eff≈26.5) : P(cible|rempli) **54%** · **EV/risk +0.027** (×p_fill ; si rempli +0.10% du capital)
  - **deep** (entrée dip −1.388% → cible +3.435% / stop −4.109%, p_fill 71%, n_eff≈25.0) : P(cible|rempli) **60%** · **EV/risk +0.121** (×p_fill ; si rempli +0.70% du capital)
...
- **MACD** : hist 1.801  _(bullish_recent)_
- **BB** : %B 1.07 · largeur 11.3%
...
- **MA** : MA20 334.66 · MA50 325.39 · MA200 305.66  _(prix > MA20)_
- **Dist MA** : MA20 +6.5% · MA50 +9.5% · MA200 +16.6%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (93622 bytes source)._  
