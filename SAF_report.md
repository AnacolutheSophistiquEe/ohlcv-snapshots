...
**Generated** : 2026-09-15T00:09:22.631669+00:00  
**Santé technique** : 4/10 — **Rating** : Pass  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · €321.70  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-09-16 — US FOMC Rate Decision (J-1 sess · macro taux)  
> ↳ spot €321.70 (+4.8% vs entrée) · entrée €306.87 · stop €298.92 · T1 €312.71 · R/R 0.73  
> ↳ P(T1 av. stop) 74 % · EV/risk 0.09 · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈216) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €305.70–€308.03 (mid €306.87)
- Spot actuel : €321.70 (+4.8% au-dessus de la zone — repli à attendre)
- Stop : €298.92 (stop swing_plan-based (-7.08%))
- Targets : T1 €312.71 · R/R 0.73 | T2 €318.55 · R/R 1.47 | T3 €324.39 · R/R 2.2
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €298.92
...
- **P(stop avant cible)** _(source : daily, 1280 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   ...
   - swing : **0.3847** [0.3346 ; 0.4368] _(largeur 10.2 pt, n_eff 345.8)_
...
- **β de baisse : 1.3759** (β de hausse 1.3414, asymétrie 1.0257) vs FCHI — 618 séances de repli, historique complet
...
- **Couple retenu** : stop 289.2429 sur sr_based (3.49 ATR, 10.089 %) — p(stop avant cible) 0.08 [0.05 ; 0.11], R/R 1.219, perte reelle 10.089 % (gap inclus), CVaR 10.089 %, EV 0.9718 % — **NON CONFORME (best_effort — proposition de derniere main)**
   - viole : cible atteinte seulement 7.8 % du temps (< 15 %) meme a 10 seances : le R/R de 1.22 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
   - viole : R/R 1.22 < plancher 3.00 (mesure vs SPOT, gap inclus)
- Budget de queue : **12.0 %** du notionnel — ⚠ VALEUR FIGEE (valeur de repli (ligne absente de l'allocation)), PAS une mesure. L'allocation derivee de la contrainte du compte n'etait pas disponible.
- Candidats (la structure propose, la statistique elimine) :
   - ⚪ atr_based a 1.5 ATR (stop 3.707 %) — p(stop avant cible) 0.4061 [0.36 ; 0.46], R/R 2.158, perte reelle 5.698 % (gap inclus), EV 0.2995 % — **REFUSE**
   ...
   - ⚪ sr_based a 3.49 ATR (stop 10.089 %) — p(stop avant cible) 0.08 [0.05 ; 0.11], R/R 1.219, perte reelle 10.089 % (gap inclus), EV 0.9718 % — **REFUSE**
      - refuse : cible atteinte seulement 7.8 % du temps (< 15 %) meme a 10 seances : le R/R de 1.22 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.22 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - 🟢 support a 7.8 ATR (stop 20.736 %) — p(stop avant cible) 0.005 [0.00 ; 0.02], R/R 0.593, perte reelle 20.736 % (gap inclus), EV 0.9397 % — **REFUSE**
   ...
   - ⚪ atr_grid a 0.25 ATR (stop 0.618 %) — p(stop avant cible) 0.8827 [0.85 ; 0.91], R/R 9.077, perte reelle 1.355 % (gap inclus), EV -0.3454 % — **REFUSE**
      - refuse : cible atteinte seulement 3.9 % du temps (< 15 %) meme a 10 seances : le R/R de 9.08 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.35 %) : P(cible) 3.9 % x 12.30 % + P(rien) 7.8 % x 4.72 % ne couvrent pas P(stop) 88.3 % x 1.35 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.5 ATR (stop 1.236 %) — p(stop avant cible) 0.7686 [0.72 ; 0.81], R/R 5.976, perte reelle 2.058 % (gap inclus), EV -0.1455 % — **REFUSE**
      - refuse : cible atteinte seulement 4.9 % du temps (< 15 %) meme a 10 seances : le R/R de 5.98 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.15 %) : P(cible) 4.9 % x 12.30 % + P(rien) 18.2 % x 4.57 % ne couvrent pas P(stop) 76.9 % x 2.06 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.75 ATR (stop 1.853 %) — p(stop avant cible) 0.6701 [0.62 ; 0.72], R/R 4.056, perte reelle 3.032 % (gap inclus), EV -0.1258 % — **REFUSE**
      - refuse : cible atteinte seulement 6.5 % du temps (< 15 %) meme a 10 seances : le R/R de 4.06 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.13 %) : P(cible) 6.5 % x 12.30 % + P(rien) 26.5 % x 4.19 % ne couvrent pas P(stop) 67.0 % x 3.03 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.0 ATR (stop 2.471 %) — p(stop avant cible) 0.5809 [0.53 ; 0.63], R/R 2.987, perte reelle 4.117 % (gap inclus), EV -0.0792 % — **REFUSE**
      - refuse : cible atteinte seulement 7.0 % du temps (< 15 %) meme a 10 seances : le R/R de 2.99 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.08 %) : P(cible) 7.0 % x 12.30 % + P(rien) 34.9 % x 4.15 % ne couvrent pas P(stop) 58.1 % x 4.12 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.25 ATR (stop 3.089 %) — p(stop avant cible) 0.4887 [0.44 ; 0.54], R/R 2.557, perte reelle 4.809 % (gap inclus), EV 0.1939 % — **REFUSE**
   ...
   - ⚪ atr_grid a 1.75 ATR (stop 4.325 %) — p(stop avant cible) 0.3557 [0.31 ; 0.41], R/R 1.809, perte reelle 6.799 % (gap inclus), EV 0.1832 % — **REFUSE**
   ...
   - ⚪ atr_grid a 2.0 ATR (stop 4.942 %) — p(stop avant cible) 0.2977 [0.25 ; 0.35], R/R 1.809, perte reelle 6.799 % (gap inclus), EV 0.6766 % — **REFUSE**
      - refuse : cible atteinte seulement 7.8 % du temps (< 15 %) meme a 10 seances : le R/R de 1.81 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.81 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 2.25 ATR (stop 5.56 %) — p(stop avant cible) 0.2644 [0.22 ; 0.31], R/R 1.232, perte reelle 9.986 % (gap inclus), EV 0.0513 % — **REFUSE**
      - refuse : cible atteinte seulement 7.8 % du temps (< 15 %) meme a 10 seances : le R/R de 1.23 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.23 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 2.5 ATR (stop 6.178 %) — p(stop avant cible) 0.2393 [0.20 ; 0.29], R/R 1.232, perte reelle 9.986 % (gap inclus), EV 0.2735 % — **REFUSE**
      - refuse : cible atteinte seulement 7.8 % du temps (< 15 %) meme a 10 seances : le R/R de 1.23 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.23 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 2.75 ATR (stop 6.796 %) — p(stop avant cible) 0.1906 [0.15 ; 0.23], R/R 1.232, perte reelle 9.986 % (gap inclus), EV 0.5162 % — **REFUSE**
      - refuse : cible atteinte seulement 7.8 % du temps (< 15 %) meme a 10 seances : le R/R de 1.23 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.23 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 3.0 ATR (stop 7.414 %) — p(stop avant cible) 0.1545 [0.12 ; 0.20], R/R 1.232, perte reelle 9.986 % (gap inclus), EV 0.7135 % — **REFUSE**
      - refuse : cible atteinte seulement 7.8 % du temps (< 15 %) meme a 10 seances : le R/R de 1.23 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.23 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ grid_snapped a 3.49 ATR (stop 9.373 %) — p(stop avant cible) 0.092 [0.06 ; 0.13], R/R 1.232, perte reelle 9.986 % (gap inclus), EV 0.9485 % — **REFUSE**
      - refuse : cible atteinte seulement 7.8 % du temps (< 15 %) meme a 10 seances : le R/R de 1.23 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.23 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 4.5 ATR (stop 11.121 %) — p(stop avant cible) 0.0628 [0.04 ; 0.09], R/R 1.106, perte reelle 11.121 % (gap inclus), EV 0.9582 % — **REFUSE**
   ...
   - ⚪ atr_grid a 5.0 ATR (stop 12.356 %) — p(stop avant cible) 0.0419 [0.02 ; 0.07], R/R 0.995, perte reelle 12.356 % (gap inclus), EV 0.9695 % — **REFUSE**
   ...
   - ⚪ atr_grid a 5.5 ATR (stop 13.592 %) — p(stop avant cible) 0.0325 [0.02 ; 0.06], R/R 0.905, perte reelle 13.592 % (gap inclus), EV 0.9308 % — **REFUSE**
   ...
   - ⚪ atr_grid a 6.0 ATR (stop 14.827 %) — p(stop avant cible) 0.019 [0.01 ; 0.04], R/R 0.83, perte reelle 14.827 % (gap inclus), EV 0.9305 % — **REFUSE**
   ...
   - ⚪ atr_grid a 6.5 ATR (stop 16.063 %) — p(stop avant cible) 0.0094 [0.00 ; 0.02], R/R 0.766, perte reelle 16.063 % (gap inclus), EV 0.9378 % — **REFUSE**
   ...
   - ⚪ atr_grid a 7.0 ATR (stop 17.299 %) — p(stop avant cible) 0.0065 [0.00 ; 0.02], R/R 0.711, perte reelle 17.299 % (gap inclus), EV 0.9437 % — **REFUSE**
   ...
   - ⚪ atr_grid a 7.5 ATR (stop 18.534 %) — p(stop avant cible) 0.005 [0.00 ; 0.02], R/R 0.664, perte reelle 18.534 % (gap inclus), EV 0.9509 % — **REFUSE**
      - refuse : cible atteinte seulement 7.8 % du temps (< 15 %) meme a 10 seances : le R/R de 0.66 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.66 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 18.53 % > budget 12.00 %
   - 🟢 grid_snapped a 7.8 ATR (stop 20.02 %) — p(stop avant cible) 0.005 [0.00 ; 0.02], R/R 0