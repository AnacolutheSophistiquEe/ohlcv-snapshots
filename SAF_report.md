...
**Generated** : 2026-09-01T21:42:17.697162+00:00  
...
> ↳ spot €331.60 (+6.8% vs entrée) · entrée €310.42 · stop €302.92 · T1 €315.31 · R/R 0.65  
> ↳ P(T1 av. stop) 60 % · EV/risk 0.005 · ¼-Kelly 0.005 · _first-passage empirique daily (historique réel, n≈217) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €309.44–€311.40 (mid €310.42)
- Spot actuel : €331.60 (+6.8% au-dessus de la zone — repli à attendre)
- Stop : €302.92 (stop swing_plan-based (-8.65%))
- Targets : T1 €315.31 · R/R 0.65 | T2 €320.21 · R/R 1.31 | T3 €325.11 · R/R 1.96
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €302.92
...
- **Au stop du plan (8.65 %)** : le gap seul le franchit 0.078 % des séances (1 fois sur 1280).
   - exécution **1.336 pt plus bas** dans le cas TYPIQUE (médiane), 1.336 au p90, **1.336 au pire**
   - perte réelle **9.986 %** en moyenne _(tirée par la queue)_, jusqu'à **9.986 %** — au lieu des 8.65 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1281 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.1697** [0.1195 ; 0.2309] _(largeur 11.1 pt, n_eff 173.1)_
   - swing : **0.3467** [0.298 ; 0.398] _(largeur 10.0 pt, n_eff 345.8)_
   - deep : **0.3051** [0.2583 ; 0.3551] _(largeur 9.7 pt, n_eff 345.8)_
...
- **β de baisse : 1.3689** (β de hausse 1.336, asymétrie 1.0246) vs FCHI — 619 séances de repli, historique complet
...
- **Couple retenu** : stop 297.8821 sur atr_grid (4.5 ATR, 10.168 %) — p(stop avant cible) 0.079 [0.05 ; 0.11], R/R 0.884, perte reelle 10.168 % (gap inclus), CVaR 10.168 %, EV 1.1544 % — **NON CONFORME (best_effort — proposition de derniere main)**
   - viole : R/R 0.88 < plancher 3.00 (mesure vs SPOT, gap inclus)
- Budget de queue : **12.0 %** du notionnel — ⚠ VALEUR FIGEE (valeur de repli (ligne absente de l'allocation)), PAS une mesure. L'allocation derivee de la contrainte du compte n'etait pas disponible.
- Candidats (la structure propose, la statistique elimine) :
   - ⚪ atr_based a 1.5 ATR (stop 3.389 %) — p(stop avant cible) 0.43 [0.38 ; 0.48], R/R 1.577, perte reelle 5.698 % (gap inclus), EV 0.0516 % — **REFUSE**
      - refuse : R/R 1.58 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ sr_based a 5.24 ATR (stop 13.271 %) — p(stop avant cible) 0.0341 [0.02 ; 0.06], R/R 0.677, perte reelle 13.271 % (gap inclus), EV 1.1186 % — **REFUSE**
      - refuse : R/R 0.68 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 13.27 % > budget 12.00 %
   - 🟢 support a 9.6 ATR (stop 23.118 %) — p(stop avant cible) 0.0015 [0.00 ; 0.01], R/R 0.389, perte reelle 23.118 % (gap inclus), EV 1.136 % — **REFUSE**
      - refuse : R/R 0.39 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 23.12 % > budget 12.00 %
   - ⚪ atr_grid a 0.25 ATR (stop 0.565 %) — p(stop avant cible) 0.8877 [0.85 ; 0.92], R/R 6.881, perte reelle 1.306 % (gap inclus), EV -0.4376 % — **REFUSE**
      - refuse : cible atteinte seulement 5.2 % du temps (< 15 %) meme a 10 seances : le R/R de 6.88 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.44 %) : P(cible) 5.2 % x 8.99 % + P(rien) 6.1 % x 4.24 % ne couvrent pas P(stop) 88.8 % x 1.31 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.5 ATR (stop 1.13 %) — p(stop avant cible) 0.772 [0.73 ; 0.81], R/R 4.581, perte reelle 1.962 % (gap inclus), EV -0.2389 % — **REFUSE**
      - refuse : cible atteinte seulement 7.5 % du temps (< 15 %) meme a 10 seances : le R/R de 4.58 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.24 %) : P(cible) 7.5 % x 8.99 % + P(rien) 15.3 % x 3.94 % ne couvrent pas P(stop) 77.2 % x 1.96 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.75 ATR (stop 1.695 %) — p(stop avant cible) 0.676 [0.63 ; 0.72], R/R 3.336, perte reelle 2.694 % (gap inclus), EV -0.0373 % — **REFUSE**
      - refuse : cible atteinte seulement 10.8 % du temps (< 15 %) meme a 10 seances : le R/R de 3.34 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.04 %) : P(cible) 10.8 % x 8.99 % + P(rien) 21.6 % x 3.76 % ne couvrent pas P(stop) 67.6 % x 2.69 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.0 ATR (stop 2.26 %) — p(stop avant cible) 0.5945 [0.54 ; 0.65], R/R 2.451, perte reelle 3.667 % (gap inclus), EV -0.1279 % — **REFUSE**
      - refuse : cible atteinte seulement 12.4 % du temps (< 15 %) meme a 10 seances : le R/R de 2.45 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.13 %) : P(cible) 12.4 % x 8.99 % + P(rien) 28.1 % x 3.33 % ne couvrent pas P(stop) 59.5 % x 3.67 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.25 ATR (stop 2.825 %) — p(stop avant cible) 0.5038 [0.45 ; 0.56], R/R 1.953, perte reelle 4.602 % (gap inclus), EV 0.0083 % — **REFUSE**
      - refuse : cible atteinte seulement 14.1 % du temps (< 15 %) meme a 10 seances : le R/R de 1.95 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
   ...
   - ⚪ atr_grid a 1.75 ATR (stop 3.954 %) — p(stop avant cible) 0.362 [0.31 ; 0.41], R/R 1.458, perte reelle 6.163 % (gap inclus), EV 0.4184 % — **REFUSE**
      - refuse : R/R 1.46 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 2.0 ATR (stop 4.519 %) — p(stop avant cible) 0.3171 [0.27 ; 0.37], R/R 1.322, perte reelle 6.799 % (gap inclus), EV 0.4973 % — **REFUSE**
      - refuse : R/R 1.32 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 2.25 ATR (stop 5.084 %) — p(stop avant cible) 0.2778 [0.23 ; 0.33], R/R 1.17, perte reelle 7.683 % (gap inclus), EV 0.6175 % — **REFUSE**
      - refuse : R/R 1.17 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 2.5 ATR (stop 5.649 %) — p(stop avant cible) 0.2464 [0.20 ; 0.29], R/R 0.9, perte reelle 9.986 % (gap inclus), EV 0.287 % — **REFUSE**
      - refuse : R/R 0.90 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 2.75 ATR (stop 6.214 %) — p(stop avant cible) 0.2268 [0.19 ; 0.27], R/R 0.9, perte reelle 9.986 % (gap inclus), EV 0.5029 % — **REFUSE**
      - refuse : R/R 0.90 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 3.0 ATR (stop 6.779 %) — p(stop avant cible) 0.1758 [0.14 ; 0.22], R/R 0.9, perte reelle 9.986 % (gap inclus), EV 0.7571 % — **REFUSE**
      - refuse : R/R 0.90 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 3.5 ATR (stop 7.909 %) — p(stop avant cible) 0.1376 [0.10 ; 0.18], R/R 0.9, perte reelle 9.986 % (gap inclus), EV 0.9833 % — **REFUSE**
      - refuse : R/R 0.90 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 4.0 ATR (stop 9.038 %) — p(stop avant cible) 0.1053 [0.08 ; 0.14], R/R 0.9, perte reelle 9.986 % (gap inclus), EV 1.1118 % — **REFUSE**
      - refuse : R/R 0.90 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 4.5 ATR (stop 10.168 %) — p(stop avant cible) 0.079 [0.05 ; 0.11], R/R 0.884, perte reelle 10.168 % (gap inclus), EV 1.1544 % — **REFUSE**
      - refuse : R/R 0.88 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ grid_snapped a 5.24 ATR (stop 12.519 %) — p(stop avant cible) 0.0439 [0.03 ; 0.07], R/R 0.718, perte reelle 12.519 % (gap inclus), EV 1.1415 % — **REFUSE**
      - refuse : R/R 0.72 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 12.52 % > budget 12.00 %
   - ⚪ atr_grid a 6.0 ATR (stop 13.558 %) — p(stop avant cible) 0.0341 [0.02 ; 0.06], R/R 0.663, perte reelle 13.558 % (gap inclus), EV 1.1088 % — **REFUSE**
      - refuse : R/R 0.66 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 13.56 % > budget 12.00 %
   - ⚪ atr_grid a 6.5 ATR (stop 14.687 %) — p(stop avant cible) 0.0199 [0.01 ; 0.04], R/R 0.612, perte reelle 14.687 % (gap inclus), EV 1.111 % — **REFUSE**
      - refuse : R/R 0.61 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 14.69 % > budget 12.00 %
   - ⚪ atr_grid a 7.0 ATR (stop 15.817 %) — p(stop avant cible) 0.0099 [0.00 ; 0.02], R/R 0.568, perte reelle 15.817 % (gap inclus), EV 1.1175 % — **REFUSE**
      - refuse : R/R 0.57 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 15.82 % > budget 12.00 %
   - ⚪ atr_grid a 7.5 ATR (stop 16.947 %) — p(stop avant cible) 0.0068 [0.00 ; 0.02], R/R 0.53, perte reelle 16.947 % (gap inclus), EV 1.1245 % — **REFUSE**
      - refuse : R/R 0.53 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 16.95 % > budget 12.00 %
   - ⚪ atr_grid a 8.0 ATR (stop 18.077 %) — p(stop avant cible) 0.0061 [0.00 ; 0.02], R/R 0.497, perte reelle 18.077 % (gap inclus), EV 1.1229 % — **REFUSE**
...
- Reference : spot 331.6, ATR14 7.4929 (2.26 % du cours). **Les prix ci-dessous sont ancres sur ce spot de cloture : les REANCRER sur le prix vivant avant de poser.**
- **Horizon = consigne operateur.** intraday -> 1 seance ; SANS PRECISION -> swing, 5 seances ; positionnel/long -> 20.
- **Bornes appliquees d'office par le calculateur** : aucune tranche touchee plus de **45.0 %** du temps a l'horizon retenu ; aucune sous le **bruit journalier** du titre (0.345 ATR = 0.78 % du cours, soit l'excursion adverse mediane d'une seance) ; deux tranches jamais separees par moins que ce bruit. Ce sont des DEFAUTS DU MODULE : ils cedent avant toute consigne, et le rapport le dit.

| distance | % du cours | prix (spot ref) | p(touche) 1s | p(touche) 2s | p(touche) 3s | p(touche) 5s | p(touche) 10s | p(touche) 20s |
|---|---|---|---|---|---|---|---|---|
| 0.05 ATR | 0.113 % | 331.2254 | 89.12 % | 92.44 % | 93.61 % | 95.57 % | 96.34 % | 97.1 % |
| 0.1 ATR | 0.226 % | 330.8507 | 81.27 % | 87.14 % | 89.1 % | 91.34 % | 93.47 % | 94.81 % |
| 0.15 ATR | 0.339 % | 330.4761 | 75.0 % | 83.22 % | 86.15 % | 88.58 % | 91.3 % | 92.71 % |
| 0.2 ATR | 0.452 % | 330.1014 | 68.24 % | 78.12 % | 82.51 % | 85.24 % | 88.92 % | 90.91 % |
| 0.25 ATR | 0.565 % | 329.7268 | 61.27 % | 73.41 % | 78.88 % | 83.17 % | 87.64 % | 90.01 % |
| 0.35 ATR | 0.791 % | 328.9775 | 49.41 % | 63.0 % | 69.45 % | 76.57 % | 82.59 % | 87.01 % |
| 0.5 ATR | 1.13 % | 327.8536 | 35.49 % | 51.62 % | 59.04 % | 68.31 % | 75.77 % | 81.32 % |
| 0.75 ATR | 1.695 % | 325.9804 | 20.49 % | 35.53 % | 42.93 % | 52.95 % | 63.11 % | 70.73 % |
| 1.0 ATR | 2.26 % | 324.1071 | 9.71 % | 23.65 % | 32.42 % | 41.73 % | 53.31 % | 61.24 % |
| 1.25 ATR | 2.825 % | 322.2339 | 4.31 % | 15.41 % | 23.97 % | 33.07 % | 45.99 % | 54.45 % |
| 1.5 ATR | 3.389 % | 320.3607 | 2.25 % | 10.01 % | 16.5 % | 25.0 % | 37.78 % | 46.45 % |
| 2.0 ATR | 4.519 % | 316.6143 | 0.98 % | 4.42 % | 7.47 % | 15.35 % | 26.81 % | 36.76 % |
| 2.5 ATR | 5.649 % | 312.8679 | 0.2 % | 1.47 % | 3.54 % | 8.96 % | 18.6 % | 27.97 % |
| 3.0 ATR | 6.779 % | 309.1214 | 0.0 % | 0.88 % | 2.06 % | 5.81 % | 12.46 % | 21.78 % |
| 4.0 ATR | 9.038 % | 301.6286 | 0.0 % | 0.2 % | 0.59 % | 1.08 % | 5.04 % | 11.29 % |
| 6.0 ATR | 13.558 % | 286.6429 | 0.0 % | 0.1 % | 0.2 % | 0.39 % | 1.09 % | 3.1 % |
...
- **2 seance(s)** : plage utile 0.603–0.75 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 0.75 ATR (1.695 %, prix 325.9794), p(touche) 35.53 % (en stress 86.27 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 30.2 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **3 seance(s)** : plage utile 0.718–1.25 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 0.75 ATR (1.695 %, prix 325.9794), p(touche) 42.93 % (en stress 98.04 %)  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 43.5 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **5 seance(s)** : plage utile 0.927–1.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (2.26 %, prix 324.1058), p(touche) 41.73 % (en stress 98.04 %)  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 41.8 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **10 seance(s)** : plage utile 1.28–2.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.5 ATR (3.389 %, prix 320.3621), p(touche) 37.78 % (en stress 100.0 %)  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 37.9 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **20 seance(s)** : plage utile 1.575–3.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 2.0 ATR (4.519 %, prix 316.615), p(touche) 36.76 % (en stress 99.01 %)  ✅ optimum identifie (63.5 % des re-echantillons)
...
- EV/risk : 0.005 | EV/share : €0.040 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 60 % | T2 39 % | T3 23 %
...
- **MACD** : hist -2.892  _(pas de croisement recent)_
- **BB** : %B -0.0 · largeur 10.9%
- **ATR** : 7.49 (46.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV falling · CMF -0.322  _(distribution)_
- **Vol ratio** : 1.2  _(volume normal)_
- **Choppiness** : 40.6  _(transition)_
- **MA** : MA20 350.93 · MA50 343.27 · MA200 310.66  _(prix < MA20)_
- **Dist MA** : MA20 -5.5% · MA50 -3.4% · MA200 +6.7%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (780293 bytes source)._  
