...
**Generated** : 2026-09-21T22:03:36.011714+00:00  
**Santé technique** : 8/10 — **Rating** : Pass  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : range · volatilite low · ₩2917000.00  

> 🟡 **WAIT-FOR-DIP** — spot +3.1 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot ₩2917000.00 (+3.1% vs entrée) · entrée ₩2828170.04 · stop ₩2601916.44 · T1 ₩2891896.57 · R/R 0.28  
> ↳ P(T1 av. stop) 41 % _(réel 5 s)_ · EV/risk 0.02 _(réel 5 s)_ (GBM -0.133) · ¼-Kelly 0.024 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −8.0% cohérent avec le bruit 5 s (EV-optimal ≈ −8.0%)  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal 158 % hors [0,100] (R² max 0.90). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- Entry (zone de repli) : ₩2815424.74–₩2840915.35 (mid ₩2828170.04)
- Spot actuel : ₩2917000.00 (+3.1% au-dessus de la zone — repli à attendre)
- Stop : ₩2601916.44 (stop swing_plan-based (-11.28%))
- Targets : T1 ₩2891896.57 · R/R 0.28 | T2 ₩2955623.10 · R/R 0.56 | T3 ₩3019349.63 · R/R 0.84
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩2601916.44
...
- **Au stop du plan (11.28 %)** : le gap seul le franchit 0.082 % des séances (1 fois sur 1219).
   - exécution **0.406 pt plus bas** dans le cas TYPIQUE (médiane), 0.406 au p90, **0.406 au pire**
   - perte réelle **11.686 %** en moyenne _(tirée par la queue)_, jusqu'à **11.686 %** — au lieu des 11.28 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1220 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.0661** [0.0361 ; 0.1104] _(largeur 7.4 pt, n_eff 173.1)_
   - swing : **0.4537** [0.4018 ; 0.5064] _(largeur 10.5 pt, n_eff 345.6)_
   - deep : **0.3839** [0.3338 ; 0.436] _(largeur 10.2 pt, n_eff 345.6)_
- ⚠ 5 s / swing : probabilite(s) EXACTEMENT nulle(s) : p_no_touch. Ce n'est PAS « jamais » — c'est « aucune occurrence sur 17.4 observations effectives », dont la borne haute a 95 % vaut environ 17.2 %.
- ⚠ 5 s / deep : probabilite(s) EXACTEMENT nulle(s) : p_no_touch. Ce n'est PAS « jamais » — c'est « aucune occurrence sur 17.8 observations effectives », dont la borne haute a 95 % vaut environ 16.8 %.
- ⚠ **5 s — échantillon insuffisant sur : intraday (36.9 pt), swing (42.9 pt), deep (43.4 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
- **VaR/CVaR à 1 j (fenêtre adaptative, 250 séances)** : VaR **-6.93 %** | CVaR **-9.26 %** | vol 4.99 %/j
   - _fenêtre arrêtée : rupture de regime a 300 seances en arriere (volatilite 3.54 % contre 5.82 % aujourd'hui, rapport 0.61)_
...
- EV/risk : -0.133 | EV/share : ₩-30034.424 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 45 % | T2 21 % | T3 20 %
...
- Régime probabiliste (posterior HMM, intraday) : bull 85.0 | bear 8.0 | side 6.9  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −3.043% → cible +2.253% / stop −8.0%, p_fill 56%, n_eff≈25.5) : P(cible|rempli) **41%** · **EV/risk +0.020** (×p_fill ; si rempli +0.29% du capital)
  - **swing** (entrée dip −6.704% → cible +5.038% / stop −4.905%, p_fill 30%, n_eff≈17.4) : P(cible|rempli) **39%** · **EV/risk -0.066** (×p_fill ; si rempli -1.09% du capital)
  - **deep** (entrée dip −10.355% → cible +7.125% / stop −7.658%, p_fill 31%, n_eff≈17.8) : P(cible|rempli) **49%** · **EV/risk -0.015** (×p_fill ; si rempli -0.38% du capital)
...
- **MACD** : hist 4241.459  _(bullish_recent)_
- **BB** : %B 0.6 · largeur 16.5%
- **ATR** : 133500.0 (25.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV rising · CMF 0.092  _(accumulation)_
- **Vol ratio** : 0.74  _(volume normal)_
- **Choppiness** : 65.6  _(marche en range (choppy))_
- **MA** : MA20 2867550.0 · MA50 2768980.0 · MA200 2805216.84  _(prix > MA20)_
- **Dist MA** : MA20 +1.7% · MA50 +5.3% · MA200 +4.0%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (542524 bytes source)._  
