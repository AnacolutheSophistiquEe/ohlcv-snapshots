...
**Generated** : 2026-09-15T00:24:23.469951+00:00  
**Santé technique** : 4/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · ₩2803000.00  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-09-16 — US FOMC Rate Decision (J-1 sess · macro taux)  
> ↳ spot ₩2803000.00 (+2.2% vs entrée) · entrée ₩2742670.04 · stop ₩2523256.44 · T1 ₩2804292.99 · R/R 0.28  
> ↳ P(T1 av. stop) 46 % _(réel 5 s)_ · EV/risk -0.011 _(réel 5 s)_ (GBM -0.133) · ¼-Kelly 0.024 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩2730345.45–₩2754994.63 (mid ₩2742670.04)
- Spot actuel : ₩2803000.00 (+2.2% au-dessus de la zone — repli à attendre)
- Stop : ₩2523256.44 (stop swing_plan-based (-10.41%))
- Targets : T1 ₩2804292.99 · R/R 0.28 | T2 ₩2865915.93 · R/R 0.56 | T3 ₩2927538.88 · R/R 0.84
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩2523256.44
...
- **Au stop du plan (10.41 %)** : le gap seul le franchit 0.082 % des séances (1 fois sur 1217).
   - exécution **1.276 pt plus bas** dans le cas TYPIQUE (médiane), 1.276 au p90, **1.276 au pire**
   - perte réelle **11.686 %** en moyenne _(tirée par la queue)_, jusqu'à **11.686 %** — au lieu des 10.41 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1218 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.07** [0.039 ; 0.1153] _(largeur 7.6 pt, n_eff 173.1)_
   - swing : **0.384** [0.3339 ; 0.4361] _(largeur 10.2 pt, n_eff 345.6)_
   - deep : **0.3403** [0.2918 ; 0.3914] _(largeur 10.0 pt, n_eff 345.6)_
...
- ⚠ **5 s — échantillon insuffisant sur : intraday (34.3 pt), swing (38.7 pt), deep (36.9 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
- **VaR/CVaR à 1 j (fenêtre adaptative, 250 séances)** : VaR **-6.93 %** | CVaR **-9.26 %** | vol 4.99 %/j
   - _fenêtre arrêtée : rupture de regime a 240 seances en arriere (volatilite 3.56 % contre 5.95 % aujourd'hui, rapport 0.60)_
...
- **β de baisse : 1.0759** (β de hausse 0.9988, asymétrie 1.0772) vs KS11 — 554 séances de repli, historique complet


## Edge, scénarios & sizing

- EV/risk : -0.133 | EV/share : ₩-29104.641 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 83.7 | bear 7.4 | side 8.9  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −2.152% → cible +2.247% / stop −8.0%, p_fill 70%, n_eff≈30.2) : P(cible|rempli) **46%** · **EV/risk -0.011** (×p_fill ; si rempli -0.12% du capital)
  - **swing** (entrée dip −4.735% → cible +5.024% / stop −5.957%, p_fill 53%, n_eff≈23.1) : P(cible|rempli) **48%** · **EV/risk -0.083** (×p_fill ; si rempli -0.93% du capital)
  - **deep** (entrée dip −7.317% → cible +7.105% / stop −9.185%, p_fill 55%, n_eff≈23.2) : P(cible|rempli) **65%** · **EV/risk +0.073** (×p_fill ; si rempli +1.23% du capital)
...
- **MACD** : hist -4861.627  _(pas de croisement recent)_
- **BB** : %B 0.36 · largeur 16.5%
- **ATR** : 159071.43 (38.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV falling · CMF 0.079  _(accumulation)_
- **Vol ratio** : 0.54  _(volume atone)_
- **Choppiness** : 49.8  _(transition)_
- **MA** : MA20 2871250.0 · MA50 2781240.0 · MA200 2782734.11  _(prix < MA20)_
- **Dist MA** : MA20 -2.4% · MA50 +0.8% · MA200 +0.7%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (484744 bytes source)._  
