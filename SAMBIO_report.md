...
**Generated** : 2026-09-17T00:28:53.516094+00:00  
**Santé technique** : 3/10 — **Rating** : Pass  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite low · ₩1409000.00  

> 🟡 **WAIT-FOR-DIP** — spot +2.5 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot ₩1409000.00 (+2.5% vs entrée) · entrée ₩1374875.00 · stop ₩1264885.00 · T1 ₩1390126.07 · R/R 0.14  
> ↳ P(T1 av. stop) 45 % _(réel 5 s)_ · EV/risk 0.007 _(réel 5 s)_ (GBM -0.022) · ¼-Kelly 0.116 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩1371824.79–₩1377925.21 (mid ₩1374875.00)
- Spot actuel : ₩1409000.00 (+2.5% au-dessus de la zone — repli à attendre)
- Stop : ₩1264885.00 (stop swing_plan-based (-8.32%))
- Targets : T1 ₩1390126.07 · R/R 0.14 | T2 ₩1405377.14 · R/R 0.28 | T3 ₩1420628.20 · R/R 0.42
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩1264885.00
...
- **Au stop du plan (8.32 %)** : le gap seul le franchit 0.0 % des séances (0 fois sur 1217).
   - exécution **— pt plus bas** dans le cas TYPIQUE (médiane), — au p90, **— au pire**
   - perte réelle **— %** en moyenne _(tirée par la queue)_, jusqu'à **— %** — au lieu des 8.32 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1218 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   ...
   - swing : **0.4123** [0.3613 ; 0.4648] _(largeur 10.3 pt, n_eff 345.6)_
   - deep : **0.4046** [0.3538 ; 0.457] _(largeur 10.3 pt, n_eff 345.6)_
- ⚠ 5 s / intraday : probabilite(s) EXACTEMENT nulle(s) : p_stop_first. Ce n'est PAS « jamais » — c'est « aucune occurrence sur 14.4 observations effectives », dont la borne haute a 95 % vaut environ 20.8 %.
- ⚠ 5 s / swing : probabilite(s) EXACTEMENT nulle(s) : p_no_touch. Ce n'est PAS « jamais » — c'est « aucune occurrence sur 8.6 observations effectives », dont la borne haute a 95 % vaut environ 35.0 %.
- ⚠ **5 s — échantillon insuffisant sur : intraday (47.4 pt), swing (53.1 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
- **VaR/CVaR à 1 j (fenêtre adaptative, 250 séances)** : VaR **-4.06 %** | CVaR **-5.87 %** | vol 2.55 %/j
   - _fenêtre arrêtée : rupture de regime a 300 seances en arriere (volatilite 1.55 % contre 2.72 % aujourd'hui, rapport 0.57)_
...
- **β de baisse : 0.3168** (β de hausse 0.2192, asymétrie 1.4449) vs KS11 — 555 séances de repli, historique complet


## Edge, scénarios & sizing

- EV/risk : -0.022 | EV/share : ₩-2413.147 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 62 % | T2 40 % | T3 17 %
- Kelly (position) : f* 0.464 | ¼-Kelly 0.116 _(fraction du capital ; ¼-Kelly recommandé ; Kelly ≤ 0 ⇒ mise optimale nulle ⇒ Pass, même si l'EV blended scale-out reste marginalement positive)_
- Calibration des probas : _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_
- Régime probabiliste (posterior HMM, intraday) : bull 7.6 | bear 85.7 | side 6.8  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −2.424% → cible +1.109% / stop −8.0%, p_fill 32%, n_eff≈14.4) : P(cible|rempli) **45%** · **EV/risk +0.007** (×p_fill ; si rempli +0.19% du capital)
  - **swing** (entrée dip −5.324% → cible +2.48% / stop −3.165%, p_fill 19%, n_eff≈8.6) : P(cible|rempli) **73%** · **EV/risk +0.051** (×p_fill ; si rempli +0.84% du capital)
...
- **MACD** : hist -13008.172  _(pas de croisement recent)_
- **BB** : %B 0.19 · largeur 17.9%
- **ATR** : 42214.29 (21.0e pct 1a)  _(volatilite basse)_
- **OBV/CMF** : OBV falling · CMF 0.078  _(accumulation)_
- **Vol ratio** : 0.78  _(volume normal)_
- **Choppiness** : 49.7  _(transition)_
- **MA** : MA20 1493100.0 · MA50 1477640.0 · MA200 1562740.0  _(prix < MA20)_
- **Dist MA** : MA20 -5.6% · MA50 -4.6% · MA200 -9.8%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (478422 bytes source)._  
