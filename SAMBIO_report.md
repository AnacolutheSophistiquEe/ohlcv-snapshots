...
**Generated** : 2026-08-25T23:01:00.375242+00:00  
**Santé technique** : 8/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · ₩1582000.00  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot ₩1582000.00 (+0.4% vs entrée) · entrée ₩1576339.03 · stop ₩1450231.90 · T1 ₩1597616.71 · R/R 0.17  
> ↳ P(T1 av. stop) 58 % _(réel 5 s)_ · EV/risk -0.004 _(réel 5 s)_ (GBM -0.031) · ¼-Kelly 0.094 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩1572083.49–₩1580594.56 (mid ₩1576339.03)
- Spot actuel : ₩1582000.00 (+0.4% au-dessus de la zone — repli à attendre)
- Stop : ₩1450231.90 (stop swing_plan-based (-4.05%))
- Targets : T1 ₩1597616.71 · R/R 0.17 | T2 ₩1618894.40 · R/R 0.34 | T3 ₩1640172.08 · R/R 0.51
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩1450231.90
...
- **Au stop du plan (4.05 %)** : le gap seul le franchit 0.411 % des séances (5 fois sur 1218).
   - exécution **1.001 pt plus bas** dans le cas TYPIQUE (médiane), 1.266 au p90, **1.323 au pire**
   - perte réelle **4.846 %** en moyenne _(tirée par la queue)_, jusqu'à **5.373 %** — au lieu des 4.05 % annoncés par la distance
...
- Chocs d'ouverture : p05 -1.276 % | p01 -2.574 % | pire -5.373 % _(sur 1218 séances)_
...
- ⚠ **5 s — échantillon insuffisant sur : intraday (30.5 pt), swing (30.7 pt), deep (30.5 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
...
- **β de baisse : 0.3181** (β de hausse 0.2207, asymétrie 1.4412) vs KS11 — 554 séances de repli, historique complet


## Edge, scénarios & sizing

- EV/risk : -0.031 | EV/share : ₩-3883.458 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 73.2 | bear 19.9 | side 6.9  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.359% → cible +1.35% / stop −8.0%, p_fill 91%, n_eff≈37.8) : P(cible|rempli) **58%** · **EV/risk -0.004** (×p_fill ; si rempli -0.04% du capital)
  - **swing** (entrée dip −0.786% → cible +3.018% / stop −3.29%, p_fill 93%, n_eff≈38.3) : P(cible|rempli) **51%** · **EV/risk -0.035** (×p_fill ; si rempli -0.12% du capital)
  - **deep** (entrée dip −1.213% → cible +4.268% / stop −4.957%, p_fill 85%, n_eff≈36.6) : P(cible|rempli) **61%** · **EV/risk +0.096** (×p_fill ; si rempli +0.56% du capital)
...
- **RSI** : 65.7  _(momentum haussier)_
- **ADX** : 16.8  _(pas de tendance nette)_
- **MACD** : hist -873.405  _(pas de croisement recent)_
- **BB** : %B 0.76 · largeur 11.7%
- **ATR** : 51642.86 (50.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV rising · CMF 0.197  _(accumulation)_
- **Vol ratio** : 0.64  _(volume normal)_
- **Choppiness** : 54.4  _(transition)_
- **MA** : MA20 1534700.0 · MA50 1445760.0 · MA200 1595016.51  _(prix > MA20)_
- **Dist MA** : MA20 +3.1% · MA50 +9.4% · MA200 -0.8%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (535842 bytes source)._  
