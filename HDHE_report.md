...
- **Au stop du plan (7.85 %)** : le gap seul le franchit 0.082 % des séances ; quand il le franchit, l'exécution est **3.865 points plus bas** → perte réelle **11.715 %** _(et non 7.85 %)_
