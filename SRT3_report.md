...
**Generated** : 2026-07-02T21:37:30.101341+00:00  
**Santé technique** : 6/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite high · €231.10  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-07-02 — US Employment Situation (NFP / unemployment / earnings) (J-0 sess · macro taux)  
> ↳ spot €231.10 (+3.0% vs entrée) · entrée €224.43 · stop €220.92 · T1 €231.45 · R/R 2.0  
> ↳ P(T1 av. stop) 35 % _(réel 5 s)_ · EV/risk -0.012 _(réel 5 s)_ (GBM 0.0) · ¼-Kelly 0.003 · _first-passage empirique daily (historique réel, n≈215) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €223.03–€225.84 (mid €224.43)
- Spot actuel : €231.10 (+3.0% au-dessus de la zone — repli à attendre)
- Stop : €220.92 (stop swing_plan-based (-4.41%))
- Targets : T1 €231.45 · R/R 2.0 | T2 €238.48 · R/R 4.0 | T3 €245.50 · R/R 6.0
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €220.92
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −1.309% → cible +1.399% / stop −3.0%, p_fill 57%, n_eff≈24.2) : P(cible|rempli) **39%** · **EV/risk -0.037** (×p_fill ; si rempli -0.20% du capital)
  - **swing** (entrée dip −2.891% → cible +3.129% / stop −1.565%, p_fill 38%, n_eff≈15.0) : P(cible|rempli) **35%** · **EV/risk -0.012** (×p_fill ; si rempli -0.05% du capital)
  - **deep** (entrée dip −4.456% → cible +4.425% / stop −2.213%, p_fill 45%, n_eff≈15.8) : P(cible|rempli) **34%** · **EV/risk +0.009** (×p_fill ; si rempli +0.05% du capital)
...
- **ATR** : 9.66 (82.0e pct 1a)  _(volatilite elevee)_
- **OBV/CMF** : OBV rising · CMF -0.144  _(distribution)_
- **Vol ratio** : 0.56  _(volume atone)_
- **Choppiness** : 51.3  _(transition)_
- **MA** : MA20 228.12 · MA50 225.96 · MA200 229.36  _(prix > MA20)_
- **Dist MA** : MA20 +1.3% · MA50 +2.3% · MA200 +0.8%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (95373 bytes source)._  
