...
**Generated** : 2026-09-22T21:38:56.743932+00:00  
...
> ↳ spot €253.00 (+2.5% vs entrée) · entrée €246.92 · stop €243.21 · T1 €249.56 · R/R 0.71  
> ↳ P(T1 av. stop) 55 % _(réel 5 s)_ · EV/risk 0.006 _(réel 5 s)_ (GBM 0.058) · ¼-Kelly 0.037 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €246.39–€247.44 (mid €246.92)
- Spot actuel : €253.00 (+2.5% au-dessus de la zone — repli à attendre)
- Stop : €243.21 (stop swing_plan-based (-8.07%))
- Targets : T1 €249.56 · R/R 0.71 | T2 €252.20 · R/R 1.42 | T3 €254.84 · R/R 2.13
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €243.21
...
- **P(stop avant cible)** _(source : daily, 1275 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.3736** [0.3041 ; 0.4473] _(largeur 14.3 pt, n_eff 173.1)_
...
- **β de baisse : 1.0722** (β de hausse 1.1712, asymétrie 0.9155) vs GDAXI — 600 séances de repli, historique complet
...
- **Couple retenu** : stop 222.6822 sur grid_snapped (4.01 ATR, 11.983 %) — p(stop avant cible) 0.067 [0.04 ; 0.10], R/R 0.106, perte reelle 14.205 % (gap inclus), CVaR 11.985 %, EV -0.0921 % — **NON CONFORME (best_effort — proposition de derniere main)**
   - viole : R/R 0.11 < plancher 3.00 (mesure vs SPOT, gap inclus)
- Budget de queue : **12.0 %** du notionnel — ⚠ VALEUR FIGEE (valeur de repli (ligne absente de l'allocation)), PAS une mesure. L'allocation derivee de la contrainte du compte n'etait pas disponible.
- Candidats (la structure propose, la statistique elimine) :
   - ⚪ atr_based a 1.5 ATR (stop 4.171 %) — p(stop avant cible) 0.2624 [0.22 ; 0.31], R/R 0.197, perte reelle 7.669 % (gap inclus), EV -0.9071 % — **REFUSE**
      - refuse : R/R 0.20 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.91 %) : P(cible) 73.5 % x 1.51 % + P(rien) 0.2 % x -1.13 % ne couvrent pas P(stop) 26.2 % x 7.67 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ sr_based a 3.56 ATR (stop 11.633 %) — p(stop avant cible) 0.0697 [0.05 ; 0.10], R/R 0.106, perte reelle 14.205 % (gap inclus), EV -0.1161 % — **REFUSE**
      - refuse : R/R 0.11 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.12 %) : P(cible) 84.3 % x 1.51 % + P(rien) 8.7 % x -4.55 % ne couvrent pas P(stop) 7.0 % x 14.20 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ swing_based a 4.01 ATR (stop 12.884 %) — p(stop avant cible) 0.0558 [0.04 ; 0.08], R/R 0.106, perte reelle 14.205 % (gap inclus), EV -0.0432 % — **REFUSE**
      - refuse : R/R 0.11 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 12.89 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.04 %) : P(cible) 84.3 % x 1.51 % + P(rien) 10.1 % x -5.15 % ne couvrent pas P(stop) 5.6 % x 14.21 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - 🟢 support a 9.06 ATR (stop 26.934 %) — p(stop avant cible) 0.0015 [0.00 ; 0.01], R/R 0.056, perte reelle 26.934 % (gap inclus), EV 0.1299 % — **REFUSE**
      - refuse : R/R 0.06 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 26.93 % > budget 12.00 %
   - ⚪ atr_grid a 0.25 ATR (stop 0.695 %) — p(stop avant cible) 0.6325 [0.58 ; 0.68], R/R 0.953, perte reelle 1.581 % (gap inclus), EV -0.4462 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.45 %) : P(cible) 36.8 % x 1.51 % + P(rien) 0.0 % x 0.00 % ne couvrent pas P(stop) 63.2 % x 1.58 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.5 ATR (stop 1.39 %) — p(stop avant cible) 0.5312 [0.48 ; 0.58], R/R 0.581, perte reelle 2.594 % (gap inclus), EV -0.6715 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.67 %) : P(cible) 46.9 % x 1.51 % + P(rien) 0.0 % x 0.00 % ne couvrent pas P(stop) 53.1 % x 2.59 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.75 ATR (stop 2.086 %) — p(stop avant cible) 0.4368 [0.39 ; 0.49], R/R 0.34, perte reelle 4.426 % (gap inclus), EV -1.0845 % — **REFUSE**
      - refuse : R/R 0.34 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.08 %) : P(cible) 56.3 % x 1.51 % + P(rien) 0.0 % x 0.00 % ne couvrent pas P(stop) 43.7 % x 4.43 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.0 ATR (stop 2.781 %) — p(stop avant cible) 0.3523 [0.30 ; 0.40], R/R 0.239, perte reelle 6.31 % (gap inclus), EV -1.2469 % — **REFUSE**
      - refuse : R/R 0.24 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.25 %) : P(cible) 64.8 % x 1.51 % + P(rien) 0.0 % x 0.00 % ne couvrent pas P(stop) 35.2 % x 6.31 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.25 ATR (stop 3.476 %) — p(stop avant cible) 0.3043 [0.26 ; 0.35], R/R 0.197, perte reelle 7.669 % (gap inclus), EV -1.2853 % — **REFUSE**
      - refuse : R/R 0.20 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.29 %) : P(cible) 69.6 % x 1.51 % + P(rien) 0.0 % x 0.00 % ne couvrent pas P(stop) 30.4 % x 7.67 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.75 ATR (stop 4.867 %) — p(stop avant cible) 0.2362 [0.19 ; 0.28], R/R 0.182, perte reelle 8.26 % (gap inclus), EV -0.8104 % — **REFUSE**
      - refuse : R/R 0.18 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.81 %) : P(cible) 75.8 % x 1.51 % + P(rien) 0.5 % x -0.46 % ne couvrent pas P(stop) 23.6 % x 8.26 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.0 ATR (stop 5.562 %) — p(stop avant cible) 0.2064 [0.17 ; 0.25], R/R 0.182, perte reelle 8.26 % (gap inclus), EV -0.5317 % — **REFUSE**
      - refuse : R/R 0.18 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.53 %) : P(cible) 78.3 % x 1.51 % + P(rien) 1.0 % x -0.70 % ne couvrent pas P(stop) 20.6 % x 8.26 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.25 ATR (stop 6.257 %) — p(stop avant cible) 0.1922 [0.15 ; 0.24], R/R 0.162, perte reelle 9.276 % (gap inclus), EV -0.6007 % — **REFUSE**
      - refuse : R/R 0.16 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.60 %) : P(cible) 79.4 % x 1.51 % + P(rien) 1.4 % x -1.04 % ne couvrent pas P(stop) 19.2 % x 9.28 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.5 ATR (stop 6.952 %) — p(stop avant cible) 0.1765 [0.14 ; 0.22], R/R 0.162, perte reelle 9.276 % (gap inclus), EV -0.4544 % — **REFUSE**
      - refuse : R/R 0.16 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.45 %) : P(cible) 80.6 % x 1.51 % + P(rien) 1.8 % x -1.76 % ne couvrent pas P(stop) 17.6 % x 9.28 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.75 ATR (stop 7.648 %) — p(stop avant cible) 0.161 [0.13 ; 0.20], R/R 0.149, perte reelle 10.096 % (gap inclus), EV -0.4321 % — **REFUSE**
      - refuse : R/R 0.15 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.43 %) : P(cible) 81.8 % x 1.51 % + P(rien) 2.1 % x -1.86 % ne couvrent pas P(stop) 16.1 % x 10.10 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 3.0 ATR (stop 8.343 %) — p(stop avant cible) 0.1406 [0.11 ; 0.18], R/R 0.143, perte reelle 10.559 % (gap inclus), EV -0.3275 % — **REFUSE**
      - refuse : R/R 0.14 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.33 %) : P(cible) 82.8 % x 1.51 % + P(rien) 3.2 % x -2.84 % ne couvrent pas P(stop) 14.1 % x 10.56 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 3.56 ATR (stop 10.732 %) — p(stop avant cible) 0.0828 [0.06 ; 0.12], R/R 0.106, perte reelle 14.205 % (gap inclus), EV -0.2448 % — **REFUSE**
      - refuse : R/R 0.11 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.24 %) : P(cible) 84.0 % x 1.51 % + P(rien) 7.7 % x -4.36 % ne couvrent pas P(stop) 8.3 % x 14.20 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 4.01 ATR (stop 11.983 %) — p(stop avant cible) 0.067 [0.04 ; 0.10], R/R 0.106, perte reelle 14.205 % (gap inclus), EV -0.0921 % — **REFUSE**
      - refuse : R/R 0.11 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.09 %) : P(cible) 84.3 % x 1.51 % + P(rien) 9.0 % x -4.56 % ne couvrent pas P(stop) 6.7 % x 14.21 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 4.5 ATR (stop 12.514 %) — p(stop avant cible) 0.0592 [0.04 ; 0.09], R/R 0.106, perte reelle 14.205 % (gap inclus), EV -0.0569 % — **REFUSE**
      - refuse : R/R 0.11 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 12.52 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.06 %) : P(cible) 84.3 % x 1.51 % + P(rien) 9.8 % x -4.98 % ne couvrent pas P(stop) 5.9 % x 14.21 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 5.0 ATR (stop 13.905 %) — p(stop avant cible) 0.0405 [0.02 ; 0.07], R/R 0.106, perte reelle 14.205 % (gap inclus), EV 0.0518 % — **REFUSE**
      - refuse : R/R 0.11 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 13.91 % > budget 12.00 %
   - ⚪ atr_grid a 5.5 ATR (stop 15.295 %) — p(stop avant cible) 0.0254 [0.01 ; 0.05], R/R 0.099, perte reelle 15.295 % (gap inclus), EV 0.0658 % — **REFUSE**
      - refuse : R/R 0.10 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 15.29 % > budget 12.00 %
   - ⚪ atr_grid a 6.0 ATR (stop 16.685 %) — p(stop avant cible) 0.0068 [0.00 ; 0.02], R/R 0.09, perte reelle 16.685 % (gap inclus), EV 0.1346 % — **REFUSE**
      - refuse : R/R 0.09 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 16.68 % > budget 12.00 %
   - ⚪ atr_grid a 6.5 ATR (stop 18.076 %) — p(stop avant cible) 0.0055 [0.00 ; 0.02], R/R 0.083, perte reelle 18.076 % (gap inclus), EV 0.1348 % — **REFUSE**
      - refuse : R/R 0.08 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 18.08 % > budget 12.00 %
   - ⚪ atr_grid a 7.0 ATR (stop 19.466 %) — p(stop avant cible) 0.0052 [0.00 ; 0.02], R/R 0.077, perte reelle 19.466 % (gap inclus), EV 0.1293 % — **REFUSE**
      - refuse : R/R 0.08 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 19.47 % > budget 12.00 %
   - ⚪ atr_grid a 7.5 ATR (stop 20.857 %) — p(stop avant cible) 0.0052 [0.00 ; 0.02], R/R 0.072, perte reelle 20.857 % (gap inclus), EV 0.1213 % — **REFUSE**
      - refuse : R/R 0.07 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 20.86 % > budget 12.00 %
   - ⚪ atr_grid a 8.0 ATR (stop 22.247 %) — p(stop avant cible) 0.0033 [0.00 ; 0.01], R/R 0.068, perte reelle 22.247 % (gap inclus), EV 0.1249 % — **REFUSE**
      - refuse : R/R 0.07 < plancher 3.00 (mesure vs SPOT, gap inclus)
...
- **Bornes appliquees d'office par le calculateur** : aucune tranche touchee plus de **45.0 %** du temps a l'horizon retenu ; aucune sous le **bruit journalier** du titre (0.381 ATR = 1.06 % du cours, soit l'excursion adverse mediane d'une seance) ; deux tranches jamais separees par moins que ce bruit. Ce sont des DEFAUTS DU MODULE : ils cedent avant toute consigne, et le rapport le dit.
...
| 0.15 ATR | 0.417 % | 251.9446 | 74.85 % | 83.61 % | 86.66 % | 90.5 % | 93.63 % | 94.97 % |
| 0.2 ATR | 0.556 % | 251.5929 | 68.24 % | 78.68 % | 82.71 % | 87.33 % | 92.24 % | 94.37 % |
| 0.25 ATR | 0.695 % | 251.2411 | 62.92 % | 75.32 % | 79.45 % | 84.95 % | 90.45 % | 93.07 % |
| 0.35 ATR | 0.973 % | 250.5375 | 53.06 % | 69.1 % | 73.91 % | 80.79 % | 87.06 % | 90.95 % |
| 0.5 ATR | 1.39 % | 249.4821 | 38.26 % | 56.56 % | 64.33 % | 73.96 % | 82.59 % | 88.24 % |
| 0.75 ATR | 2.086 % | 247.7232 | 19.13 % | 36.62 % | 47.73 % | 59.21 % | 72.44 % | 81.71 % |
| 1.0 ATR | 2.781 % | 245.9643 | 9.76 % | 24.38 % | 34.58 % | 47.72 % | 63.08 % | 74.67 % |
| 1.25 ATR | 3.476 % | 244.2054 | 4.73 % | 14.91 % | 24.6 % | 38.42 % | 53.43 % | 67.54 % |
| 1.5 ATR | 4.171 % | 242.4464 | 2.27 % | 9.87 % | 17.69 % | 30.89 % | 46.27 % | 61.71 % |
| 2.0 ATR | 5.562 % | 238.9286 | 0.69 % | 4.54 % | 8.2 % | 17.23 % | 34.83 % | 51.76 % |
| 2.5 ATR | 6.952 % | 235.4107 | 0.3 % | 1.97 % | 4.74 % | 10.69 % | 24.48 % | 41.81 % |
...
- **1 seance(s)** : plage utile 0.432–0.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 0.5 ATR (1.39 %, prix 249.4833), p(touche) 38.26 % (en stress 83.33 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 42.8 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
...
- **3 seance(s)** : plage utile 0.802–1.25 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (2.781 %, prix 245.9641), p(touche) 34.58 % (en stress 92.16 %)  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 27.8 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
...
- **20 seance(s)** : plage utile 2.34–3.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 2.5 ATR (6.952 %, prix 235.4114), p(touche) 41.81 % (en stress 100.0 %)  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 50.1 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
...
- EV/risk : 0.058 | EV/share : €0.215 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 66 % | T2 38 % | T3 18 %
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −2.406% → cible +1.07% / stop −1.5%, p_fill 13%, n_eff≈12.6) : P(cible|rempli) **55%** · **EV/risk +0.006** (×p_fill ; si rempli +0.07% du capital)
...
- **MACD** : hist 1.199  _(bullish_recent)_
- **BB** : %B 0.84 · largeur 12.5%
...
- **MA** : MA20 242.56 · MA50 236.44 · MA200 232.88  _(prix > MA20)_
- **Dist MA** : MA20 +4.3% · MA50 +7.0% · MA200 +8.6%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (884759 bytes source)._  
