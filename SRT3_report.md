...
**Generated** : 2026-08-12T00:02:07.615200+00:00  
**Santé technique** : 7/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite high · €238.50  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-08-12 — US Core CPI (ex food & energy) (J-0 sess · macro taux)  
> ↳ spot €238.50 (+1.6% vs entrée) · entrée €234.67 · stop €231.15 · T1 €238.04 · R/R 0.96  
> ↳ P(T1 av. stop) 34 % _(réel 5 s)_ · EV/risk -0.001 _(réel 5 s)_ (GBM 0.045) · ¼-Kelly 0.02 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- 🔴 **Santé haussière vs sur-extension** — Santé technique 7/10 élevée alors que : RSI 74.6 > 70 (surachat) — le score mesure la santé durable, PAS le timing ; entrée au prix actuel défavorable.
...
- Entry (zone de repli) : €233.99–€235.34 (mid €234.67)
- Spot actuel : €238.50 (+1.6% au-dessus de la zone — repli à attendre)
- Stop : €231.15 (stop swing_plan-based (-7.69%))
- Targets : T1 €238.04 · R/R 0.96 | T2 €241.42 · R/R 1.92 | T3 €244.80 · R/R 2.88
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €231.15
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −1.604% → cible +1.44% / stop −1.5%, p_fill 47%, n_eff≈20.9) : P(cible|rempli) **34%** · **EV/risk -0.001** (×p_fill ; si rempli -0.00% du capital)
  - **swing** (entrée dip −3.533% → cible +3.219% / stop −4.309%, p_fill 30%, n_eff≈11.1) : P(cible|rempli) **66%** · **EV/risk +0.041** (×p_fill ; si rempli +0.59% du capital)
  - **deep** (entrée dip −5.465% → cible +4.552% / stop −6.596%, p_fill 30%, n_eff≈10.4) : P(cible|rempli) **55%** · **EV/risk -0.032** (×p_fill ; si rempli -0.69% du capital)
...
- **MACD** : hist 1.434  _(bullish_recent)_
...
- **MA** : MA20 230.57 · MA50 230.48 · MA200 231.96  _(prix > MA20)_
- **Dist MA** : MA20 +3.4% · MA50 +3.5% · MA200 +2.8%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (95329 bytes source)._  
