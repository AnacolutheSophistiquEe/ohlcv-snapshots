...
**Generated** : 2026-08-11T21:37:03.140555+00:00  
**Santé technique** : 7/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite high · €238.30  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-08-12 — US CPI (headline) (J-1 sess · macro taux)  
> ↳ spot €238.30 (+1.6% vs entrée) · entrée €234.52 · stop €231.00 · T1 €237.89 · R/R 0.96  
> ↳ P(T1 av. stop) 34 % _(réel 5 s)_ · EV/risk -0.003 _(réel 5 s)_ (GBM 0.045) · ¼-Kelly 0.02 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- 🔴 **Santé haussière vs sur-extension** — Santé technique 7/10 élevée alors que : RSI 74.2 > 70 (surachat) — le score mesure la santé durable, PAS le timing ; entrée au prix actuel défavorable.
...
- Entry (zone de repli) : €233.84–€235.19 (mid €234.52)
- Spot actuel : €238.30 (+1.6% au-dessus de la zone — repli à attendre)
- Stop : €231.00 (stop swing_plan-based (-7.65%))
- Targets : T1 €237.89 · R/R 0.96 | T2 €241.27 · R/R 1.92 | T3 €244.64 · R/R 2.87
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €231.00


## Edge, scénarios & sizing

- EV/risk : 0.045 | EV/share : €0.160 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 56 % | T2 23 % | T3 7 %
...
- Régime probabiliste (posterior HMM, intraday) : bull 20.8 | bear 70.7 | side 8.6  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 477.0 (= 2 part(s) × prix) · cible 512.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −1.584% → cible +1.439% / stop −1.5%, p_fill 47%, n_eff≈20.9) : P(cible|rempli) **34%** · **EV/risk -0.003** (×p_fill ; si rempli -0.01% du capital)
  - **swing** (entrée dip −3.489% → cible +3.219% / stop −4.311%, p_fill 30%, n_eff≈11.1) : P(cible|rempli) **66%** · **EV/risk +0.041** (×p_fill ; si rempli +0.59% du capital)
  - **deep** (entrée dip −5.399% → cible +4.552% / stop −6.597%, p_fill 30%, n_eff≈10.4) : P(cible|rempli) **55%** · **EV/risk -0.032** (×p_fill ; si rempli -0.69% du capital)
...
- **RSI** : 74.3  _(surachat)_
- **ADX** : 16.6  _(pas de tendance nette)_
- **MACD** : hist 1.421  _(bullish_recent)_
- **BB** : %B 0.68 · largeur 18.5%
- **ATR** : 9.91 (81.0e pct 1a)  _(volatilite elevee)_
- **OBV/CMF** : OBV rising · CMF -0.095  _(distribution)_
- **Vol ratio** : 0.5  _(volume atone)_
- **Choppiness** : 58.2  _(transition)_
- **MA** : MA20 230.56 · MA50 230.48 · MA200 231.96  _(prix > MA20)_
- **Dist MA** : MA20 +3.4% · MA50 +3.4% · MA200 +2.7%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (95352 bytes source)._  
