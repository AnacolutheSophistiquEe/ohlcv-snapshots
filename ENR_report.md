...
**Generated** : 2026-09-08T21:46:10.038988+00:00  
**Santé technique** : 5/10 — **Rating** : Neutral  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · €148.86  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-09-10 — ECB Monetary Policy Decision (J-1 sess · macro taux)  
> ↳ spot €148.86 (+3.7% vs entrée) · entrée €143.54 · stop €132.05 · T1 €145.30 · R/R 0.15  
> ↳ P(T1 av. stop) 96 % · EV/risk 0.163 · ¼-Kelly 0.097 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €143.18–€143.89 (mid €143.54)
- Spot actuel : €148.86 (+3.7% au-dessus de la zone — repli à attendre)
- Stop : €132.05 (stop swing_plan-based (-11.18%))
- Targets : T1 €145.30 · R/R 0.15 | T2 €147.07 · R/R 0.31 | T3 €148.84 · R/R 0.46
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €132.05


## Risque mesuré — ce qui borne (et ce qui ne borne pas) la perte

- 🟠 **Régime de gap : intermediaire** — p_breach(-3 %)=2.51 % — entre les deux regimes ; ni queue pure ni franchissement ordinaire
- **Au stop du plan (11.18 %)** : le gap seul le franchit 0.236 % des séances (3 fois sur 1273).
   - exécution **4.99 pt plus bas** dans le cas TYPIQUE (médiane), 20.66 au p90, **24.577 au pire**
   - perte réelle **21.854 %** en moyenne _(tirée par la queue)_, jusqu'à **35.757 %** — au lieu des 11.18 % annoncés par la distance
   - coût AMORTI sur toutes les séances : 0.0252 % _(ce que le gap coûte en moyenne, pas ce qu'il coûte le jour où il frappe)_
...
- **β de baisse : 1.3529** (β de hausse 1.0928, asymétrie 1.238) vs GDAXI — 599 séances de repli, historique complet
   - ⚠ le β de baisse récent vaut 1.422× celui de l'historique complet : la sensibilité du titre au marché a changé.


## Echelle Warden — OU poser le stop

- **Verdict : AUCUN couple (stop, cible) ne tient les contraintes. Ce n'est pas un defaut du calcul : la structure est trop loin sous le spot pour qu'un stop structurel soit rentable a ces cibles. Le levier de fond n'est PAS la distance du stop mais la TAILLE de la ligne — voir `min_target_for_rr` pour savoir a partir de quelle cible chaque stop redeviendrait defendable. **MAIS ON POSE QUAND MEME** : `best_effort` porte le moins mauvais couple, non conforme et marque comme tel. Laisser la ligne NUE est pire — la perte y est non bornee.**
- **Couple retenu** : stop 131.63 sur atr_grid (3.5 ATR, 11.575 %) — p(stop avant cible) 0.1781 [0.14 ; 0.22], R/R 1.197, perte reelle 21.854 % (gap inclus), CVaR 11.599 %, EV -1.3153 % — **NON CONFORME (best_effort — proposition de derniere main)**
...
- Candidats (la structure propose, la statistique elimine) :
   - ⚪ atr_based a 1.5 ATR (stop 4.961 %) — p(stop avant cible) 0.5919 [0.54 ; 0.64], R/R 2.731, perte reelle 9.581 % (gap inclus), EV -2.676 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 2.73 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.68 %) : P(cible) 1.0 % x 26.16 % + P(rien) 39.9 % x 6.89 % ne couvrent pas P(stop) 59.2 % x 9.58 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ swing_based a 2.17 ATR (stop 9.327 %) — p(stop avant cible) 0.3019 [0.26 ; 0.35], R/R 1.197, perte reelle 21.854 % (gap inclus), EV -3.5128 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.51 %) : P(cible) 1.0 % x 26.16 % + P(rien) 68.8 % x 4.11 % ne couvrent pas P(stop) 30.2 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ sr_based a 4.43 ATR (stop 16.786 %) — p(stop avant cible) 0.0358 [0.02 ; 0.06], R/R 0.732, perte reelle 35.757 % (gap inclus), EV 0.614 % — **REFUSE**
   ...
   - 🟢 support a 7.88 ATR (stop 28.201 %) — p(stop avant cible) 0.0036 [0.00 ; 0.01], R/R 0.732, perte reelle 35.757 % (gap inclus), EV 1.4423 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 0.73 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.73 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 28.21 % > budget 12.00 %
   - 🟢 support a 11.97 ATR (stop 41.746 %) — p(stop avant cible) 0.0007 [0.00 ; 0.01], R/R 0.627, perte reelle 41.746 % (gap inclus), EV 1.4921 % — **REFUSE**
      ...
      - refuse : CVaR 95 % 41.75 % > budget 12.00 %
   - ⚪ atr_grid a 0.25 ATR (stop 0.827 %) — p(stop avant cible) 0.9355 [0.91 ; 0.96], R/R 12.276, perte reelle 2.131 % (gap inclus), EV -1.2998 % — **REFUSE**
      - refuse : cible atteinte seulement 0.2 % du temps (< 15 %) meme a 10 seances : le R/R de 12.28 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.30 %) : P(cible) 0.2 % x 26.16 % + P(rien) 6.2 % x 10.24 % ne couvrent pas P(stop) 93.5 % x 2.13 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.5 ATR (stop 1.654 %) — p(stop avant cible) 0.8587 [0.82 ; 0.89], R/R 7.384, perte reelle 3.543 % (gap inclus), EV -1.676 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 7.38 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.68 %) : P(cible) 0.5 % x 26.16 % + P(rien) 13.7 % x 9.09 % ne couvrent pas P(stop) 85.9 % x 3.54 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.75 ATR (stop 2.48 %) — p(stop avant cible) 0.7872 [0.74 ; 0.83], R/R 5.394, perte reelle 4.85 % (gap inclus), EV -1.8975 % — **REFUSE**
      - refuse : cible atteinte seulement 0.8 % du temps (< 15 %) meme a 10 seances : le R/R de 5.39 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.90 %) : P(cible) 0.8 % x 26.16 % + P(rien) 20.5 % x 8.39 % ne couvrent pas P(stop) 78.7 % x 4.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.0 ATR (stop 3.307 %) — p(stop avant cible) 0.7073 [0.66 ; 0.75], R/R 3.753, perte reelle 6.97 % (gap inclus), EV -2.4789 % — **REFUSE**
      - refuse : cible atteinte seulement 0.8 % du temps (< 15 %) meme a 10 seances : le R/R de 3.75 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.48 %) : P(cible) 0.8 % x 26.16 % + P(rien) 28.5 % x 7.89 % ne couvrent pas P(stop) 70.7 % x 6.97 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.25 ATR (stop 4.134 %) — p(stop avant cible) 0.631 [0.58 ; 0.68], R/R 3.316, perte reelle 7.889 % (gap inclus), EV -2.1476 % — **REFUSE**
      - refuse : cible atteinte seulement 0.9 % du temps (< 15 %) meme a 10 seances : le R/R de 3.32 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.15 %) : P(cible) 0.9 % x 26.16 % + P(rien) 36.0 % x 7.23 % ne couvrent pas P(stop) 63.1 % x 7.89 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.75 ATR (stop 5.787 %) — p(stop avant cible) 0.5265 [0.47 ; 0.58], R/R 2.204, perte reelle 11.87 % (gap inclus), EV -3.1932 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 2.20 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.19 %) : P(cible) 1.0 % x 26.16 % + P(rien) 46.4 % x 6.05 % ne couvrent pas P(stop) 52.6 % x 11.87 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 2.17 ATR (stop 8.17 %) — p(stop avant cible) 0.3753 [0.33 ; 0.43], R/R 1.408, perte reelle 18.578 % (gap inclus), EV -3.7862 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.79 %) : P(cible) 1.0 % x 26.16 % + P(rien) 61.5 % x 4.76 % ne couvrent pas P(stop) 37.5 % x 18.58 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 3.0 ATR (stop 9.921 %) — p(stop avant cible) 0.2742 [0.23 ; 0.32], R/R 1.197, perte reelle 21.854 % (gap inclus), EV -2.9572 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 1.20 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.20 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.96 %) : P(cible) 1.0 % x 26.16 % + P(rien) 71.6 % x 3.88 % ne couvrent pas P(stop) 27.4 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 3.5 ATR (stop 11.575 %) — p(stop avant cible) 0.1781 [0.14 ; 0.22], R/R 1.197, perte reelle 21.854 % (gap inclus), EV -1.3153 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 1.20 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.20 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.32 %) : P(cible) 1.0 % x 26.16 % + P(rien) 81.2 % x 2.85 % ne couvrent pas P(stop) 17.8 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 4.0 ATR (stop 13.228 %) — p(stop avant cible) 0.1021 [0.07 ; 0.14], R/R 1.197, perte reelle 21.854 % (gap inclus), EV 0.1159 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 1.20 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.20 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 13.25 % > budget 12.00 %
   - ⚪ grid_snapped a 4.43 ATR (stop 15.629 %) — p(stop avant cible) 0.0531 [0.03 ; 0.08], R/R 1.008, perte reelle 25.963 % (gap inclus), EV 0.6623 % — **REFUSE**
   ...
   - ⚪ atr_grid a 5.5 ATR (stop 18.189 %) — p(stop avant cible) 0.0285 [0.01 ; 0.05], R/R 0.732, perte reelle 35.757 % (gap inclus), EV 0.8174 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 0.73 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.73 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 18.20 % > budget 12.00 %
   - ⚪ atr_grid a 6.0 ATR (stop 19.842 %) — p(stop avant cible) 0.014 [0.01 ; 0.03], R/R 0.732, perte reelle 35.757 % (gap inclus), EV 1.1858 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 0.73 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.73 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 19.85 % > budget 12.00 %
   - ⚪ atr_grid a 6.5 ATR (stop 21.496 %) — p(stop avant cible) 0.0081 [0.00 ; 0.02], R/R 0.732, perte reelle 35.757 % (gap inclus), EV 1.2905 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 0.73 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.73 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 21.51 % > budget 12.00 %
   - ⚪ atr_grid a 7.0 ATR (stop 23.149 %) — p(stop avant cible) 0.0058 [0.00 ; 0.02], R/R 0.732, perte reelle 35.757 % (gap inclus), EV 1.3626 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 0.73 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.73 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 23.16 % > budget 12.00 %
   - ⚪ atr_grid a 7.5 ATR (stop 24.803 %) — p(stop avant cible) 0.0051 [0.00 ; 0.02], R/R 0.732, perte reelle 35.757 % (gap inclus), EV 1.3901 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 0.73 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.73 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 24.81 % > budget 12.00 %
   - 🟢 grid_snapped a 7.88 ATR (stop 27.043 %) — p(stop avant cible) 0.0036 [0.00 ; 0.01], R/R 0.732, perte reelle 35.757 % (gap inclus), EV 1.4423 % — **REFUSE**
      - refuse : cible atteinte seulement 1.0 % du temps (< 15 %) meme a 10 seances : le R/R de 0.73 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.73 < plancher 3.00 (mesure vs SPOT, gap inclus)
...
- Reference : spot 148.86, ATR14 4.9229 (3.307 % du cours). **Les prix ci-dessous sont ancres sur ce spot de cloture : les REANCRER sur le prix vivant avant de poser.**
- **Horizon = consigne operateur.** intraday -> 1 seance ; SANS PRECISION -> swing, 5 seances ; positionnel/long -> 20.
- **Bornes appliquees d'office par le calculateur** : aucune tranche touchee plus de **45.0 %** du temps a l'horizon retenu ; aucune sous le **bruit journalier** du titre (0.367 ATR = 1.214 % du cours, soit l'excursion adverse mediane d'une seance) ; deux tranches jamais separees par moins que ce bruit. Ce sont des DEFAUTS DU MODULE : ils cedent avant toute consigne, et le rapport le dit.

| distance | % du cours | prix (spot ref) | p(touche) 1s | p(touche) 2s | p(touche) 3s | p(touche) 5s | p(touche) 10s | p(touche) 20s |
|---|---|---|---|---|---|---|---|---|
| 0.05 ATR | 0.165 % | 148.6139 | 91.31 % | 93.97 % | 95.55 % | 96.23 % | 97.21 % | 97.89 % |
| 0.1 ATR | 0.331 % | 148.3677 | 83.71 % | 87.94 % | 90.6 % | 92.77 % | 94.62 % | 95.67 % |
| 0.15 ATR | 0.496 % | 148.1216 | 76.31 % | 82.31 % | 86.05 % | 88.8 % | 91.24 % | 93.26 % |
| 0.2 ATR | 0.661 % | 147.8754 | 70.29 % | 79.05 % | 83.18 % | 86.62 % | 89.44 % | 91.85 % |
| 0.25 ATR | 0.827 % | 147.6293 | 63.87 % | 74.8 % | 79.62 % | 83.65 % | 87.35 % | 90.44 % |
| 0.35 ATR | 1.157 % | 147.137 | 51.73 % | 65.02 % | 70.72 % | 76.31 % | 81.97 % | 86.32 % |
| 0.5 ATR | 1.654 % | 146.3986 | 36.33 % | 52.08 % | 59.84 % | 66.8 % | 74.4 % | 80.18 % |
| 0.75 ATR | 2.48 % | 145.1679 | 19.94 % | 36.17 % | 45.4 % | 54.81 % | 65.34 % | 73.24 % |
| 1.0 ATR | 3.307 % | 143.9371 | 11.15 % | 25.59 % | 34.42 % | 44.3 % | 56.67 % | 64.89 % |
| 1.25 ATR | 4.134 % | 142.7064 | 6.12 % | 17.29 % | 25.12 % | 35.88 % | 48.11 % | 57.24 % |
| 1.5 ATR | 4.961 % | 141.4757 | 2.86 % | 11.07 % | 17.8 % | 27.75 % | 41.04 % | 50.91 % |
| 2.0 ATR | 6.614 % | 139.0143 | 0.79 % | 4.05 % | 8.7 % | 16.15 % | 27.99 % | 39.64 % |
| 2.5 ATR | 8.268 % | 136.5529 | 0.3 % | 1.98 % | 4.15 % | 9.42 % | 19.32 % | 29.98 % |
| 3.0 ATR | 9.921 % | 134.0914 | 0.1 % | 0.79 % | 1.88 % | 4.86 % | 12.35 % | 22.33 % |
| 4.0 ATR | 13.228 % | 129.1686 | 0.1 % | 0.4 % | 1.09 % | 2.38 % | 6.47 % | 12.68 % |
| 6.0 ATR | 19.842 % | 119.3229 | 0.0 % | 0.2 % | 0.4 % | 0.89 % | 2.29 % | 5.43 % |
...
| **20 s.** | 0.69 ATR | 1.54 ATR | 1.76 ATR | 2.34 ATR | 2.83 ATR | 3.24 ATR | 4.74 ATR | hors grille |
...
- **2 seance(s)** : plage utile 0.611–1.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 0.75 ATR (2.48 %, prix 145.1683), p(touche) 36.17 % (en stress 91.18 %)  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 37.8 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **3 seance(s)** : plage utile 0.759–1.25 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (3.307 %, prix 143.9372), p(touche) 34.42 % (en stress 91.18 %)  ✅ optimum identifie (85.1 % des re-echantillons)
- **5 seance(s)** : plage utile 0.983–1.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (3.307 %, prix 143.9372), p(touche) 44.3 % (en stress 99.01 %)  ✅ optimum identifie (89.8 % des re-echantillons)
- **10 seance(s)** : plage utile 1.36–2.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.5 ATR (4.961 %, prix 141.4751), p(touche) 41.04 % (en stress 100.0 %)  ✅ optimum identifie (92.4 % des re-echantillons)
- **20 seance(s)** : plage utile 1.762–3.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 2.0 ATR (6.614 %, prix 139.0144), p(touche) 39.64 % (en stress 99.0 %)  ✅ optimum identifie (88.5 % des re-echantillons)
...
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 55 % | T2 29 % | T3 14 %
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −3.576% → cible +1.232% / stop −8.0%, p_fill 15%, n_eff≈11.0) : P(cible|rempli) **63%** · **EV/risk +0.004** (×p_fill ; si rempli +0.19% du capital)
...
- **MACD** : hist -0.483  _(pas de croisement recent)_
- **BB** : %B 0.39 · largeur 17.4%
...
- **MA** : MA20 151.89 · MA50 152.63 · MA200 150.65  _(prix < MA20)_
- **Dist MA** : MA20 -2.0% · MA50 -2.5% · MA200 -1.2%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (771406 bytes source)._  
