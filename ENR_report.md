...
**Generated** : 2026-09-10T21:43:51.398002+00:00  
**Santé technique** : 2/10 — **Rating** : Pass  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · €140.82  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-09-11 — US CPI (headline) (J-1 sess · macro taux)  
> ↳ spot €140.82 (+5.1% vs entrée) · entrée €134.04 · stop €129.05 · T1 €137.66 · R/R 0.73  
> ↳ P(T1 av. stop) 47 % _(réel 5 s)_ · EV/risk 0.002 _(réel 5 s)_ (GBM 0.047) · ¼-Kelly 0.011 · _first-passage empirique daily (historique réel, n≈215) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €133.31–€134.76 (mid €134.04)
- Spot actuel : €140.82 (+5.1% au-dessus de la zone — repli à attendre)
- Stop : €129.05 (stop swing_plan-based (-8.36%))
- Targets : T1 €137.66 · R/R 0.73 | T2 €141.28 · R/R 1.45 | T3 €144.91 · R/R 2.18
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €129.05


## Risque mesuré — ce qui borne (et ce qui ne borne pas) la perte

- 🟠 **Régime de gap : intermediaire** — p_breach(-3 %)=2.51 % — entre les deux regimes ; ni queue pure ni franchissement ordinaire
- **Au stop du plan (8.36 %)** : le gap seul le franchit 0.314 % des séances (4 fois sur 1273).
   - exécution **6.543 pt plus bas** dans le cas TYPIQUE (médiane), 21.521 au p90, **27.397 au pire**
   - perte réelle **18.578 %** en moyenne _(tirée par la queue)_, jusqu'à **35.757 %** — au lieu des 8.36 % annoncés par la distance
...
- **β de baisse : 1.3544** (β de hausse 1.0913, asymétrie 1.241) vs GDAXI — 600 séances de repli, historique complet
...
- **Couple retenu** : stop 124.7974 sur sr_based (2.58 ATR, 11.378 %) — p(stop avant cible) 0.1882 [0.15 ; 0.23], R/R 1.526, perte reelle 21.854 % (gap inclus), CVaR 11.403 %, EV -1.4509 % — **NON CONFORME (best_effort — proposition de derniere main)**
   - viole : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.53 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
...
- Candidats (la structure propose, la statistique elimine) :
   - ⚪ swing_based a 0.53 ATR (stop 4.151 %) — p(stop avant cible) 0.6326 [0.58 ; 0.68], R/R 4.228, perte reelle 7.889 % (gap inclus), EV -2.1484 % — **REFUSE**
      - refuse : cible atteinte seulement 0.3 % du temps (< 15 %) meme a 10 seances : le R/R de 4.23 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.15 %) : P(cible) 0.3 % x 33.35 % + P(rien) 36.4 % x 7.50 % ne couvrent pas P(stop) 63.3 % x 7.89 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_based a 1.5 ATR (stop 5.308 %) — p(stop avant cible) 0.5797 [0.53 ; 0.63], R/R 3.357, perte reelle 9.934 % (gap inclus), EV -2.7654 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 3.36 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.77 %) : P(cible) 0.4 % x 33.35 % + P(rien) 41.7 % x 6.90 % ne couvrent pas P(stop) 58.0 % x 9.93 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ sr_based a 2.58 ATR (stop 11.378 %) — p(stop avant cible) 0.1882 [0.15 ; 0.23], R/R 1.526, perte reelle 21.854 % (gap inclus), EV -1.4509 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.45 %) : P(cible) 0.4 % x 33.35 % + P(rien) 80.8 % x 3.15 % ne couvrent pas P(stop) 18.8 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - 🟢 support a 6.17 ATR (stop 24.093 %) — p(stop avant cible) 0.005 [0.00 ; 0.02], R/R 0.933, perte reelle 35.757 % (gap inclus), EV 1.3635 % — **REFUSE**
   ...
   - 🔴 support a 10.22 ATR (stop 38.412 %) — p(stop avant cible) 0.0013 [0.00 ; 0.01], R/R 0.868, perte reelle 38.412 % (gap inclus), EV 1.4557 % — **REFUSE**
      ...
      - ⚠ support DETECTE a 9.18 ATR du spot — compartiment >=6, mesure a 52.6 % de casse (IC clusterise [0.377 ; 0.667] sur 57 touches, registre point-in-time). C'est un pile ou face : l'ancrage n'apporte rien de plus qu'une distance arbitraire et rapproche le stop du bruit. Si c'est le seul disponible, la ligne n'est pas ancrable et le levier redevient la TAILLE.
   - ⚪ atr_grid a 0.25 ATR (stop 0.885 %) — p(stop avant cible) 0.9313 [0.90 ; 0.95], R/R 15.18, perte reelle 2.197 % (gap inclus), EV -1.3007 % — **REFUSE**
      - refuse : cible atteinte seulement 0.1 % du temps (< 15 %) meme a 10 seances : le R/R de 15.18 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.30 %) : P(cible) 0.1 % x 33.35 % + P(rien) 6.8 % x 10.52 % ne couvrent pas P(stop) 93.1 % x 2.20 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 0.53 ATR (stop 2.948 %) — p(stop avant cible) 0.7566 [0.71 ; 0.80], R/R 5.552, perte reelle 6.007 % (gap inclus), EV -2.3212 % — **REFUSE**
      - refuse : cible atteinte seulement 0.3 % du temps (< 15 %) meme a 10 seances : le R/R de 5.55 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.32 %) : P(cible) 0.3 % x 33.35 % + P(rien) 24.0 % x 8.79 % ne couvrent pas P(stop) 75.7 % x 6.01 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.0 ATR (stop 3.538 %) — p(stop avant cible) 0.6942 [0.64 ; 0.74], R/R 4.598, perte reelle 7.253 % (gap inclus), EV -2.4684 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.47 %) : P(cible) 0.3 % x 33.35 % + P(rien) 30.2 % x 8.11 % ne couvrent pas P(stop) 69.4 % x 7.25 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.75 ATR (stop 6.192 %) — p(stop avant cible) 0.5108 [0.46 ; 0.56], R/R 2.464, perte reelle 13.536 % (gap inclus), EV -3.8534 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.85 %) : P(cible) 0.4 % x 33.35 % + P(rien) 48.6 % x 6.06 % ne couvrent pas P(stop) 51.1 % x 13.54 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.0 ATR (stop 7.077 %) — p(stop avant cible) 0.4574 [0.41 ; 0.51], R/R 1.795, perte reelle 18.578 % (gap inclus), EV -5.3614 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.80 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.80 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-5.36 %) : P(cible) 0.4 % x 33.35 % + P(rien) 53.9 % x 5.60 % ne couvrent pas P(stop) 45.7 % x 18.58 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.25 ATR (stop 7.962 %) — p(stop avant cible) 0.3916 [0.34 ; 0.44], R/R 1.795, perte reelle 18.578 % (gap inclus), EV -4.0801 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.80 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.80 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-4.08 %) : P(cible) 0.4 % x 33.35 % + P(rien) 60.5 % x 5.09 % ne couvrent pas P(stop) 39.2 % x 18.58 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 2.58 ATR (stop 10.175 %) — p(stop avant cible) 0.2594 [0.22 ; 0.31], R/R 1.526, perte reelle 21.854 % (gap inclus), EV -2.7284 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.53 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.53 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.73 %) : P(cible) 0.4 % x 33.35 % + P(rien) 73.7 % x 3.83 % ne couvrent pas P(stop) 25.9 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 3.5 ATR (stop 12.385 %) — p(stop avant cible) 0.1415 [0.11 ; 0.18], R/R 1.526, perte reelle 21.854 % (gap inclus), EV -0.6403 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.53 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.53 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 12.41 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.64 %) : P(cible) 0.4 % x 33.35 % + P(rien) 85.5 % x 2.73 % ne couvrent pas P(stop) 14.1 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 4.0 ATR (stop 14.154 %) — p(stop avant cible) 0.0803 [0.06 ; 0.11], R/R 1.285, perte reelle 25.963 % (gap inclus), EV 0.1108 % — **REFUSE**
   ...
   - ⚪ atr_grid a 4.5 ATR (stop 15.923 %) — p(stop avant cible) 0.0438 [0.03 ; 0.07], R/R 1.285, perte reelle 25.963 % (gap inclus), EV 0.7997 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.28 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.28 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 15.94 % > budget 12.00 %
   - ⚪ atr_grid a 5.0 ATR (stop 17.692 %) — p(stop avant cible) 0.0316 [0.02 ; 0.05], R/R 0.933, perte reelle 35.757 % (gap inclus), EV 0.7009 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.93 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.93 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 17.71 % > budget 12.00 %
   - ⚪ atr_grid a 5.5 ATR (stop 19.462 %) — p(stop avant cible) 0.022 [0.01 ; 0.04], R/R 0.933, perte reelle 35.757 % (gap inclus), EV 0.9615 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.93 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.93 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 19.47 % > budget 12.00 %
   - 🟢 grid_snapped a 6.17 ATR (stop 22.89 %) — p(stop avant cible) 0.0058 [0.00 ; 0.02], R/R 0.933, perte reelle 35.757 % (gap inclus), EV 1.3325 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.93 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.93 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 22.90 % > budget 12.00 %
   - ⚪ atr_grid a 7.0 ATR (stop 24.769 %) — p(stop avant cible) 0.005 [0.00 ; 0.02], R/R 0.933, perte reelle 35.757 % (gap inclus), EV 1.3635 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.93 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.93 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 24.78 % > budget 12.00 %
   - ⚪ atr_grid a 7.5 ATR (stop 26.538 %) — p(stop avant cible) 0.0035 [0.00 ; 0.01], R/R 0.933, perte reelle 35.757 % (gap inclus), EV 1.4157 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.93 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.93 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 26.55 % > budget 12.00 %
   - ⚪ atr_grid a 8.0 ATR (stop 28.308 %) — p(stop avant cible) 0.0035 [0.00 ; 0.01], R/R 0.933, perte reelle 35.757 % (gap inclus), EV 1.4157 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.93 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.93 < plancher 3.00 (mesure vs SPOT, gap inclus)
...
- Reference : spot 140.82, ATR14 4.9829 (3.538 % du cours). **Les prix ci-dessous sont ancres sur ce spot de cloture : les REANCRER sur le prix vivant avant de poser.**
- **Horizon = consigne operateur.** intraday -> 1 seance ; SANS PRECISION -> swing, 5 seances ; positionnel/long -> 20.
- **Bornes appliquees d'office par le calculateur** : aucune tranche touchee plus de **45.0 %** du temps a l'horizon retenu ; aucune sous le **bruit journalier** du titre (0.366 ATR = 1.295 % du cours, soit l'excursion adverse mediane d'une seance) ; deux tranches jamais separees par moins que ce bruit. Ce sont des DEFAUTS DU MODULE : ils cedent avant toute consigne, et le rapport le dit.

| distance | % du cours | prix (spot ref) | p(touche) 1s | p(touche) 2s | p(touche) 3s | p(touche) 5s | p(touche) 10s | p(touche) 20s |
|---|---|---|---|---|---|---|---|---|
| 0.05 ATR | 0.177 % | 140.5709 | 91.31 % | 93.97 % | 95.45 % | 96.23 % | 97.21 % | 97.89 % |
| 0.1 ATR | 0.354 % | 140.3217 | 83.71 % | 87.94 % | 90.5 % | 92.77 % | 94.62 % | 95.67 % |
| 0.15 ATR | 0.531 % | 140.0726 | 76.31 % | 82.31 % | 85.95 % | 88.8 % | 91.24 % | 93.26 % |
| 0.2 ATR | 0.708 % | 139.8234 | 70.29 % | 79.05 % | 83.09 % | 86.62 % | 89.44 % | 91.85 % |
| 0.25 ATR | 0.885 % | 139.5743 | 63.77 % | 74.8 % | 79.53 % | 83.55 % | 87.35 % | 90.44 % |
| 0.35 ATR | 1.238 % | 139.076 | 51.63 % | 64.92 % | 70.62 % | 76.11 % | 81.97 % | 86.32 % |
| 0.5 ATR | 1.769 % | 138.3286 | 36.33 % | 51.88 % | 59.64 % | 66.6 % | 74.4 % | 80.18 % |
| 0.75 ATR | 2.654 % | 137.0829 | 19.84 % | 35.97 % | 45.2 % | 54.61 % | 65.34 % | 73.24 % |
| 1.0 ATR | 3.538 % | 135.8372 | 11.06 % | 25.4 % | 34.22 % | 44.1 % | 56.67 % | 64.89 % |
| 1.25 ATR | 4.423 % | 134.5914 | 6.02 % | 17.19 % | 24.93 % | 35.68 % | 48.11 % | 57.24 % |
| 1.5 ATR | 5.308 % | 133.3457 | 2.76 % | 10.97 % | 17.61 % | 27.55 % | 41.04 % | 50.91 % |
| 2.0 ATR | 7.077 % | 130.8543 | 0.79 % | 3.95 % | 8.51 % | 15.96 % | 27.99 % | 39.64 % |
| 2.5 ATR | 8.846 % | 128.3629 | 0.3 % | 1.98 % | 3.96 % | 9.22 % | 19.12 % | 29.88 % |
| 3.0 ATR | 10.615 % | 125.8714 | 0.1 % | 0.79 % | 1.88 % | 4.66 % | 12.15 % | 22.13 % |
| 4.0 ATR | 14.154 % | 120.8886 | 0.1 % | 0.4 % | 1.09 % | 2.28 % | 6.27 % | 12.47 % |
| 6.0 ATR | 21.231 % | 110.9229 | 0.0 % | 0.2 % | 0.4 % | 0.89 % | 2.19 % | 5.33 % |
...
- **2 seance(s)** : plage utile 0.608–1.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 0.75 ATR (2.654 %, prix 137.0826), p(touche) 35.97 % (en stress 91.18 %)  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 37.0 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **3 seance(s)** : plage utile 0.755–1.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (3.538 %, prix 135.8378), p(touche) 34.22 % (en stress 91.18 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ✅ optimum identifie (86.8 % des re-echantillons)
- **5 seance(s)** : plage utile 0.979–1.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (3.538 %, prix 135.8378), p(touche) 44.1 % (en stress 99.01 %)  ✅ optimum identifie (91.0 % des re-echantillons)
- **10 seance(s)** : plage utile 1.36–2.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.5 ATR (5.308 %, prix 133.3453), p(touche) 41.04 % (en stress 100.0 %)  ✅ optimum identifie (92.5 % des re-echantillons)
- **20 seance(s)** : plage utile 1.762–3.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 2.0 ATR (7.077 %, prix 130.8542), p(touche) 39.64 % (en stress 99.0 %)  ✅ optimum identifie (88.4 % des re-echantillons)
...
- EV/risk : 0.047 | EV/share : €0.233 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 60 % | T2 38 % | T3 21 %
...
- Régime probabiliste (posterior HMM, swing) : bull 6.7 | bear 76.5 | side 16.9  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −2.185% → cible +1.209% / stop −8.0%, p_fill 47%, n_eff≈19.9) : P(cible|rempli) **54%** · **EV/risk +0.015** (×p_fill ; si rempli +0.25% du capital)
  - **swing** (entrée dip −4.822% → cible +2.703% / stop −3.718%, p_fill 34%, n_eff≈14.3) : P(cible|rempli) **47%** · **EV/risk +0.002** (×p_fill ; si rempli +0.02% du capital)
  - **deep** (entrée dip −7.442% → cible +3.823% / stop −5.735%, p_fill 17%, n_eff≈11.6) : P(cible|rempli) **72%** · **EV/risk +0.030** (×p_fill ; si rempli +1.02% du capital)
...
- **MA** : MA20 150.18 · MA50 151.76 · MA200 151.02  _(prix < MA20)_
- **Dist MA** : MA20 -6.2% · MA50 -7.2% · MA200 -6.8%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (770790 bytes source)._  
