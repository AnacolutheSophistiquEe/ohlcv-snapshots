...
**Generated** : 2026-09-22T21:43:37.813528+00:00  
**Santé technique** : 7/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · €145.86  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot €145.86 (+0.5% vs entrée) · entrée €145.16 · stop €133.55 · T1 €147.45 · R/R 0.2  
...
- Entry (zone de repli) : €144.70–€145.62 (mid €145.16)
- Spot actuel : €145.86 (+0.5% au-dessus de la zone — repli à attendre)
- Stop : €133.55 (stop swing_plan-based (-4.47%))
- Targets : T1 €147.45 · R/R 0.2 | T2 €149.74 · R/R 0.39 | T3 €152.02 · R/R 0.59
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €133.55


## Risque mesuré — ce qui borne (et ce qui ne borne pas) la perte

- 🟠 **Régime de gap : intermediaire** — p_breach(-3 %)=2.59 % — entre les deux regimes ; ni queue pure ni franchissement ordinaire
- **Au stop du plan (4.47 %)** : le gap seul le franchit 1.413 % des séances (18 fois sur 1274).
   - exécution **1.385 pt plus bas** dans le cas TYPIQUE (médiane), 9.926 au p90, **31.287 au pire**
   - perte réelle **8.475 %** en moyenne _(tirée par la queue)_, jusqu'à **35.757 %** — au lieu des 4.47 % annoncés par la distance
   - coût AMORTI sur toutes les séances : 0.0566 % _(ce que le gap coûte en moyenne, pas ce qu'il coûte le jour où il frappe)_
...
- ⚠ **5 s — échantillon insuffisant sur : intraday (32.1 pt), swing (27.9 pt), deep (30.9 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
...
- **β de baisse : 1.3534** (β de hausse 1.0857, asymétrie 1.2466) vs GDAXI — 600 séances de repli, historique complet
...
- **Couple retenu** : stop 137.1475 sur atr_grid (1.75 ATR, 5.973 %) — p(stop avant cible) 0.5323 [0.48 ; 0.58], R/R 2.28, perte reelle 12.609 % (gap inclus), CVaR 6.015 %, EV -3.8337 % — **NON CONFORME (best_effort — proposition de derniere main)**
   - severite des violations : 0.1641 (somme des depassements RELATIFS a chaque seuil ; c'est elle qui a departage, l'esperance ne tranchant qu'a severites egales)
   - viole : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 2.28 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
   ...
   - viole : R/R 2.28 < plancher 3.00 (mesure vs SPOT, gap inclus)
...
- Candidats (la structure propose, la statistique elimine) :
   - ⚪ sr_based a 0.66 ATR (stop 4.395 %) — p(stop avant cible) 0.639 [0.59 ; 0.69], R/R 3.561, perte reelle 8.071 % (gap inclus), EV -2.4336 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 3.56 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.43 %) : P(cible) 0.5 % x 28.74 % + P(rien) 35.6 % x 7.22 % ne couvrent pas P(stop) 63.9 % x 8.07 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ swing_based a 3.13 ATR (stop 12.808 %) — p(stop avant cible) 0.1185 [0.09 ; 0.16], R/R 1.315, perte reelle 21.854 % (gap inclus), EV -0.4788 % — **REFUSE**
      ...
      - refuse : CVaR 95 % 12.83 % > budget 5.46 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.48 %) : P(cible) 0.5 % x 28.74 % + P(rien) 87.6 % x 2.23 % ne couvrent pas P(stop) 11.8 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - 🔴 support a 7.19 ATR (stop 26.66 %) — p(stop avant cible) 0.0034 [0.00 ; 0.01], R/R 0.804, perte reelle 35.757 % (gap inclus), EV 1.1109 % — **REFUSE**
      ...
      - refuse : CVaR 95 % 26.67 % > budget 5.46 %
      - ⚠ support DETECTE a 0.56 ATR du spot — compartiment <1, mesure a 48.2 % de casse (IC clusterise [0.447 ; 0.516] sur 1116 touches, registre point-in-time). C'est un pile ou face : l'ancrage n'apporte rien de plus qu'une distance arbitraire et rapproche le stop du bruit. Si c'est le seul disponible, la ligne n'est pas ancrable et le levier redevient la TAILLE.
   - 🟢 support a 10.42 ATR (stop 37.685 %) — p(stop avant cible) 0.0012 [0.00 ; 0.01], R/R 0.763, perte reelle 37.685 % (gap inclus), EV 1.1537 % — **REFUSE**
      ...
      - refuse : CVaR 95 % 37.69 % > budget 5.46 %
   - ⚪ atr_grid a 0.25 ATR (stop 0.853 %) — p(stop avant cible) 0.9385 [0.91 ; 0.96], R/R 13.191, perte reelle 2.179 % (gap inclus), EV -1.3863 % — **REFUSE**
      - refuse : cible atteinte seulement 0.1 % du temps (< 15 %) meme a 10 seances : le R/R de 13.19 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.39 %) : P(cible) 0.1 % x 28.74 % + P(rien) 6.0 % x 10.26 % ne couvrent pas P(stop) 93.8 % x 2.18 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 0.66 ATR (stop 3.29 %) — p(stop avant cible) 0.7263 [0.68 ; 0.77], R/R 4.196, perte reelle 6.851 % (gap inclus), EV -2.6697 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.67 %) : P(cible) 0.4 % x 28.74 % + P(rien) 26.9 % x 8.09 % ne couvrent pas P(stop) 72.6 % x 6.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.5 ATR (stop 5.12 %) — p(stop avant cible) 0.6133 [0.56 ; 0.66], R/R 2.893, perte reelle 9.934 % (gap inclus), EV -3.2865 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.29 %) : P(cible) 0.5 % x 28.74 % + P(rien) 38.1 % x 6.95 % ne couvrent pas P(stop) 61.3 % x 9.93 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.75 ATR (stop 5.973 %) — p(stop avant cible) 0.5323 [0.48 ; 0.58], R/R 2.28, perte reelle 12.609 % (gap inclus), EV -3.8337 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.83 %) : P(cible) 0.5 % x 28.74 % + P(rien) 46.2 % x 5.88 % ne couvrent pas P(stop) 53.2 % x 12.61 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.0 ATR (stop 6.827 %) — p(stop avant cible) 0.4856 [0.43 ; 0.54], R/R 1.95, perte reelle 14.737 % (gap inclus), EV -4.2893 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.95 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.95 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 6.86 % > budget 5.46 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-4.29 %) : P(cible) 0.5 % x 28.74 % + P(rien) 50.9 % x 5.32 % ne couvrent pas P(stop) 48.6 % x 14.74 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.25 ATR (stop 7.68 %) — p(stop avant cible) 0.4168 [0.37 ; 0.47], R/R 1.547, perte reelle 18.578 % (gap inclus), EV -4.8195 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-4.82 %) : P(cible) 0.5 % x 28.74 % + P(rien) 57.8 % x 4.79 % ne couvrent pas P(stop) 41.7 % x 18.58 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.5 ATR (stop 8.533 %) — p(stop avant cible) 0.348 [0.30 ; 0.40], R/R 1.547, perte reelle 18.578 % (gap inclus), EV -3.6848 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.55 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.55 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 8.56 % > budget 5.46 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.68 %) : P(cible) 0.5 % x 28.74 % + P(rien) 64.6 % x 4.06 % ne couvrent pas P(stop) 34.8 % x 18.58 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.75 ATR (stop 9.386 %) — p(stop avant cible) 0.2997 [0.25 ; 0.35], R/R 1.315, perte reelle 21.854 % (gap inclus), EV -3.8242 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.32 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.32 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 9.42 % > budget 5.46 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.82 %) : P(cible) 0.5 % x 28.74 % + P(rien) 69.5 % x 3.70 % ne couvrent pas P(stop) 30.0 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 3.13 ATR (stop 11.703 %) — p(stop avant cible) 0.1633 [0.13 ; 0.20], R/R 1.315, perte reelle 21.854 % (gap inclus), EV -1.357 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.32 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.32 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 11.73 % > budget 5.46 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.36 %) : P(cible) 0.5 % x 28.74 % + P(rien) 83.1 % x 2.47 % ne couvrent pas P(stop) 16.3 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 4.0 ATR (stop 13.653 %) — p(stop avant cible) 0.0918 [0.06 ; 0.13], R/R 1.107, perte reelle 25.963 % (gap inclus), EV -0.4492 % — **REFUSE**
      ...
      - refuse : CVaR 95 % 13.67 % > budget 5.46 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.45 %) : P(cible) 0.5 % x 28.74 % + P(rien) 90.3 % x 1.97 % ne couvrent pas P(stop) 9.2 % x 25.96 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 4.5 ATR (stop 15.36 %) — p(stop avant cible) 0.0514 [0.03 ; 0.08], R/R 1.107, perte reelle 25.963 % (gap inclus), EV 0.3484 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.11 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.11 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 15.38 % > budget 5.46 %
   - ⚪ atr_grid a 5.0 ATR (stop 17.066 %) — p(stop avant cible) 0.0336 [0.02 ; 0.06], R/R 0.804, perte reelle 35.757 % (gap inclus), EV 0.3341 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 0.80 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.80 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 17.08 % > budget 5.46 %
   - ⚪ atr_grid a 5.5 ATR (stop 18.773 %) — p(stop avant cible) 0.0241 [0.01 ; 0.04], R/R 0.804, perte reelle 35.757 % (gap inclus), EV 0.5913 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 0.80 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.80 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 18.79 % > budget 5.46 %
   - ⚪ atr_grid a 6.0 ATR (stop 20.48 %) — p(stop avant cible) 0.0125 [0.00 ; 0.03], R/R 0.804, perte reelle 35.757 % (gap inclus), EV 0.8821 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 0.80 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.80 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 20.49 % > budget 5.46 %
   - ⚪ atr_grid a 6.5 ATR (stop 22.186 %) — p(stop avant cible) 0.0076 [0.00 ; 0.02], R/R 0.804, perte reelle 35.757 % (gap inclus), EV 0.969 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 0.80 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.80 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 22.20 % > budget 5.46 %
   - 🔴 grid_snapped a 7.19 ATR (stop 25.554 %) — p(stop avant cible) 0.0041 [0.00 ; 0.02], R/R 0.804, perte reelle 35.757 % (gap inclus), EV 1.0905 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 0.80 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.80 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 25.56 % > budget 5.46 %
   - ⚪ atr_grid a 8.0 ATR (stop 27.306 %) — p(stop avant cible) 0.0034 [0.00 ; 0.01], R/R 0.804, perte reelle 35.757 % (gap inclus), EV 1.1109 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 0.80 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.80 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 27.31 % > budget 5.46 %
...
- Reference : spot 145.86, ATR14 4.9786 (3.413 % du cours). **Les prix ci-dessous sont ancres sur ce spot de cloture : les REANCRER sur le prix vivant avant de poser.**
- **Horizon = consigne operateur.** intraday -> 1 seance ; SANS PRECISION -> swing, 5 seances ; positionnel/long -> 20.
- **Bornes appliquees d'office par le calculateur** : aucune tranche touchee plus de **45.0 %** du temps a l'horizon retenu ; aucune sous le **bruit journalier** du titre (0.366 ATR = 1.249 % du cours, soit l'excursion adverse mediane d'une seance) ; deux tranches jamais separees par moins que ce bruit. Ce sont des DEFAUTS DU MODULE : ils cedent avant toute consigne, et le rapport le dit.

| distance | % du cours | prix (spot ref) | p(touche) 1s | p(touche) 2s | p(touche) 3s | p(touche) 5s | p(touche) 10s | p(touche) 20s |
|---|---|---|---|---|---|---|---|---|
| 0.05 ATR | 0.171 % | 145.6111 | 91.52 % | 94.08 % | 95.55 % | 96.14 % | 97.21 % | 97.89 % |
| 0.1 ATR | 0.341 % | 145.3621 | 83.83 % | 88.15 % | 90.61 % | 92.67 % | 94.63 % | 95.68 % |
| 0.15 ATR | 0.512 % | 145.1132 | 76.23 % | 82.33 % | 85.87 % | 88.71 % | 91.24 % | 93.27 % |
| 0.2 ATR | 0.683 % | 144.8643 | 70.32 % | 79.07 % | 83.0 % | 86.53 % | 89.45 % | 91.86 % |
| 0.25 ATR | 0.853 % | 144.6154 | 63.81 % | 74.83 % | 79.45 % | 83.47 % | 87.36 % | 90.45 % |
| 0.35 ATR | 1.195 % | 144.1175 | 51.68 % | 64.96 % | 70.45 % | 76.04 % | 81.99 % | 86.33 % |
| 0.5 ATR | 1.707 % | 143.3707 | 36.19 % | 51.83 % | 59.49 % | 66.53 % | 74.43 % | 80.2 % |
| 0.75 ATR | 2.56 % | 142.1261 | 19.72 % | 35.93 % | 45.26 % | 54.55 % | 65.37 % | 73.27 % |
| 1.0 ATR | 3.413 % | 140.8814 | 11.14 % | 25.37 % | 34.29 % | 44.06 % | 56.72 % | 64.92 % |
| 1.25 ATR | 4.267 % | 139.6368 | 6.11 % | 17.37 % | 25.1 % | 35.74 % | 48.26 % | 57.29 % |
| 1.5 ATR | 5.12 % | 138.3921 | 2.76 % | 11.06 % | 17.79 % | 27.82 % | 41.09 % | 50.95 % |
| 2.0 ATR | 6.827 % | 135.9029 | 0.79 % | 3.95 % | 8.6 % | 16.24 % | 28.16 % | 39.8 % |
| 2.5 ATR | 8.533 % | 133.4136 | 0.3 % | 1.97 % | 3.95 % | 9.41 % | 19.3 % | 30.05 % |
| 3.0 ATR | 10.24 % | 130.9243 | 0.1 % | 0.79 % | 1.88 % | 4.85 % | 12.24 % | 22.21 % |
| 4.0 ATR | 13.653 % | 125.9457 | 0.1 % | 0.39 % | 1.09 % | 2.28 % | 6.27 % | 12.36 % |
| 6.0 ATR | 20.48 % | 115.9886 | 0.0 % | 0.2 % | 0.4 % | 0.89 % | 2.19 % | 5.33 % |
...
- **2 seance(s)** : plage utile 0.607–0.75 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 0.75 ATR (2.56 %, prix 142.126), p(touche) 35.93 % (en stress 91.18 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 38.4 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **3 seance(s)** : plage utile 0.756–1.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (3.413 %, prix 140.8818), p(touche) 34.29 % (en stress 91.18 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ✅ optimum identifie (85.2 % des re-echantillons)
- **5 seance(s)** : plage utile 0.978–1.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (3.413 %, prix 140.8818), p(touche) 44.06 % (en stress 99.01 %)  ✅ optimum identifie (90.9 % des re-echantillons)
- **10 seance(s)** : plage utile 1.364–2.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.5 ATR (5.12 %, prix 138.392), p(touche) 41.09 % (en stress 100.0 %)  ✅ optimum identifie (93.5 % des re-echantillons)
- **20 seance(s)** : plage utile 1.767–3.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 2.0 ATR (6.827 %, prix 135.9021), p(touche) 39.8 % (en stress 99.0 %)  ✅ optimum identifie (89.2 % des re-echantillons)
...
- EV/risk : -0.06 | EV/share : €-0.697 | p_fill : —
...
- Sizing : notional réel 146.0 (= 1 part(s) × prix) · cible 288.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.478% → cible +1.577% / stop −8.0%, p_fill 86%, n_eff≈34.3) : P(cible|rempli) **44%** · **EV/risk -0.042** (×p_fill ; si rempli -0.39% du capital)
  - **swing** (entrée dip −1.057% → cible +3.525% / stop −3.45%, p_fill 80%, n_eff≈31.3) : P(cible|rempli) **21%** · **EV/risk -0.476** (×p_fill ; si rempli -2.06% du capital)
  - **deep** (entrée dip −1.64% → cible +4.986% / stop −5.205%, p_fill 84%, n_eff≈33.1) : P(cible|rempli) **33%** · **EV/risk -0.331** (×p_fill ; si rempli -2.06% du capital)
...
- **MACD** : hist 0.472  _(bullish_recent)_
- **BB** : %B 0.61 · largeur 14.5%
...
- **MA** : MA20 143.49 · MA50 148.6 · MA200 152.3  _(prix > MA20)_
- **Dist MA** : MA20 +1.7% · MA50 -1.8% · MA200 -4.2%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (891674 bytes source)._  
