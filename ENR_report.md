...
**Generated** : 2026-08-19T00:05:53.917963+00:00  
**Santé technique** : 6/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · €153.90  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot €153.90 (+0.8% vs entrée) · entrée €152.71 · stop €144.07 · T1 €169.98 · R/R 2.0  
> ↳ P(T1 av. stop) 10 % _(réel 5 s)_ · EV/risk -0.102 _(réel 5 s)_ (GBM 0.045) · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈216) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €151.52–€153.90 (mid €152.71)
- Spot actuel : €153.90 (+0.8% au-dessus de la zone — repli à attendre)
- Stop : €144.07 (stop swing_plan-based (-6.38%))
- Targets : T1 €169.98 · R/R 2.0 | T2 €170.26 · R/R 2.03 | T3 €170.55 · R/R 2.06
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €144.07


## Edge, scénarios & sizing

- EV/risk : 0.045 | EV/share : €0.393 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 10 % | T2 9 % | T3 8 %
- Kelly (position) : f* 0.0 | ¼-Kelly 0.0 _(fraction du capital ; ¼-Kelly recommandé ; Kelly ≤ 0 ⇒ mise optimale nulle ⇒ Pass, même si l'EV blended scale-out reste marginalement positive)_
- Calibration des probas : _first-passage empirique daily (historique réel, n≈216) · non recalibrée track-record (n=0)_
- Régime probabiliste (posterior HMM, swing) : bull 8.6 | bear 85.7 | side 5.7  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 308.0 (= 2 part(s) × prix) · cible 400.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.355% → cible +1.741% / stop −1.5%, p_fill 84%, n_eff≈36.2) : P(cible|rempli) **34%** · **EV/risk -0.157** (×p_fill ; si rempli -0.28% du capital)
  - **swing** (entrée dip −0.768% → cible +11.31% / stop −5.655%, p_fill 81%, n_eff≈32.5) : P(cible|rempli) **10%** · **EV/risk -0.102** (×p_fill ; si rempli -0.71% du capital)
  - **deep** (entrée dip −1.192% → cible +5.506% / stop −7.073%, p_fill 89%, n_eff≈36.0) : P(cible|rempli) **37%** · **EV/risk -0.237** (×p_fill ; si rempli -1.89% du capital)
...
- **MACD** : hist 1.308  _(pas de croisement recent)_
- **BB** : %B 0.57 · largeur 19.1%
- **ATR** : 7.17 (52.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV rising · CMF -0.244  _(distribution)_
- **Vol ratio** : 0.59  _(volume atone)_
- **Choppiness** : 42.7  _(transition)_
- **MA** : MA20 151.93 · MA50 155.39 · MA200 147.73  _(prix > MA20)_
- **Dist MA** : MA20 +1.3% · MA50 -1.0% · MA200 +4.2%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (98116 bytes source)._  
