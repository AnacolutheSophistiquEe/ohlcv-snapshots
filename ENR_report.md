...
**Generated** : 2026-09-22T00:07:40.734806+00:00  
**Santé technique** : 5/10 — **Rating** : Pass  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · €143.10  

> 🟡 **WAIT-FOR-DIP** — spot +2.6 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot €143.10 (+2.6% vs entrée) · entrée €139.45 · stop €128.29 · T1 €141.67 · R/R 0.2  
...
- Entry (zone de repli) : €139.00–€139.89 (mid €139.45)
- Spot actuel : €143.10 (+2.6% au-dessus de la zone — repli à attendre)
- Stop : €128.29 (stop swing_plan-based (-9.08%))
- Targets : T1 €141.67 · R/R 0.2 | T2 €143.90 · R/R 0.4 | T3 €146.12 · R/R 0.6
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €128.29


## Risque mesuré — ce qui borne (et ce qui ne borne pas) la perte

- 🟠 **Régime de gap : intermediaire** — p_breach(-3 %)=2.59 % — entre les deux regimes ; ni queue pure ni franchissement ordinaire
- **Au stop du plan (9.08 %)** : le gap seul le franchit 0.235 % des séances (3 fois sur 1274).
   - exécution **7.09 pt plus bas** dans le cas TYPIQUE (médiane), 22.76 au p90, **26.677 au pire**
   - perte réelle **21.854 %** en moyenne _(tirée par la queue)_, jusqu'à **35.757 %** — au lieu des 9.08 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1275 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   ...
   - swing : **0.5032** [0.4507 ; 0.5557] _(largeur 10.5 pt, n_eff 345.8)_
...
- **β de baisse : 1.3534** (β de hausse 1.0888, asymétrie 1.243) vs GDAXI — 600 séances de repli, historique complet
...
- **Couple retenu** : stop 136.9 sur atr_grid (1.25 ATR, 4.333 %) — p(stop avant cible) 0.637 [0.59 ; 0.69], R/R 3.87, perte reelle 8.071 % (gap inclus), CVaR 4.392 %, EV -2.3988 % — **NON CONFORME (best_effort — proposition de derniere main)**
   - severite des violations : 0.2961 (somme des depassements RELATIFS a chaque seuil ; c'est elle qui a departage, l'esperance ne tranchant qu'a severites egales)
   - viole : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 3.87 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
...
- Candidats (la structure propose, la statistique elimine) :
   - ⚪ atr_based a 1.5 ATR (stop 5.199 %) — p(stop avant cible) 0.5994 [0.55 ; 0.65], R/R 3.144, perte reelle 9.934 % (gap inclus), EV -3.1398 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.14 %) : P(cible) 0.4 % x 31.23 % + P(rien) 39.7 % x 6.81 % ne couvrent pas P(stop) 59.9 % x 9.93 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ swing_based a 2.58 ATR (stop 11.144 %) — p(stop avant cible) 0.1933 [0.15 ; 0.24], R/R 1.429, perte reelle 21.854 % (gap inclus), EV -1.8578 % — **REFUSE**
      ...
      - refuse : CVaR 95 % 11.17 % > budget 4.19 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.86 %) : P(cible) 0.4 % x 31.23 % + P(rien) 80.3 % x 2.81 % ne couvrent pas P(stop) 19.3 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ sr_based a 3.05 ATR (stop 12.751 %) — p(stop avant cible) 0.1229 [0.09 ; 0.16], R/R 1.429, perte reelle 21.854 % (gap inclus), EV -0.5235 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 12.77 % > budget 4.19 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.52 %) : P(cible) 0.4 % x 31.23 % + P(rien) 87.4 % x 2.35 % ne couvrent pas P(stop) 12.3 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - 🟢 support a 6.66 ATR (stop 25.265 %) — p(stop avant cible) 0.0041 [0.00 ; 0.02], R/R 0.873, perte reelle 35.757 % (gap inclus), EV 1.115 % — **REFUSE**
      ...
      - refuse : CVaR 95 % 25.27 % > budget 4.19 %
   - 🟢 support a 9.9 ATR (stop 36.503 %) — p(stop avant cible) 0.0012 [0.00 ; 0.01], R/R 0.856, perte reelle 36.503 % (gap inclus), EV 1.1793 % — **REFUSE**
      ...
      - refuse : CVaR 95 % 36.50 % > budget 4.19 %
   - ⚪ atr_grid a 0.25 ATR (stop 0.867 %) — p(stop avant cible) 0.9351 [0.91 ; 0.96], R/R 14.261, perte reelle 2.19 % (gap inclus), EV -1.3381 % — **REFUSE**
      - refuse : cible atteinte seulement 0.1 % du temps (< 15 %) meme a 10 seances : le R/R de 14.26 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.34 %) : P(cible) 0.1 % x 31.23 % + P(rien) 6.4 % x 10.52 % ne couvrent pas P(stop) 93.5 % x 2.19 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.5 ATR (stop 1.733 %) — p(stop avant cible) 0.8582 [0.82 ; 0.89], R/R 8.398, perte reelle 3.719 % (gap inclus), EV -1.8285 % — **REFUSE**
      - refuse : cible atteinte seulement 0.2 % du temps (< 15 %) meme a 10 seances : le R/R de 8.40 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - refuse : CVaR 95 % 4.53 % > budget 4.19 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.83 %) : P(cible) 0.2 % x 31.23 % + P(rien) 14.0 % x 9.30 % ne couvrent pas P(stop) 85.8 % x 3.72 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.75 ATR (stop 2.6 %) — p(stop avant cible) 0.7935 [0.75 ; 0.83], R/R 6.121, perte reelle 5.102 % (gap inclus), EV -2.1872 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 6.12 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.19 %) : P(cible) 0.4 % x 31.23 % + P(rien) 20.3 % x 8.63 % ne couvrent pas P(stop) 79.3 % x 5.10 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.0 ATR (stop 3.466 %) — p(stop avant cible) 0.7088 [0.66 ; 0.75], R/R 4.474, perte reelle 6.98 % (gap inclus), EV -2.5097 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.51 %) : P(cible) 0.4 % x 31.23 % + P(rien) 28.8 % x 8.09 % ne couvrent pas P(stop) 70.9 % x 6.98 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.25 ATR (stop 4.333 %) — p(stop avant cible) 0.637 [0.59 ; 0.69], R/R 3.87, perte reelle 8.071 % (gap inclus), EV -2.3988 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 3.87 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.40 %) : P(cible) 0.4 % x 31.23 % + P(rien) 35.9 % x 7.33 % ne couvrent pas P(stop) 63.7 % x 8.07 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.75 ATR (stop 6.066 %) — p(stop avant cible) 0.5287 [0.48 ; 0.58], R/R 2.477, perte reelle 12.609 % (gap inclus), EV -3.763 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 2.48 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - refuse : CVaR 95 % 6.11 % > budget 4.19 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.76 %) : P(cible) 0.4 % x 31.23 % + P(rien) 46.8 % x 5.97 % ne couvrent pas P(stop) 52.9 % x 12.61 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.0 ATR (stop 6.932 %) — p(stop avant cible) 0.4708 [0.42 ; 0.52], R/R 2.119, perte reelle 14.737 % (gap inclus), EV -4.0706 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-4.07 %) : P(cible) 0.4 % x 31.23 % + P(rien) 52.6 % x 5.24 % ne couvrent pas P(stop) 47.1 % x 14.74 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.25 ATR (stop 7.799 %) — p(stop avant cible) 0.4051 [0.35 ; 0.46], R/R 1.681, perte reelle 18.578 % (gap inclus), EV -4.5782 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-4.58 %) : P(cible) 0.4 % x 31.23 % + P(rien) 59.1 % x 4.80 % ne couvrent pas P(stop) 40.5 % x 18.58 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 2.58 ATR (stop 9.993 %) — p(stop avant cible) 0.2758 [0.23 ; 0.32], R/R 1.429, perte reelle 21.854 % (gap inclus), EV -3.3002 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 10.02 % > budget 4.19 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.30 %) : P(cible) 0.4 % x 31.23 % + P(rien) 72.0 % x 3.63 % ne couvrent pas P(stop) 27.6 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 3.05 ATR (stop 11.6 %) — p(stop avant cible) 0.1716 [0.13 ; 0.21], R/R 1.429, perte reelle 21.854 % (gap inclus), EV -1.5113 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 11.62 % > budget 4.19 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.51 %) : P(cible) 0.4 % x 31.23 % + P(rien) 82.5 % x 2.58 % ne couvrent pas P(stop) 17.2 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 3.5 ATR (stop 12.131 %) — p(stop avant cible) 0.1436 [0.11 ; 0.18], R/R 1.429, perte reelle 21.854 % (gap inclus), EV -0.9877 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 12.15 % > budget 4.19 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.99 %) : P(cible) 0.4 % x 31.23 % + P(rien) 85.3 % x 2.39 % ne couvrent pas P(stop) 14.4 % x 21.85 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 4.0 ATR (stop 13.864 %) — p(stop avant cible) 0.0816 [0.06 ; 0.11], R/R 1.203, perte reelle 25.963 % (gap inclus), EV -0.2377 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.24 %) : P(cible) 0.4 % x 31.23 % + P(rien) 91.5 % x 1.93 % ne couvrent pas P(stop) 8.2 % x 25.96 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 4.5 ATR (stop 15.597 %) — p(stop avant cible) 0.0509 [0.03 ; 0.08], R/R 1.203, perte reelle 25.963 % (gap inclus), EV 0.3858 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 1.20 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.20 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 15.61 % > budget 4.19 %
   - ⚪ atr_grid a 5.0 ATR (stop 17.331 %) — p(stop avant cible) 0.031 [0.02 ; 0.05], R/R 0.873, perte reelle 35.757 % (gap inclus), EV 0.4333 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.87 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.87 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 17.35 % > budget 4.19 %
   - ⚪ atr_grid a 5.5 ATR (stop 19.064 %) — p(stop avant cible) 0.0236 [0.01 ; 0.04], R/R 0.873, perte reelle 35.757 % (gap inclus), EV 0.6273 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.87 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.87 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 19.08 % > budget 4.19 %
   - ⚪ atr_grid a 6.0 ATR (stop 20.797 %) — p(stop avant cible) 0.0082 [0.00 ; 0.02], R/R 0.873, perte reelle 35.757 % (gap inclus), EV 0.9805 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.87 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.87 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 20.81 % > budget 4.19 %
   - 🟢 grid_snapped a 6.66 ATR (stop 24.114 %) — p(stop avant cible) 0.0048 [0.00 ; 0.02], R/R 0.873, perte reelle 35.757 % (gap inclus), EV 1.0866 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.87 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.87 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 24.12 % > budget 4.19 %
   - ⚪ atr_grid a 7.5 ATR (stop 25.996 %) — p(stop avant cible) 0.0041 [0.00 ; 0.02], R/R 0.873, perte reelle 35.757 % (gap inclus), EV 1.115 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.87 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.87 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 26.00 % > budget 4.19 %
   - ⚪ atr_grid a 8.0 ATR (stop 27.729 %) — p(stop avant cible) 0.0034 [0.00 ; 0.01], R/R 0.873, perte reelle 35.757 % (gap inclus), EV 1.1353 % — **REFUSE**
      - refuse : cible atteinte seulement 0.4 % du temps (< 15 %) meme a 10 seances : le R/R de 0.87 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 0.87 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 27.74 % > budget 4.19 %
...
- Reference : spot 143.1, ATR14 4.96 (3.466 % du cours). **Les prix ci-dessous sont ancres sur ce spot de cloture : les REANCRER sur le prix vivant avant de poser.**
- **Horizon = consigne operateur.** intraday -> 1 seance ; SANS PRECISION -> swing, 5 seances ; positionnel/long -> 20.
- **Bornes appliquees d'office par le calculateur** : aucune tranche touchee plus de **45.0 %** du temps a l'horizon retenu ; aucune sous le **bruit journalier** du titre (0.366 ATR = 1.269 % du cours, soit l'excursion adverse mediane d'une seance) ; deux tranches jamais separees par moins que ce bruit. Ce sont des DEFAUTS DU MODULE : ils cedent avant toute consigne, et le rapport le dit.

| distance | % du cours | prix (spot ref) | p(touche) 1s | p(touche) 2s | p(touche) 3s | p(touche) 5s | p(touche) 10s | p(touche) 20s |
|---|---|---|---|---|---|---|---|---|
| 0.05 ATR | 0.173 % | 142.852 | 91.42 % | 93.98 % | 95.45 % | 96.14 % | 97.21 % | 97.89 % |
| 0.1 ATR | 0.347 % | 142.604 | 83.73 % | 88.06 % | 90.51 % | 92.67 % | 94.63 % | 95.68 % |
| 0.15 ATR | 0.52 % | 142.356 | 76.13 % | 82.23 % | 85.87 % | 88.71 % | 91.24 % | 93.27 % |
| 0.2 ATR | 0.693 % | 142.108 | 70.22 % | 78.97 % | 83.0 % | 86.53 % | 89.45 % | 91.86 % |
| 0.25 ATR | 0.867 % | 141.86 | 63.81 % | 74.73 % | 79.45 % | 83.47 % | 87.36 % | 90.45 % |
| 0.35 ATR | 1.213 % | 141.364 | 51.68 % | 64.86 % | 70.45 % | 76.04 % | 81.99 % | 86.33 % |
| 0.5 ATR | 1.733 % | 140.62 | 36.19 % | 51.73 % | 59.49 % | 66.53 % | 74.43 % | 80.2 % |
| 0.75 ATR | 2.6 % | 139.38 | 19.72 % | 35.93 % | 45.26 % | 54.55 % | 65.37 % | 73.27 % |
| 1.0 ATR | 3.466 % | 138.14 | 11.14 % | 25.37 % | 34.29 % | 44.06 % | 56.72 % | 64.92 % |
| 1.25 ATR | 4.333 % | 136.9 | 6.11 % | 17.37 % | 25.1 % | 35.74 % | 48.16 % | 57.29 % |
| 1.5 ATR | 5.199 % | 135.66 | 2.76 % | 11.06 % | 17.79 % | 27.82 % | 41.0 % | 50.95 % |
| 2.0 ATR | 6.932 % | 133.18 | 0.79 % | 3.95 % | 8.6 % | 16.24 % | 28.06 % | 39.7 % |
| 2.5 ATR | 8.665 % | 130.7 | 0.3 % | 1.97 % | 3.95 % | 9.41 % | 19.2 % | 29.95 % |
| 3.0 ATR | 10.398 % | 128.22 | 0.1 % | 0.79 % | 1.88 % | 4.85 % | 12.14 % | 22.11 % |
| 4.0 ATR | 13.864 % | 123.26 | 0.1 % | 0.39 % | 1.09 % | 2.28 % | 6.27 % | 12.36 % |
| 6.0 ATR | 20.797 % | 113.34 | 0.0 % | 0.2 % | 0.4 % | 0.89 % | 2.19 % | 5.33 % |
...
- **2 seance(s)** : plage utile 0.606–0.75 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 0.75 ATR (2.6 %, prix 139.3794), p(touche) 35.93 % (en stress 91.18 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 39.4 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **3 seance(s)** : plage utile 0.756–1.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (3.466 %, prix 138.1402), p(touche) 34.29 % (en stress 91.18 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ✅ optimum identifie (86.2 % des re-echantillons)
- **5 seance(s)** : plage utile 0.978–1.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (3.466 %, prix 138.1402), p(touche) 44.06 % (en stress 99.01 %)  ✅ optimum identifie (91.5 % des re-echantillons)
- **10 seance(s)** : plage utile 1.36–2.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.5 ATR (5.199 %, prix 135.6602), p(touche) 41.0 % (en stress 100.0 %)  ✅ optimum identifie (93.5 % des re-echantillons)
- **20 seance(s)** : plage utile 1.764–3.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 2.0 ATR (6.932 %, prix 133.1803), p(touche) 39.7 % (en stress 99.0 %)  ✅ optimum identifie (89.0 % des re-echantillons)
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −2.554% → cible +1.595% / stop −8.0%, p_fill 35%, n_eff≈17.1) : P(cible|rempli) **38%** · **EV/risk +0.008** (×p_fill ; si rempli +0.18% du capital)
  - **swing** (entrée dip −5.614% → cible +3.567% / stop −3.672%, p_fill 24%, n_eff≈10.7) : P(cible|rempli) **41%** · **EV/risk +0.042** (×p_fill ; si rempli +0.65% du capital)
...
- **MA** : MA20 143.83 · MA50 148.76 · MA200 152.15  _(prix < MA20)_
- **Dist MA** : MA20 -0.5% · MA50 -3.8% · MA200 -5.9%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (832629 bytes source)._  
