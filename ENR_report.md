...
**Generated** : 2026-08-12T00:04:35.003669+00:00  
**Santé technique** : 6/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite high · €158.56  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-08-12 — US Core CPI (ex food & energy) (J-0 sess · macro taux)  
> ↳ spot €158.56 (+1.1% vs entrée) · entrée €156.85 · stop €144.31 · T1 €159.57 · R/R 0.22  
> ↳ P(T1 av. stop) 35 % _(réel 5 s)_ · EV/risk -0.059 _(réel 5 s)_ (GBM -0.061) · ¼-Kelly 0.076 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €156.31–€157.40 (mid €156.85)
- Spot actuel : €158.56 (+1.1% au-dessus de la zone — repli à attendre)
- Stop : €144.31 (stop swing_plan-based (-7.57%))
- Targets : T1 €159.57 · R/R 0.22 | T2 €162.28 · R/R 0.43 | T3 €165.00 · R/R 0.65
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €144.31


## Edge, scénarios & sizing

- EV/risk : -0.061 | EV/share : €-0.760 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 45 % | T2 20 % | T3 9 %
...
- Régime probabiliste (posterior HMM, intraday) : bull 15.5 | bear 24.9 | side 59.6  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 317.0 (= 2 part(s) × prix) · cible 400.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −1.076% → cible +1.731% / stop −8.0%, p_fill 68%, n_eff≈27.1) : P(cible|rempli) **35%** · **EV/risk -0.059** (×p_fill ; si rempli -0.69% du capital)
  - **swing** (entrée dip −2.365% → cible +9.865% / stop −5.331%, p_fill 71%, n_eff≈27.3) : P(cible|rempli) **9%** · **EV/risk -0.163** (×p_fill ; si rempli -1.23% du capital)
  - **deep** (entrée dip −3.652% → cible +5.473% / stop −8.104%, p_fill 72%, n_eff≈26.9) : P(cible|rempli) **52%** · **EV/risk -0.071** (×p_fill ; si rempli -0.81% du capital)
...
- **MACD** : hist 1.621  _(pas de croisement recent)_
- **BB** : %B 0.86 · largeur 15.2%
- **ATR** : 8.25 (85.0e pct 1a)  _(volatilite elevee)_
- **OBV/CMF** : OBV rising · CMF -0.101  _(distribution)_
- **Vol ratio** : 0.37  _(volume atone)_
- **Choppiness** : 53.5  _(transition)_
- **MA** : MA20 150.24 · MA50 155.29 · MA200 146.1  _(prix > MA20)_
- **Dist MA** : MA20 +5.5% · MA50 +2.1% · MA200 +8.5%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (99673 bytes source)._  
