...
**Generated** : 2026-09-04T00:11:00.807828+00:00  
...
**Subtitle** : indeterminate · volatilite normal · €121.20  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot €121.20 (+0.7% vs entrée) · entrée €120.34 · stop €116.51 · T1 €128.00 · R/R 2.0  
> ↳ P(T1 av. stop) 14 % _(réel 5 s)_ · EV/risk -0.063 _(réel 5 s)_ (GBM 0.04) · ¼-Kelly 0.022 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −3.18% cohérent avec le bruit 5 s (EV-optimal ≈ −2.5%)  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal 258 % hors [0,100] (R² max 0.64). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- Entry (zone de repli) : €119.66–€121.01 (mid €120.34)
- Spot actuel : €121.20 (+0.7% au-dessus de la zone — repli à attendre)
- Stop : €116.51 (stop swing_plan-based (-8.35%))
- Targets : T1 €128.00 · R/R 2.0 | T2 €129.21 · R/R 2.32 | T3 €130.42 · R/R 2.63
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €116.51
...
- **Au stop du plan (8.35 %)** : le gap seul le franchit 0.469 % des séances (6 fois sur 1280).
...
- **P(stop avant cible)** _(source : daily, 1281 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.3934** [0.3229 ; 0.4674] _(largeur 14.5 pt, n_eff 173.1)_
   - swing : **0.4206** [0.3694 ; 0.4731] _(largeur 10.4 pt, n_eff 345.8)_
   - deep : **0.3966** [0.3461 ; 0.4488] _(largeur 10.3 pt, n_eff 345.8)_
- ⚠ **5 s — échantillon insuffisant sur : intraday (32.2 pt), swing (32.3 pt), deep (33.3 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
- **VaR/CVaR à 1 j (fenêtre adaptative, 250 séances)** : VaR **-7.63 %** | CVaR **-13.66 %** | vol 6.5 %/j
   - _fenêtre arrêtée : rupture de regime a 300 seances en arriere (volatilite 2.97 % contre 7.54 % aujourd'hui, rapport 0.39)_
...
- **β de baisse : 1.1261** (β de hausse 1.6214, asymétrie 0.6945) vs FCHI — 619 séances de repli, historique complet
...
- **Couple retenu** : stop 107.8062 sur atr_grid (1.75 ATR, 11.051 %) — p(stop avant cible) 0.4228 [0.37 ; 0.48], R/R 0.787, perte reelle 21.456 % (gap inclus), CVaR 11.075 %, EV -4.0874 % — **NON CONFORME (best_effort — proposition de derniere main)**
   - viole : R/R 0.79 < plancher 3.00 (mesure vs SPOT, gap inclus)
- Budget de queue : **12.0 %** du notionnel — ⚠ VALEUR FIGEE (valeur de repli (ligne absente de l'allocation)), PAS une mesure. L'allocation derivee de la contrainte du compte n'etait pas disponible.
- Candidats (la structure propose, la statistique elimine) :
   - 🟢 support a 0.55 ATR (stop 6.56 %) — p(stop avant cible) 0.5976 [0.55 ; 0.65], R/R 1.193, perte reelle 14.154 % (gap inclus), EV -3.8641 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.86 %) : P(cible) 24.2 % x 16.88 % + P(rien) 16.1 % x 3.20 % ne couvrent pas P(stop) 59.8 % x 14.15 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_based a 1.5 ATR (stop 9.472 %) — p(stop avant cible) 0.4788 [0.43 ; 0.53], R/R 0.787, perte reelle 21.456 % (gap inclus), EV -5.4233 % — **REFUSE**
      - refuse : R/R 0.79 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-5.42 %) : P(cible) 27.3 % x 16.88 % + P(rien) 24.8 % x 0.96 % ne couvrent pas P(stop) 47.9 % x 21.46 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - 🟢 support a 2.05 ATR (stop 16.048 %) — p(stop avant cible) 0.2483 [0.20 ; 0.30], R/R 0.787, perte reelle 21.456 % (gap inclus), EV -0.6739 % — **REFUSE**
      - refuse : R/R 0.79 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 16.06 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.67 %) : P(cible) 33.4 % x 16.88 % + P(rien) 41.7 % x -2.37 % ne couvrent pas P(stop) 24.8 % x 21.46 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - 🟢 support a 5.17 ATR (stop 35.718 %) — p(stop avant cible) 0.022 [0.01 ; 0.04], R/R 0.473, perte reelle 35.718 % (gap inclus), EV 1.1277 % — **REFUSE**
      - refuse : R/R 0.47 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 35.72 % > budget 12.00 %
   - ⚪ atr_grid a 0.25 ATR (stop 1.579 %) — p(stop avant cible) 0.8737 [0.84 ; 0.91], R/R 4.958, perte reelle 3.405 % (gap inclus), EV -1.1534 % — **REFUSE**
      - refuse : cible atteinte seulement 9.9 % du temps (< 15 %) meme a 10 seances : le R/R de 4.96 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.15 %) : P(cible) 9.9 % x 16.88 % + P(rien) 2.8 % x 5.62 % ne couvrent pas P(stop) 87.4 % x 3.41 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - 🟢 grid_snapped a 0.55 ATR (stop 5.36 %) — p(stop avant cible) 0.6431 [0.59 ; 0.69], R/R 1.511, perte reelle 11.172 % (gap inclus), EV -2.9273 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.93 %) : P(cible) 22.3 % x 16.88 % + P(rien) 13.4 % x 3.70 % ne couvrent pas P(stop) 64.3 % x 11.17 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.25 ATR (stop 7.894 %) — p(stop avant cible) 0.5494 [0.50 ; 0.60], R/R 1.102, perte reelle 15.318 % (gap inclus), EV -3.7984 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.80 %) : P(cible) 24.9 % x 16.88 % + P(rien) 20.1 % x 2.04 % ne couvrent pas P(stop) 54.9 % x 15.32 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.75 ATR (stop 11.051 %) — p(stop avant cible) 0.4228 [0.37 ; 0.48], R/R 0.787, perte reelle 21.456 % (gap inclus), EV -4.0874 % — **REFUSE**
      - refuse : R/R 0.79 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-4.09 %) : P(cible) 29.5 % x 16.88 % + P(rien) 28.2 % x 0.00 % ne couvrent pas P(stop) 42.3 % x 21.46 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - 🟢 grid_snapped a 2.05 ATR (stop 14.848 %) — p(stop avant cible) 0.2953 [0.25 ; 0.34], R/R 0.787, perte reelle 21.456 % (gap inclus), EV -1.7058 % — **REFUSE**
      - refuse : R/R 0.79 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 14.86 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.71 %) : P(cible) 31.6 % x 16.88 % + P(rien) 38.9 % x -1.80 % ne couvrent pas P(stop) 29.5 % x 21.46 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.75 ATR (stop 17.366 %) — p(stop avant cible) 0.2246 [0.18 ; 0.27], R/R 0.703, perte reelle 24.006 % (gap inclus), EV -0.8832 % — **REFUSE**
      - refuse : R/R 0.70 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 17.38 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.88 %) : P(cible) 33.4 % x 16.88 % + P(rien) 44.1 % x -2.57 % ne couvrent pas P(stop) 22.5 % x 24.01 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 3.0 ATR (stop 18.944 %) — p(stop avant cible) 0.1909 [0.15 ; 0.23], R/R 0.576, perte reelle 29.294 % (gap inclus), EV -1.2471 % — **REFUSE**
      - refuse : R/R 0.58 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 18.95 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.25 %) : P(cible) 33.7 % x 16.88 % + P(rien) 47.2 % x -2.84 % ne couvrent pas P(stop) 19.1 % x 29.29 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 3.5 ATR (stop 22.102 %) — p(stop avant cible) 0.1039 [0.07 ; 0.14], R/R 0.576, perte reelle 29.294 % (gap inclus), EV 0.2607 % — **REFUSE**
      - refuse : R/R 0.58 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 22.11 % > budget 12.00 %
   - ⚪ atr_grid a 4.0 ATR (stop 25.259 %) — p(stop avant cible) 0.0554 [0.03 ; 0.08], R/R 0.576, perte reelle 29.294 % (gap inclus), EV 1.0679 % — **REFUSE**
      - refuse : R/R 0.58 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 25.26 % > budget 12.00 %
   - ⚪ atr_grid a 4.5 ATR (stop 28.417 %) — p(stop avant cible) 0.0373 [0.02 ; 0.06], R/R 0.576, perte reelle 29.294 % (gap inclus), EV 1.1838 % — **REFUSE**
      - refuse : R/R 0.58 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 28.42 % > budget 12.00 %
   - 🟢 grid_snapped a 5.17 ATR (stop 34.518 %) — p(stop avant cible) 0.027 [0.01 ; 0.05], R/R 0.489, perte reelle 34.518 % (gap inclus), EV 1.12 % — **REFUSE**
      - refuse : R/R 0.49 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 34.52 % > budget 12.00 %
   - ⚪ atr_grid a 6.0 ATR (stop 37.889 %) — p(stop avant cible) 0.0153 [0.01 ; 0.03], R/R 0.446, perte reelle 37.889 % (gap inclus), EV 1.1322 % — **REFUSE**
      - refuse : R/R 0.45 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 37.89 % > budget 12.00 %
   - ⚪ atr_grid a 6.5 ATR (stop 41.046 %) — p(stop avant cible) 0.0019 [0.00 ; 0.01], R/R 0.411, perte reelle 41.046 % (gap inclus), EV 1.1877 % — **REFUSE**
      - refuse : R/R 0.41 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 41.05 % > budget 12.00 %
   - ⚪ atr_grid a 7.0 ATR (stop 44.204 %) — p(stop avant cible) 0.0 [0.00 ; 0.01], R/R 0.382, perte reelle 44.204 % (gap inclus), EV 1.2046 % — **REFUSE**
      - refuse : R/R 0.38 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 44.20 % > budget 12.00 %
   - ⚪ atr_grid a 7.5 ATR (stop 47.361 %) — p(stop avant cible) 0.0 [0.00 ; 0.01], R/R 0.356, perte reelle 47.361 % (gap inclus), EV 1.2046 % — **REFUSE**
      - refuse : R/R 0.36 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 47.36 % > budget 12.00 %
   - ⚪ atr_grid a 8.0 ATR (stop 50.519 %) — p(stop avant cible) 0.0 [0.00 ; 0.01], R/R 0.334, perte reelle 50.519 % (gap inclus), EV 1.2046 % — **REFUSE**
      - refuse : R/R 0.33 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 50.52 % > budget 12.00 %
...
- Reference : spot 121.2, ATR14 7.6536 (6.315 % du cours). **Les prix ci-dessous sont ancres sur ce spot de cloture : les REANCRER sur le prix vivant avant de poser.**
- **Horizon = consigne operateur.** intraday -> 1 seance ; SANS PRECISION -> swing, 5 seances ; positionnel/long -> 20.
- **Bornes appliquees d'office par le calculateur** : aucune tranche touchee plus de **45.0 %** du temps a l'horizon retenu ; aucune sous le **bruit journalier** du titre (0.358 ATR = 2.261 % du cours, soit l'excursion adverse mediane d'une seance) ; deux tranches jamais separees par moins que ce bruit. Ce sont des DEFAUTS DU MODULE : ils cedent avant toute consigne, et le rapport le dit.

| distance | % du cours | prix (spot ref) | p(touche) 1s | p(touche) 2s | p(touche) 3s | p(touche) 5s | p(touche) 10s | p(touche) 20s |
|---|---|---|---|---|---|---|---|---|
| 0.05 ATR | 0.316 % | 120.8173 | 91.08 % | 94.11 % | 95.58 % | 96.65 % | 97.73 % | 98.7 % |
| 0.1 ATR | 0.631 % | 120.4346 | 84.8 % | 89.99 % | 92.04 % | 94.59 % | 96.24 % | 97.4 % |
| 0.15 ATR | 0.947 % | 120.052 | 77.84 % | 85.08 % | 87.92 % | 91.14 % | 93.77 % | 95.3 % |
| 0.2 ATR | 1.263 % | 119.6693 | 69.41 % | 80.08 % | 83.99 % | 88.29 % | 91.59 % | 93.41 % |
| 0.25 ATR | 1.579 % | 119.2866 | 62.94 % | 76.25 % | 80.75 % | 86.61 % | 90.31 % | 92.81 % |
| 0.35 ATR | 2.21 % | 118.5212 | 50.78 % | 67.71 % | 73.67 % | 81.5 % | 86.05 % | 90.21 % |
| 0.5 ATR | 3.157 % | 117.3732 | 35.88 % | 55.45 % | 62.87 % | 73.52 % | 81.4 % | 87.51 % |
| 0.75 ATR | 4.736 % | 115.4598 | 17.06 % | 35.53 % | 46.95 % | 58.86 % | 73.59 % | 81.32 % |
| 1.0 ATR | 6.315 % | 113.5464 | 8.24 % | 24.04 % | 34.18 % | 47.93 % | 65.48 % | 75.92 % |
| 1.25 ATR | 7.894 % | 111.633 | 4.12 % | 15.7 % | 25.34 % | 37.7 % | 57.17 % | 70.13 % |
| 1.5 ATR | 9.472 % | 109.7196 | 2.35 % | 10.7 % | 18.57 % | 30.12 % | 49.36 % | 64.04 % |
| 2.0 ATR | 12.63 % | 105.8929 | 0.59 % | 4.61 % | 8.94 % | 18.31 % | 35.61 % | 53.65 % |
| 2.5 ATR | 15.787 % | 102.0661 | 0.29 % | 2.45 % | 4.81 % | 11.71 % | 24.73 % | 45.55 % |
| 3.0 ATR | 18.944 % | 98.2393 | 0.2 % | 0.79 % | 2.55 % | 7.09 % | 17.21 % | 37.56 % |
| 4.0 ATR | 25.259 % | 90.5857 | 0.1 % | 0.59 % | 1.38 % | 3.54 % | 9.79 % | 24.38 % |
| 6.0 ATR | 37.889 % | 75.2786 | 0.0 % | 0.29 % | 0.79 % | 1.57 % | 4.45 % | 12.19 % |
...
- **3 seance(s)** : plage utile 0.788–1.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (6.315 %, prix 113.5462), p(touche) 34.18 % (en stress 86.27 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 36.5 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **5 seance(s)** : plage utile 1.072–1.25 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.25 ATR (7.894 %, prix 111.6325), p(touche) 37.7 % (en stress 87.25 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 19.2 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
...
- EV/risk : 0.04 | EV/share : €0.154 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 78.7 | bear 14.1 | side 7.2  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 364.0 (= 3 part(s) × prix) · cible 400.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.709% → cible +6.368% / stop −3.184%, p_fill 82%, n_eff≈34.5) : P(cible|rempli) **14%** · **EV/risk -0.063** (×p_fill ; si rempli -0.25% du capital)
  - **swing** (entrée dip −1.565% → cible +13.786% / stop −6.893%, p_fill 87%, n_eff≈34.2) : P(cible|rempli) **14%** · **EV/risk -0.020** (×p_fill ; si rempli -0.16% du capital)
  - **deep** (entrée dip −2.418% → cible +8.835% / stop −9.707%, p_fill 74%, n_eff≈31.2) : P(cible|rempli) **35%** · **EV/risk -0.237** (×p_fill ; si rempli -3.10% du capital)
...
- **MACD** : hist 0.049  _(bullish_recent)_
- **BB** : %B 0.62 · largeur 31.3%
- **ATR** : 7.65 (64.0e pct 1a)  _(volatilite au-dessus de la moyenne (tiers haut))_
- **OBV/CMF** : OBV rising · CMF -0.341  _(distribution)_
- **Vol ratio** : 1.2  _(volume normal)_
- **Choppiness** : 49.0  _(transition)_
- **MA** : MA20 116.85 · MA50 110.24 · MA200 80.32  _(prix > MA20)_
- **Dist MA** : MA20 +3.7% · MA50 +9.9% · MA200 +50.9%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (764659 bytes source)._  
