...
**Generated** : 2026-06-26T00:04:31.284702+00:00  
**Santé technique** : 8/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : range · volatilite low · €4.90  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot €4.90 (+2.3% vs entrée) · entrée €4.79 · stop €4.74 · T1 €4.86 · R/R 1.4  
> ↳ P(T1 av. stop) 34 % _(réel 5 s)_ · EV/risk -0.035 _(réel 5 s)_ (GBM -0.017) · ¼-Kelly 0.0 · _probas brutes (Monte-Carlo), non calibrées · n=0_  
...
- Entry (zone de repli) : €4.78–€4.81 (mid €4.79)
- Spot actuel : €4.90 (+2.3% au-dessus de la zone — repli à attendre)
- Stop : €4.74 (stop swing_plan-based (-6.29%))
- Targets : T1 €4.86 · R/R 1.4 | T2 €4.93 · R/R 2.8 | T3 €5.00 · R/R 4.2
...
- Sizing : notional réel 284.0 (= 58 part(s) × prix) · cible 288.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −2.165% → cible +1.432% / stop −1.16%, p_fill 41%, n_eff≈20.2) : P(cible|rempli) **34%** · **EV/risk -0.035** (×p_fill ; si rempli -0.10% du capital)
  - **swing** (entrée dip −4.765% → cible +3.203% / stop −1.601%, p_fill 26%, n_eff≈11.5) : P(cible|rempli) **11%** · **EV/risk -0.185** (×p_fill ; si rempli -1.13% du capital)
  - **deep** (entrée dip −7.361% → cible +4.529% / stop −2.266%, p_fill 23%, n_eff≈10.5) : P(cible|rempli) **27%** · **EV/risk -0.055** (×p_fill ; si rempli -0.54% du capital)
...
- **OBV/CMF** : OBV rising · CMF 0.156  _(accumulation)_
...
- **Dist MA** : MA20 +1.0% · MA50 -2.8% · MA200 -12.0%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (42801 bytes source)._  
