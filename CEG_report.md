...
**Generated** : 2026-08-20T00:25:49.586449+00:00  
**Santé technique** : 7/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : range · volatilite low · $274.17  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot $274.17 (+1.0% vs entrée) · entrée $271.57 · stop $267.50 · T1 $274.40 · R/R 0.7  
> ↳ P(T1 av. stop) 44 % _(réel 5 s)_ · EV/risk -0.095 _(réel 5 s)_ (GBM -0.02) · ¼-Kelly 0.011 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −1.5% cohérent avec le bruit 5 s (EV-optimal ≈ −1.5%)  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal 171 % hors [0,100] (R² max 0.96). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- Entry (zone de repli) : $271.01–$272.14 (mid $271.57)
- Spot actuel : $274.17 (+1.0% au-dessus de la zone — repli à attendre)
- Stop : $267.50 (stop swing_plan-based (-5.99%))
- Targets : T1 $274.40 · R/R 0.7 | T2 $277.99 · R/R 1.58 | T3 $281.58 · R/R 2.46
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $267.50


## Edge, scénarios & sizing

- EV/risk : -0.02 | EV/share : $-0.080 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 61 % | T2 28 % | T3 7 %
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.944% → cible +1.041% / stop −1.5%, p_fill 62%, n_eff≈25.2) : P(cible|rempli) **44%** · **EV/risk -0.095** (×p_fill ; si rempli -0.23% du capital)
  - **swing** (entrée dip −2.087% → cible +2.747% / stop −3.986%, p_fill 46%, n_eff≈19.4) : P(cible|rempli) **52%** · **EV/risk -0.064** (×p_fill ; si rempli -0.55% du capital)
  - **deep** (entrée dip −3.226% → cible +3.885% / stop −6.049%, p_fill 41%, n_eff≈20.9) : P(cible|rempli) **61%** · **EV/risk -0.008** (×p_fill ; si rempli -0.12% du capital)
...
- **MACD** : hist 0.294  _(pas de croisement recent)_
- **BB** : %B 0.64 · largeur 10.6%
- **ATR** : 10.7 (20.0e pct 1a)  _(volatilite basse)_
- **OBV/CMF** : OBV rising · CMF -0.321  _(distribution)_
- **Vol ratio** : 0.77  _(volume normal)_
- **Choppiness** : 65.9  _(marche en range (choppy))_
- **MA** : MA20 270.07 · MA50 261.69 · MA200 299.88  _(prix > MA20)_
- **Dist MA** : MA20 +1.5% · MA50 +4.8% · MA200 -8.6%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (108050 bytes source)._  
