...
**Generated** : 2026-07-23T21:45:55.898856+00:00  
**Santé technique** : 4/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : trending · volatilite high · €126.10  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-07-23 — ECB Monetary Policy Decision (J-0 sess · macro taux)  
> ↳ spot €126.10 (+2.1% vs entrée) · entrée €123.56 · stop €121.71 · T1 €125.42 · R/R 1.01  
> ↳ P(T1 av. stop) 13 % _(réel 5 s)_ · EV/risk -0.152 _(réel 5 s)_ (GBM 0.034) · ¼-Kelly 0.003 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €123.19–€123.94 (mid €123.56)
- Spot actuel : €126.10 (+2.1% au-dessus de la zone — repli à attendre)
- Stop : €121.71 (stop swing_plan-based (-6.04%))
- Targets : T1 €125.42 · R/R 1.01 | T2 €127.29 · R/R 2.02 | T3 €129.15 · R/R 3.02
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €121.71
...
- Régime probabiliste (posterior HMM, intraday) : bull 26.3 | bear 55.1 | side 18.5  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 126.0 (= 1 part(s) × prix) · cible 160.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −2.01% → cible +1.507% / stop −1.5%, p_fill 48%, n_eff≈17.8) : P(cible|rempli) **13%** · **EV/risk -0.152** (×p_fill ; si rempli -0.48% du capital)
  - **swing** (entrée dip −4.429% → cible +3.37% / stop −1.685%, p_fill 37%, n_eff≈13.9) : P(cible|rempli) **23%** · **EV/risk -0.130** (×p_fill ; si rempli -0.59% du capital)
  - **deep** (entrée dip −6.84% → cible +4.766% / stop −2.383%, p_fill 28%, n_eff≈10.3) : P(cible|rempli) **47%** · **EV/risk +0.104** (×p_fill ; si rempli +0.89% du capital)
...
- **RSI** : 28.3  _(survente)_
- **ADX** : 26.8  _(tendance etablie)_
- **MACD** : hist -0.985  _(pas de croisement recent)_
- **BB** : %B 0.15 · largeur 20.7%
...
- **MA** : MA20 135.95 · MA50 143.17 · MA200 109.45  _(prix < MA20)_
- **Dist MA** : MA20 -7.2% · MA50 -11.9% · MA200 +15.2%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (94324 bytes source)._  
