...
**Generated** : 2026-07-17T00:24:44.621926+00:00  
...
**Subtitle** : indeterminate · volatilite normal · $24.68  

> 🟡 **WAIT-FOR-DIP** — spot +5.6 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot $24.68 (+5.6% vs entrée) · entrée $23.38 · stop $22.35 · T1 $25.43 · R/R 1.99  
> ↳ P(T1 av. stop) 31 % · EV/risk 0.065 · ¼-Kelly 0.046 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −4.39% cohérent avec le bruit 5 s (EV-optimal ≈ −1.5%)  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal -27 % hors [0,100] (R² max 0.44). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- Entry (zone de repli) : $23.23–$23.53 (mid $23.38)
- Spot actuel : $24.68 (+5.6% au-dessus de la zone — repli à attendre)
- Stop : $22.35 (stop swing_plan-based (-14.78%))
- Targets : T1 $25.43 · R/R 1.99 | T2 $25.54 · R/R 2.1 | T3 $25.64 · R/R 2.19
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $22.35


## Edge, scénarios & sizing

- EV/risk : 0.065 | EV/share : $0.066 | p_fill : —
...
- **MACD** : hist -0.147  _(pas de croisement recent)_
- **BB** : %B 0.09 · largeur 36.3%
- **ATR** : 1.74 (32.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV falling · CMF -0.202  _(distribution)_
- **Vol ratio** : 0.73  _(volume normal)_
- **Choppiness** : 46.9  _(transition)_
- **MA** : MA20 28.97 · MA50 33.38 · MA200 34.17  _(prix < MA20)_
- **Dist MA** : MA20 -14.8% · MA50 -26.1% · MA200 -27.8%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (86962 bytes source)._  
