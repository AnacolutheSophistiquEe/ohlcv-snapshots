...
**Generated** : 2026-09-21T00:34:22.799452+00:00  
**Santé technique** : 7/10 — **Rating** : Pass  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : range · volatilite normal · $39.09  

> 🟡 **WAIT-FOR-DIP** — spot +11.1 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot $39.09 (+11.1% vs entrée) · entrée $35.17 · stop $32.83 · T1 $39.73 · R/R 1.95  
> ↳ P(T1 av. stop) 25 % · EV/risk 0.072 · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈214) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : $34.75–$35.59 (mid $35.17)
- Spot actuel : $39.09 (+11.1% au-dessus de la zone — repli à attendre)
- Stop : $32.83 (stop swing_plan-based (-16.02%))
- Targets : T1 $39.73 · R/R 1.95 | T2 $40.57 · R/R 2.31 | T3 $41.41 · R/R 2.67
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $32.83
...
- **Au stop du plan (16.02 %)** : le gap seul le franchit 0.399 % des séances (5 fois sur 1254).
   - exécution **8.637 pt plus bas** dans le cas TYPIQUE (médiane), 12.155 au p90, **13.031 au pire**
   - perte réelle **23.404 %** en moyenne _(tirée par la queue)_, jusqu'à **29.051 %** — au lieu des 16.02 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1255 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.3962** [0.3256 ; 0.4703] _(largeur 14.5 pt, n_eff 173.1)_
   - swing : **0.4827** [0.4304 ; 0.5353] _(largeur 10.5 pt, n_eff 345.7)_
   - deep : **0.3329** [0.2848 ; 0.3838] _(largeur 9.9 pt, n_eff 345.7)_
...
- **β de baisse : 1.5304** (β de hausse 1.2229, asymétrie 1.2514) vs IWM — 604 séances de repli, historique complet
...
- **Couple retenu** : stop 34.4578 sur grid_snapped (1.68 ATR, 11.85 %) — p(stop avant cible) 0.2546 [0.21 ; 0.30], R/R 0.293, perte reelle 18.539 % (gap inclus), CVaR 11.903 %, EV -1.3804 % — **NON CONFORME (best_effort — proposition de derniere main)**
...
- Candidats (la structure propose, la statistique elimine) :
   - ⚪ atr_based a 1.5 ATR (stop 8.996 %) — p(stop avant cible) 0.3409 [0.29 ; 0.39], R/R 0.361, perte reelle 15.075 % (gap inclus), EV -1.8883 % — **REFUSE**
      - refuse : R/R 0.36 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.89 %) : P(cible) 61.9 % x 5.44 % + P(rien) 4.0 % x -2.92 % ne couvrent pas P(stop) 34.1 % x 15.07 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ swing_based a 1.68 ATR (stop 13.343 %) — p(stop avant cible) 0.2021 [0.16 ; 0.25], R/R 0.283, perte reelle 19.221 % (gap inclus), EV -0.7192 % — **REFUSE**
      - refuse : R/R 0.28 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 13.39 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.72 %) : P(cible) 67.5 % x 5.44 % + P(rien) 12.3 % x -4.11 % ne couvrent pas P(stop) 20.2 % x 19.22 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ sr_based a 3.14 ATR (stop 22.117 %) — p(stop avant cible) 0.0976 [0.07 ; 0.13], R/R 0.203, perte reelle 26.856 % (gap inclus), EV 0.0799 % — **REFUSE**
      - refuse : R/R 0.20 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 22.13 % > budget 12.00 %
   - 🟢 support a 4.85 ATR (stop 32.405 %) — p(stop avant cible) 0.0519 [0.03 ; 0.08], R/R 0.168, perte reelle 32.405 % (gap inclus), EV 0.1494 % — **REFUSE**
      - refuse : R/R 0.17 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 32.40 % > budget 12.00 %
   - 🟢 support a 5.84 ATR (stop 38.289 %) — p(stop avant cible) 0.026 [0.01 ; 0.05], R/R 0.142, perte reelle 38.289 % (gap inclus), EV 0.162 % — **REFUSE**
      - refuse : R/R 0.14 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 38.29 % > budget 12.00 %
   - 🟢 support a 6.7 ATR (stop 43.482 %) — p(stop avant cible) 0.0016 [0.00 ; 0.01], R/R 0.125, perte reelle 43.482 % (gap inclus), EV 0.2621 % — **REFUSE**
      - refuse : R/R 0.13 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 43.48 % > budget 12.00 %
   - ⚪ atr_grid a 0.25 ATR (stop 1.499 %) — p(stop avant cible) 0.7753 [0.73 ; 0.82], R/R 1.373, perte reelle 3.963 % (gap inclus), EV -1.8499 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.85 %) : P(cible) 22.5 % x 5.44 % + P(rien) 0.0 % x 2.52 % ne couvrent pas P(stop) 77.5 % x 3.96 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.5 ATR (stop 2.999 %) — p(stop avant cible) 0.6413 [0.59 ; 0.69], R/R 0.864, perte reelle 6.294 % (gap inclus), EV -2.0852 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.09 %) : P(cible) 35.9 % x 5.44 % + P(rien) 0.0 % x 1.61 % ne couvrent pas P(stop) 64.1 % x 6.29 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.75 ATR (stop 4.498 %) — p(stop avant cible) 0.5477 [0.49 ; 0.60], R/R 0.577, perte reelle 9.422 % (gap inclus), EV -2.7005 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.70 %) : P(cible) 45.2 % x 5.44 % + P(rien) 0.0 % x 0.79 % ne couvrent pas P(stop) 54.8 % x 9.42 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.0 ATR (stop 5.997 %) — p(stop avant cible) 0.4808 [0.43 ; 0.53], R/R 0.46, perte reelle 11.823 % (gap inclus), EV -2.9235 % — **REFUSE**
      - refuse : R/R 0.46 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.92 %) : P(cible) 51.0 % x 5.44 % + P(rien) 0.9 % x -1.37 % ne couvrent pas P(stop) 48.1 % x 11.82 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.25 ATR (stop 7.496 %) — p(stop avant cible) 0.4137 [0.36 ; 0.47], R/R 0.402, perte reelle 13.549 % (gap inclus), EV -2.5797 % — **REFUSE**
      - refuse : R/R 0.40 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.58 %) : P(cible) 56.4 % x 5.44 % + P(rien) 2.2 % x -1.94 % ne couvrent pas P(stop) 41.4 % x 13.55 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 1.68 ATR (stop 11.85 %) — p(stop avant cible) 0.2546 [0.21 ; 0.30], R/R 0.293, perte reelle 18.539 % (gap inclus), EV -1.3804 % — **REFUSE**
      - refuse : R/R 0.29 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.38 %) : P(cible) 66.4 % x 5.44 % + P(rien) 8.1 % x -3.40 % ne couvrent pas P(stop) 25.5 % x 18.54 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.5 ATR (stop 14.993 %) — p(stop avant cible) 0.1764 [0.14 ; 0.22], R/R 0.232, perte reelle 23.404 % (gap inclus), EV -1.1149 % — **REFUSE**
      - refuse : R/R 0.23 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 15.03 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.11 %) : P(cible) 67.9 % x 5.44 % + P(rien) 14.5 % x -4.71 % ne couvrent pas P(stop) 17.6 % x 23.40 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.75 ATR (stop 16.492 %) — p(stop avant cible) 0.1515 [0.12 ; 0.19], R/R 0.232, perte reelle 23.404 % (gap inclus), EV -0.4847 % — **REFUSE**
      - refuse : R/R 0.23 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 16.52 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.48 %) : P(cible) 69.0 % x 5.44 % + P(rien) 15.9 % x -4.36 % ne couvrent pas P(stop) 15.2 % x 23.40 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 3.14 ATR (stop 20.623 %) — p(stop avant cible) 0.1074 [0.08 ; 0.14], R/R 0.203, perte reelle 26.856 % (gap inclus), EV -0.0296 % — **REFUSE**
      - refuse : R/R 0.20 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 20.64 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.03 %) : P(cible) 70.8 % x 5.44 % + P(rien) 18.5 % x -5.38 % ne couvrent pas P(stop) 10.7 % x 26.86 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 4.0 ATR (stop 23.989 %) — p(stop avant cible) 0.0811 [0.06 ; 0.11], R/R 0.203, perte reelle 26.856 % (gap inclus), EV 0.2811 % — **REFUSE**
      - refuse : R/R 0.20 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 24.00 % > budget 12.00 %
   - ⚪ atr_grid a 4.5 ATR (stop 26.987 %) — p(stop avant cible) 0.0643 [0.04 ; 0.09], R/R 0.187, perte reelle 29.051 % (gap inclus), EV 0.2853 % — **REFUSE**
      - refuse : R/R 0.19 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 26.99 % > budget 12.00 %
   - 🟢 grid_snapped a 4.85 ATR (stop 30.911 %) — p(stop avant cible) 0.0554 [0.03 ; 0.08], R/R 0.176, perte reelle 30.911 % (gap inclus), EV 0.2099 % — **REFUSE**
      - refuse : R/R 0.18 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 30.91 % > budget 12.00 %
   - 🟢 grid_snapped a 5.84 ATR (stop 36.795 %) — p(stop avant cible) 0.0379 [0.02 ; 0.06], R/R 0.148, perte reelle 36.795 % (gap inclus), EV 0.0984 % — **REFUSE**
      - refuse : R/R 0.15 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 36.80 % > budget 12.00 %
   - 🟢 grid_snapped a 6.7 ATR (stop 41.988 %) — p(stop avant cible) 0.0066 [0.00 ; 0.02], R/R 0.13, perte reelle 41.988 % (gap inclus), EV 0.2574 % — **REFUSE**
      - refuse : R/R 0.13 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 41.99 % > budget 12.00 %
   - ⚪ atr_grid a 7.5 ATR (stop 44.979 %) — p(stop avant cible) 0.0016 [0.00 ; 0.01], R/R 0.121, perte reelle 44.979 % (gap inclus), EV 0.2597 % — **REFUSE**
      - refuse : R/R 0.12 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 44.98 % > budget 12.00 %
   - ⚪ atr_grid a 8.0 ATR (stop 47.977 %) — p(stop avant cible) 0.0012 [0.00 ; 0.01], R/R 0.113, perte reelle 47.977 % (gap inclus), EV 0.2566 % — **REFUSE**
...
- Reference : spot 39.09, ATR14 2.3443 (5.997 % du cours). **Les prix ci-dessous sont ancres sur ce spot de cloture : les REANCRER sur le prix vivant avant de poser.**
- **Horizon = consigne operateur.** intraday -> 1 seance ; SANS PRECISION -> swing, 5 seances ; positionnel/long -> 20.
- **Bornes appliquees d'office par le calculateur** : aucune tranche touchee plus de **45.0 %** du temps a l'horizon retenu ; aucune sous le **bruit journalier** du titre (0.343 ATR = 2.057 % du cours, soit l'excursion adverse mediane d'une seance) ; deux tranches jamais separees par moins que ce bruit. Ce sont des DEFAUTS DU MODULE : ils cedent avant toute consigne, et le rapport le dit.

| distance | % du cours | prix (spot ref) | p(touche) 1s | p(touche) 2s | p(touche) 3s | p(touche) 5s | p(touche) 10s | p(touche) 20s |
|---|---|---|---|---|---|---|---|---|
| 0.05 ATR | 0.3 % | 38.9728 | 90.34 % | 93.15 % | 94.56 % | 95.05 % | 96.35 % | 97.54 % |
| 0.1 ATR | 0.6 % | 38.8556 | 81.89 % | 87.11 % | 89.11 % | 91.11 % | 92.99 % | 94.87 % |
| 0.15 ATR | 0.9 % | 38.7384 | 74.75 % | 81.97 % | 84.88 % | 88.18 % | 90.66 % | 93.54 % |
| 0.2 ATR | 1.199 % | 38.6211 | 67.81 % | 77.24 % | 80.44 % | 85.66 % | 89.14 % | 92.21 % |
| 0.25 ATR | 1.499 % | 38.5039 | 61.77 % | 72.71 % | 76.31 % | 82.32 % | 87.11 % | 90.46 % |
| 0.35 ATR | 2.099 % | 38.2695 | 49.09 % | 63.44 % | 69.76 % | 77.27 % | 82.84 % | 87.9 % |
| 0.5 ATR | 2.999 % | 37.9179 | 34.81 % | 49.95 % | 58.47 % | 68.79 % | 77.06 % | 83.59 % |
| 0.75 ATR | 4.498 % | 37.3318 | 17.3 % | 33.23 % | 43.04 % | 55.25 % | 66.5 % | 75.38 % |
| 1.0 ATR | 5.997 % | 36.7457 | 8.05 % | 21.65 % | 30.65 % | 43.84 % | 57.26 % | 68.72 % |
| 1.25 ATR | 7.496 % | 36.1596 | 3.82 % | 15.01 % | 22.48 % | 33.33 % | 48.12 % | 61.54 % |
| 1.5 ATR | 8.996 % | 35.5736 | 1.51 % | 9.67 % | 16.43 % | 26.26 % | 41.93 % | 55.18 % |
| 2.0 ATR | 11.994 % | 34.4014 | 0.3 % | 3.52 % | 8.37 % | 16.16 % | 30.05 % | 43.9 % |
| 2.5 ATR | 14.993 % | 33.2293 | 0.2 % | 1.51 % | 4.33 % | 9.8 % | 19.8 % | 32.0 % |
| 3.0 ATR | 17.991 % | 32.0571 | 0.2 % | 1.21 % | 2.62 % | 5.66 % | 14.21 % | 24.1 % |
| 4.0 ATR | 23.989 % | 29.7129 | 0.0 % | 0.6 % | 1.51 % | 2.63 % | 7.41 % | 14.15 % |
| 6.0 ATR | 35.983 % | 25.0243 | 0.0 % | 0.2 % | 0.4 % | 0.71 % | 2.03 % | 5.54 % |
...
- **2 seance(s)** : plage utile 0.574–0.75 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 0.75 ATR (4.498 %, prix 37.3317), p(touche) 33.23 % (en stress 87.0 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 27.0 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **3 seance(s)** : plage utile 0.718–0.75 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 0.75 ATR (4.498 %, prix 37.3317), p(touche) 43.04 % (en stress 90.0 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 16.6 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **5 seance(s)** : plage utile 0.975–1.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.25 ATR (7.496 %, prix 36.1598), p(touche) 33.33 % (en stress 89.9 %)  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 34.6 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **10 seance(s)** : plage utile 1.376–2.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.5 ATR (8.996 %, prix 35.5735), p(touche) 41.93 % (en stress 95.96 %)  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 20.4 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **20 seance(s)** : plage utile 1.951–2.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 2.5 ATR (14.993 %, prix 33.2292), p(touche) 32.0 % (en stress 98.98 %)  ⚠ **SOLUTION DE COIN** — l'optimum est sur une borne, l'objectif est monotone : ce n'est PAS un arbitrage. Trancher avec la lecture inverse ci-dessus.  ✅ optimum identifie (61.1 % des re-echantillons)
...
- EV/risk : 0.071 | EV/share : $0.166 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 23 % | T2 19 % | T3 17 %
- Kelly (position) : f* 0.0 | ¼-Kelly 0.0 _(fraction du capital ; ¼-Kelly recommandé ; Kelly ≤ 0 ⇒ mise optimale nulle ⇒ Pass, même si l'EV blended scale-out reste marginalement positive)_
- Calibration des probas : _first-passage empirique daily (historique réel, n≈214) · non recalibrée track-record (n=0)_
- Régime probabiliste (posterior HMM, swing) : bull 79.1 | bear 5.4 | side 15.5  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 508.0 (= 13 part(s) × prix) · cible 512.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −4.556% → cible +5.792% / stop −2.896%, p_fill 18%, n_eff≈9.1) : P(cible|rempli) **0%** · **EV/risk +0.068** (×p_fill ; si rempli +1.07% du capital)
...
- **MA** : MA20 37.88 · MA50 33.56 · MA200 31.6  _(prix > MA20)_
- **Dist MA** : MA20 +3.2% · MA50 +16.5% · MA200 +23.7%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (813370 bytes source)._  
