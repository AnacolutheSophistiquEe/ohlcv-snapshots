...
**Generated** : 2026-08-28T22:02:09.543470+00:00  
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −3.673% → cible +3.149% / stop −2.229%, p_fill 32%, n_eff≈15.9) : P(cible|rempli) **37%** · **EV/risk +0.039** (×p_fill ; si rempli +0.27% du capital)
  - **swing** (entrée dip −8.074% → cible +7.041% / stop −7.785%, p_fill 19%, n_eff≈8.9) : P(cible|rempli) **60%** · **EV/risk +0.039** (×p_fill ; si rempli +1.58% du capital)
  - **deep** (entrée dip −12.475% → cible +9.957% / stop −12.265%, p_fill 15%, n_eff≈10.1) : P(cible|rempli) **63%** · **EV/risk +0.015** (×p_fill ; si rempli +1.23% du capital)
- Courbe de touche réelle (high atteint, en séance) : +0.5%→91% · +1.0%→76% · +2.0%→60% · +3.0%→48% · +5.0%→29% · +8.0%→12%
- Range intraday médian 6.69% (p90 10.79%) · excursion haute méd. +2.57% / basse méd. −2.68%
- Profil de vol intra : ouverture 4.177% vs midi 1.278% vs clôture 1.656% _(ouverture ~3.3× plus volatile → privilégier/éviter selon le setup)_
- **Asset Behavior Profiler** (160 séances, frais pipeline) : **choppy-dominant (trend-following risqué)** _(jours choppy 84% · range 15% · trend ↑0%/↓1% ; spike-down 71% · recovery-V 30%)_
- **Régime intraday** : **chop** _(efficiency 0.117 ; neutre — autocorr -0.026)_ ; drift intra méd. 0.058% ; recovery-V 27%
- **σ réalisé intraday** 4.009% (sans gap overnight) — le MC l'utilise pour l'horizon intraday (le σ daily, plus élevé, surestimait les touches)
- Opening range (30min) : cassure haut 47% / bas 68% / whipsaw 17%
- POC intraday (dernière séance, temps-au-prix) : 38.1415 (VA 37.9945–38.5335 ; dernier close 38.45)
...
- Gaps overnight (n=159) : méd. 0.39% · baisse 42% (gap-down >1% 33% · >2% 17%)
- Excursion ouverture 5min (n=160) : bas méd −0.88% (p90 −2.79%) · haut méd +0.97% · range méd 2.29%
- Excursion ouverture 15min (n=160) : bas méd −1.29% (p90 −3.52%) · haut méd +1.43% · range méd 2.97%
- Excursion ouverture 30min (n=160) : bas méd −1.42% (p90 −3.88%) · haut méd +1.5% · range méd 3.75%
- Excursion ouverture 60min (n=160) : bas méd −1.7% (p90 −4.61%) · haut méd +1.81% · range méd 4.44%
- **Niveaux d'achat fishing** (limit buy à −L% sous le close veille 38.46 ; rebond = P(prix +1.0% après fill, déclenche un réveil de gestion)) :
   - −0.5% : fill 30min 59% · séance 71% (120/159) · gap 39% · délai 0.0min · rebond 55% (72/120) (MFE +1.25%)
   - −1.0% : fill 30min 52% · séance 68% (111/159) · gap 33% · délai 0.0min · rebond 59% (65/111) (MFE +1.3%)
   - −1.5% : fill 30min 45% · séance 61% (100/159) · gap 23% · délai 0.1min · rebond 66% (62/100) (MFE +1.45%)
   - −2.0% : fill 30min 42% · séance 52% (87/159) · gap 17% · délai 0.7min · rebond 69% (56/87) (MFE +1.67%)
   - −3.0% : fill 30min 31% · séance 48% (76/159) · gap 11% · délai 8.6min · rebond 62% (47/76) (MFE +1.78%)
   - −4.0% : fill 30min 20% · séance 37% (57/159) · gap 6% · délai 21.8min · rebond 75% (38/57) (MFE +1.88%)
   - −5.0% : fill 30min 14% · séance 30% (48/159) · gap 4% · délai 42.2min · rebond 81% (36/48) (MFE +2.59%)
- **Stop « survie au bruit »** (creux NORMAL d'une trajectoire pourtant gagnante → ne jamais couper au-dessus) :
   - capter +1.0% : creux à tolérer méd −0.53% (p90 −2.86%) → stop au-delà de −1.85% (survit 80% du bruit)
   - capter +2.0% : creux à tolérer méd −0.59% (p90 −2.99%) → stop au-delà de −1.93% (survit 80% du bruit)
   - capter +3.0% : creux à tolérer méd −0.68% (p90 −2.83%) → stop au-delà de −1.93% (survit 80% du bruit)
- Zig-zag intra-séance (seuil 0.5% · n=908 jambes) : jambe baissière méd −1.2% (p90 −2.87%) · ~12.0 jambes/séance
- **Fishing selon l'ouverture** (tu vois le gap au pré-open ; comptes bruts entre parenthèses) :
   - **gap-down** (69 séances) :
      · −1.0% : fill 96% (67/69) · rebond 45% (34/67)
      · −2.0% : fill 91% (63/69) · rebond 64% (37/63)
      · −3.0% : fill 88% (58/69) · rebond 58% (34/58)
      · −4.0% : fill 68% (45/69) · rebond 75% (30/45)
      · −5.0% : fill 58% (39/69) · rebond 80% (29/39)
   - **flat** (13 séances) :
...
- **P(clôture VERTE) selon le drive 15min** (n=160) : 44% en base · 67% si les 15 1res min sont vertes (78 cas) · 20% si rouges (82 cas) — même proba, 3 conditions (l'écart = pouvoir prédictif)
- **Fenêtre du début la PLUS prédictive** (balayage 5min→234min, n=160) : COUDE à **1:46** → P(séance verte=clôture>ouverture) 82% si début vert vs 9% si rouge (base 44% · écart 73 pts) ; prédictivité sature ensuite (plafond brut 213min ~trivial proche clôture)
- **GESTION si rempli & vert au coude** (cond. vert au coude, n=88) : tient le vert **82%** · continue >prix actuel 52% ; creux résiduel méd -1.45% (q20 -3.1%) → **SL/trailing à −3.1%** sous le prix (survit 80% du bruit) ; potentiel restant MFE méd +1.79% / q75 +2.89% → **scale +1.79% / runner +2.89%**, sortie à la clôture
  - **si ROUGE au coude** (n=72) : edge inversé — récupère vert seulement **9%** (continue à baisser 55%) → **RÉDUIRE ~85%** de la position, garder un petit runner (≈ taille des odds de récup.) à **stop large −4.54%** (au-delà de la MAE q10 -4.54%), cible rebond +1.93% ; ne PAS se contenter de serrer le SL (balayé sur le bruit)
- Bandes d'excursion forward depuis l'open (QUANTILES, pas des probas : 90% des séances entre q05 et q95) :
   - 30min (n=160) : retour [-4.3% .. +4.78%] · haut q95 +6.11% · bas q05 -4.54%
   - 60min (n=160) : retour [-4.61% .. +5.58%] · haut q95 +6.6% · bas q05 -5.4%
   - 2h (n=160) : retour [-4.74% .. +6.66%] · haut q95 +8.39% · bas q05 -5.87%
   - 4h (n=160) : retour [-5.23% .. +7.28%] · haut q95 +8.76% · bas q05 -6.81%
   - 6h (n=160) : retour [-5.72% .. +6.9%] · haut q95 +9.58% · bas q05 -6.92%
   - session (n=160) : retour [-6.93% .. +7.81%] · haut q95 +9.58% · bas q05 -7.63%
...
- **ARMER** : fenêtre la + prédictive = **90 min** → P(reste trend-up à la clôture) **12%**. Lecture précoce 30 min : signature présente → 6% vs absente 2% (base 5%)
...
_Bulletin compact généré depuis `<TICKER>_report_data.json` (889864 bytes source)._  
