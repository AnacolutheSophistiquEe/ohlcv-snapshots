...
**Generated** : 2026-08-04T00:01:55.098150+00:00  
**Santé technique** : 7/10 — **Rating** : Pass  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : strong_trend · volatilite low · €1176.60  

> 🟡 **WAIT-FOR-DIP** — spot +0.9 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot €1176.60 (+0.9% vs entrée) · entrée €1166.10 · stop €1142.78 · T1 €1182.39 · R/R 0.7  
> ↳ P(T1 av. stop) 56 % _(réel 5 s)_ · EV/risk 0.031 _(réel 5 s)_ (GBM 0.048) · ¼-Kelly 0.022 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −2.0% cohérent avec le bruit 5 s (EV-optimal ≈ −2.0%)  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal 218 % hors [0,100] (R² max 0.98). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- 🔴 **Santé haussière vs sur-extension** — Santé technique 7/10 élevée alors que : RSI 88.4 > 70 (surachat) ; %B 0.99 (collé à la bande haute) ; extension étirée (≥2×ATR au-dessus de la MA20) — le score mesure la santé durable, PAS le timing ; entrée au prix actuel défavorable.
...
- Entry (zone de repli) : €1162.84–€1169.36 (mid €1166.10)
- Spot actuel : €1176.60 (+0.9% au-dessus de la zone — repli à attendre)
- Stop : €1142.78 (stop swing_plan-based (-5.74%))
- Targets : T1 €1182.39 · R/R 0.7 | T2 €1198.68 · R/R 1.4 | T3 €1214.97 · R/R 2.1
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €1142.78


## Edge, scénarios & sizing

- EV/risk : 0.048 | EV/share : €1.113 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 71.2 | bear 5.0 | side 23.8  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.888% → cible +1.397% / stop −2.0%, p_fill 83%, n_eff≈34.6) : P(cible|rempli) **56%** · **EV/risk +0.031** (×p_fill ; si rempli +0.07% du capital)
  - **swing** (entrée dip −1.967% → cible +3.124% / stop −3.849%, p_fill 51%, n_eff≈23.1) : P(cible|rempli) **56%** · **EV/risk +0.023** (×p_fill ; si rempli +0.18% du capital)
  - **deep** (entrée dip −3.03% → cible +4.417% / stop −5.837%, p_fill 54%, n_eff≈20.7) : P(cible|rempli) **48%** · **EV/risk -0.113** (×p_fill ; si rempli -1.23% du capital)
...
- **RSI** : 88.4  _(surachat)_
- **ADX** : 25.1  _(tendance etablie)_
- **MACD** : hist 25.202  _(pas de croisement recent)_
- **BB** : %B 0.99 · largeur 26.2%
- **ATR** : 44.39 (5.0e pct 1a)  _(volatilite basse)_
- **OBV/CMF** : OBV rising · CMF -0.031  _(neutre)_
- **Vol ratio** : 0.6  _(volume atone)_
- **Choppiness** : 33.7  _(marche directionnel)_
- **MA** : MA20 1042.77 · MA50 1106.56 · MA200 1456.13  _(prix > MA20)_
- **Dist MA** : MA20 +12.8% · MA50 +6.3% · MA200 -19.2%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (93339 bytes source)._  
