...
- Entry (zone de repli) : €971.12–€975.98 (mid €973.55)
- Spot actuel : €982.40 (+0.9% au-dessus de la zone — repli à attendre)
- Stop : €954.08 (stop swing_plan-based (-5.44%))
- Targets : T1 €985.71 · R/R 0.62 | T2 €997.87 · R/R 1.25 | T3 €1010.02 · R/R 1.87
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €954.08


## Risque mesuré — ce qui borne (et ce qui ne borne pas) la perte

- 🟠 **Régime de gap : intermediaire** — p_breach(-3 %)=1.73 % — entre les deux regimes ; ni queue pure ni franchissement ordinaire
- **Au stop du plan (5.44 %)** : le gap seul le franchit 0.235 % des séances (3 fois sur 1274).
   - exécution **2.412 pt plus bas** dans le cas TYPIQUE (médiane), 14.074 au p90, **16.989 au pire**
   - perte réelle **12.114 %** en moyenne _(tirée par la queue)_, jusqu'à **22.429 %** — au lieu des 5.44 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1275 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.34** [0.2725 ; 0.4128] _(largeur 14.0 pt, n_eff 173.1)_
   - swing : **0.4351** [0.3836 ; 0.4877] _(largeur 10.4 pt, n_eff 345.8)_
   - deep : **0.4416** [0.3899 ; 0.4942] _(largeur 10.4 pt, n_eff 345.8)_
- ⚠ **5 s — échantillon insuffisant sur : intraday (31.8 pt), swing (40.0 pt), deep (41.4 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
- **VaR/CVaR à 1 j (fenêtre adaptative, 480 séances)** : VaR **-4.86 %** | CVaR **-6.85 %** | vol 3.07 %/j
   - _fenêtre arrêtée : rupture de regime a 540 seances en arriere (volatilite 1.92 % contre 3.13 % aujourd'hui, rapport 0.61)_
...
- **β de baisse : 0.5305** (β de hausse 0.5878, asymétrie 0.9026) vs GDAXI — 601 séances de repli, historique complet
   - ⚠ le β de baisse récent vaut 2.13× celui de l'historique complet : la sensibilité du titre au marché a changé.
...
- Candidats (la structure propose, la statistique elimine) :
   ...
   - ⚪ atr_grid a 2.5 ATR (stop 8.656 %) — p(stop avant cible) 0.3851 [0.33 ; 0.44], R/R 1.433, perte reelle 22.429 % (gap inclus), EV -6.1576 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-6.16 %) : P(cible) 0.5 % x 32.13 % + P(rien) 60.9 % x 3.78 % ne couvrent pas P(stop) 38.5 % x 22.43 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.75 ATR (stop 9.522 %) — p(stop avant cible) 0.3266 [0.28 ; 0.38], R/R 1.433, perte reelle 22.429 % (gap inclus), EV -5.0681 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-5.07 %) : P(cible) 0.5 % x 32.13 % + P(rien) 66.8 % x 3.11 % ne couvrent pas P(stop) 32.7 % x 22.43 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 3.0 ATR (stop 10.387 %) — p(stop avant cible) 0.2844 [0.24 ; 0.33], R/R 1.433, perte reelle 22.429 % (gap inclus), EV -4.3826 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-4.38 %) : P(cible) 0.5 % x 32.13 % + P(rien) 71.0 % x 2.56 % ne couvrent pas P(stop) 28.4 % x 22.43 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 3.5 ATR (stop 12.118 %) — p(stop avant cible) 0.2035 [0.16 ; 0.25], R/R 1.433, perte reelle 22.429 % (gap inclus), EV -3.0436 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 12.13 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-3.04 %) : P(cible) 0.5 % x 32.13 % + P(rien) 79.1 % x 1.70 % ne couvrent pas P(stop) 20.3 % x 22.43 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 4.0 ATR (stop 13.849 %) — p(stop avant cible) 0.1455 [0.11 ; 0.19], R/R 1.433, perte reelle 22.429 % (gap inclus), EV -2.2192 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 13.86 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-2.22 %) : P(cible) 0.5 % x 32.13 % + P(rien) 84.9 % x 1.02 % ne couvrent pas P(stop) 14.5 % x 22.43 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 4.5 ATR (stop 15.581 %) — p(stop avant cible) 0.1188 [0.09 ; 0.16], R/R 1.433, perte reelle 22.429 % (gap inclus), EV -1.8987 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 15.59 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.90 %) : P(cible) 0.5 % x 32.13 % + P(rien) 87.6 % x 0.67 % ne couvrent pas P(stop) 11.9 % x 22.43 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 5.0 ATR (stop 17.312 %) — p(stop avant cible) 0.0816 [0.06 ; 0.11], R/R 1.433, perte reelle 22.429 % (gap inclus), EV -1.4919 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 17.32 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.49 %) : P(cible) 0.5 % x 32.13 % + P(rien) 91.3 % x 0.18 % ne couvrent pas P(stop) 8.2 % x 22.43 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 5.5 ATR (stop 19.043 %) — p(stop avant cible) 0.0537 [0.03 ; 0.08], R/R 1.433, perte reelle 22.429 % (gap inclus), EV -1.2441 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 19.05 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.24 %) : P(cible) 0.5 % x 32.13 % + P(rien) 94.1 % x -0.23 % ne couvrent pas P(stop) 5.4 % x 22.43 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 6.0 ATR (stop 20.774 %) — p(stop avant cible) 0.0412 [0.02 ; 0.07], R/R 1.433, perte reelle 22.429 % (gap inclus), EV -1.1739 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 20.78 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.17 %) : P(cible) 0.5 % x 32.13 % + P(rien) 95.3 % x -0.45 % ne couvrent pas P(stop) 4.1 % x 22.43 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 6.5 ATR (stop 22.505 %) — p(stop avant cible) 0.0216 [0.01 ; 0.04], R/R 1.428, perte reelle 22.505 % (gap inclus), EV -0.9469 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.43 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 22.50 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.95 %) : P(cible) 0.5 % x 32.13 % + P(rien) 97.3 % x -0.66 % ne couvrent pas P(stop) 2.2 % x 22.50 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 7.0 ATR (stop 24.237 %) — p(stop avant cible) 0.0102 [0.00 ; 0.03], R/R 1.326, perte reelle 24.237 % (gap inclus), EV -0.8818 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.88 %) : P(cible) 0.5 % x 32.13 % + P(rien) 98.4 % x -0.82 % ne couvrent pas P(stop) 1.0 % x 24.24 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 7.5 ATR (stop 25.968 %) — p(stop avant cible) 0.0062 [0.00 ; 0.02], R/R 1.237, perte reelle 25.968 % (gap inclus), EV -0.888 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.24 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.24 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 25.97 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.89 %) : P(cible) 0.5 % x 32.13 % + P(rien) 98.8 % x -0.91 % ne couvrent pas P(stop) 0.6 % x 25.97 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 8.0 ATR (stop 27.699 %) — p(stop avant cible) 0.0048 [0.00 ; 0.02], R/R 1.16, perte reelle 27.699 % (gap inclus), EV -0.8436 % — **REFUSE**
      - refuse : cible atteinte seulement 0.5 % du temps (< 15 %) meme a 10 seances : le R/R de 1.16 est un rapport de distances, pas une esperance — viser si loin revient a n'avoir pas de cible
      - refuse : R/R 1.16 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 27.70 % > budget 12.00 %
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.84 %) : P(cible) 0.5 % x 32.13 % + P(rien) 99.0 % x -0.90 % ne couvrent pas P(stop) 0.5 % x 27.70 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
...
- Reference : spot 982.4, ATR14 34.0143 (3.462 % du cours). **Les prix ci-dessous sont ancres sur ce spot de cloture : les REANCRER sur le prix vivant avant de poser.**
- **Horizon = consigne operateur.** intraday -> 1 seance ; SANS PRECISION -> swing, 5 seances ; positionnel/long -> 20.
- **Bornes appliquees d'office par le calculateur** : aucune tranche touchee plus de **45.0 %** du temps a l'horizon retenu ; aucune sous le **bruit journalier** du titre (0.394 ATR = 1.364 % du cours, soit l'excursion adverse mediane d'une seance) ; deux tranches jamais separees par moins que ce bruit. Ce sont des DEFAUTS DU MODULE : ils cedent avant toute consigne, et le rapport le dit.

| distance | % du cours | prix (spot ref) | p(touche) 1s | p(touche) 2s | p(touche) 3s | p(touche) 5s | p(touche) 10s | p(touche) 20s |
|---|---|---|---|---|---|---|---|---|
| 0.05 ATR | 0.173 % | 980.6993 | 89.45 % | 92.2 % | 93.38 % | 94.55 % | 97.01 % | 97.69 % |
| 0.1 ATR | 0.346 % | 978.9986 | 83.43 % | 87.96 % | 89.82 % | 91.39 % | 95.22 % | 96.28 % |
| 0.15 ATR | 0.519 % | 977.2979 | 76.53 % | 83.22 % | 85.87 % | 88.32 % | 92.94 % | 94.77 % |
| 0.2 ATR | 0.692 % | 975.5972 | 70.02 % | 78.78 % | 81.82 % | 85.25 % | 90.95 % | 93.17 % |
| 0.25 ATR | 0.866 % | 973.8965 | 62.52 % | 73.05 % | 76.88 % | 81.19 % | 88.46 % | 91.36 % |
| 0.35 ATR | 1.212 % | 970.495 | 53.94 % | 66.04 % | 71.44 % | 76.73 % | 85.87 % | 89.25 % |
| 0.5 ATR | 1.731 % | 965.3929 | 40.53 % | 54.99 % | 61.86 % | 69.21 % | 80.3 % | 83.82 % |
| 0.75 ATR | 2.597 % | 956.8893 | 23.67 % | 39.09 % | 47.43 % | 57.62 % | 70.55 % | 77.09 % |
| 1.0 ATR | 3.462 % | 948.3857 | 13.02 % | 26.55 % | 36.36 % | 48.51 % | 62.49 % | 70.55 % |
| 1.25 ATR | 4.328 % | 939.8822 | 7.4 % | 17.87 % | 26.28 % | 39.11 % | 54.33 % | 64.22 % |
| 1.5 ATR | 5.194 % | 931.3786 | 3.94 % | 13.13 % | 20.65 % | 31.88 % | 46.07 % | 57.09 % |
| 2.0 ATR | 6.925 % | 914.3715 | 1.78 % | 7.01 % | 12.15 % | 20.99 % | 34.43 % | 47.34 % |
| 2.5 ATR | 8.656 % | 897.3643 | 0.49 % | 3.36 % | 6.32 % | 12.48 % | 25.07 % | 37.99 % |
| 3.0 ATR | 10.387 % | 880.3572 | 0.1 % | 1.38 % | 3.85 % | 7.72 % | 17.41 % | 32.06 % |
| 4.0 ATR | 13.849 % | 846.3429 | 0.0 % | 0.3 % | 1.28 % | 3.27 % | 8.66 % | 20.4 % |
| 6.0 ATR | 20.774 % | 778.3143 | 0.0 % | 0.0 % | 0.0 % | 0.2 % | 0.8 % | 3.52 % |
...
| **20 s.** | 0.83 ATR | 1.86 ATR | 2.12 ATR | 2.92 ATR | 3.60 ATR | 4.05 ATR | 5.23 ATR | 5.83 ATR |
...
- **2 seance(s)** : plage utile 0.657–1.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 0.75 ATR (2.597 %, prix 956.8871), p(touche) 39.09 % (en stress 91.18 %)  ⚠ **OPTIMUM NON IDENTIFIE** — au bootstrap par blocs, le vainqueur ne gagne que 42.6 % des re-echantillons : le rendement ne distingue pas les distances de cette zone. Trancher par la tolerance de sortie ou par un niveau structurel ne coute donc rien.
- **3 seance(s)** : plage utile 0.805–1.25 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.0 ATR (3.462 %, prix 948.3893), p(touche) 36.36 % (en stress 95.1 %)  ✅ optimum identifie (60.0 % des re-echantillons)
- **5 seance(s)** : plage utile 1.093–1.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 1.25 ATR (4.328 %, prix 939.8818), p(touche) 39.11 % (en stress 98.02 %)  ✅ optimum identifie (87.0 % des re-echantillons)
- **10 seance(s)** : plage utile 1.546–2.5 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 2.0 ATR (6.925 %, prix 914.3688), p(touche) 34.43 % (en stress 96.04 %)  ✅ optimum identifie (98.9 % des re-echantillons)
- **20 seance(s)** : plage utile 2.125–3.0 ATR _(borne basse : tolerance de sortie par defaut (45 %))_ — optimum 2.5 ATR (8.656 %, prix 897.3635), p(touche) 37.99 % (en stress 98.0 %)  ✅ optimum identifie (99.4 % des re-echantillons)
...
- EV/risk : 0.063 | EV/share : €1.222 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 82.4 | bear 5.6 | side 11.9  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.898% → cible +1.249% / stop −2.0%, p_fill 85%, n_eff≈33.4) : P(cible|rempli) **36%** · **EV/risk -0.192** (×p_fill ; si rempli -0.45% du capital)
  - **swing** (entrée dip −1.977% → cible +2.792% / stop −3.532%, p_fill 55%, n_eff≈21.3) : P(cible|rempli) **55%** · **EV/risk -0.015** (×p_fill ; si rempli -0.10% du capital)
  - **deep** (entrée dip −3.067% → cible +3.949% / stop −5.358%, p_fill 55%, n_eff≈19.5) : P(cible|rempli) **57%** · **EV/risk -0.020** (×p_fill ; si rempli -0.19% du capital)
...
- **MACD** : hist -0.964  _(pas de croisement recent)_
- **BB** : %B 0.19 · largeur 14.0%
- **ATR** : 34.01 (0.0e pct 1a)  _(volatilite basse)_
- **OBV/CMF** : OBV falling · CMF -0.263  _(distribution)_
- **Vol ratio** : 1.16  _(volume normal)_
- **Choppiness** : 63.0  _(marche en range (choppy))_
- **MA** : MA20 1027.15 · MA50 1089.93 · MA200 1349.71  _(prix < MA20)_
- **Dist MA** : MA20 -4.4% · MA50 -9.9% · MA200 -27.2%
