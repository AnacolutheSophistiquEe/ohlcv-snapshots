...
**Generated** : 2026-07-16T00:02:01.536055+00:00  
...
**Subtitle** : trending · volatilite low · €976.60  

> 🟡 **WAIT-FOR-DIP** — spot +1.2 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot €976.60 (+1.2% vs entrée) · entrée €964.65 · stop €945.36 · T1 €993.54 · R/R 1.5  
> ↳ P(T1 av. stop) 29 % _(réel 5 s)_ · EV/risk 0.027 _(réel 5 s)_ (GBM 0.004) · ¼-Kelly 0.004 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €958.87–€970.43 (mid €964.65)
- Spot actuel : €976.60 (+1.2% au-dessus de la zone — repli à attendre)
- Stop : €945.36 (stop swing_plan-based (-5.95%))
- Targets : T1 €993.54 · R/R 1.5 | T2 €1022.42 · R/R 2.99 | T3 €1051.31 · R/R 4.49
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €945.36
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −1.224% → cible +2.994% / stop −2.0%, p_fill 74%, n_eff≈27.7) : P(cible|rempli) **29%** · **EV/risk +0.027** (×p_fill ; si rempli +0.07% du capital)
  - **swing** (entrée dip −2.692% → cible +6.696% / stop −3.348%, p_fill 35%, n_eff≈14.7) : P(cible|rempli) **13%** · **EV/risk -0.203** (×p_fill ; si rempli -1.95% du capital)
  - **deep** (entrée dip −4.162% → cible +9.469% / stop −4.735%, p_fill 47%, n_eff≈18.2) : P(cible|rempli) **14%** · **EV/risk -0.229** (×p_fill ; si rempli -2.32% du capital)
...
- **MACD** : hist -2.857  _(bearish_recent)_
...
- **MA** : MA20 1052.17 · MA50 1142.41 · MA200 1510.32  _(prix < MA20)_
- **Dist MA** : MA20 -7.2% · MA50 -14.5% · MA200 -35.3%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (90251 bytes source)._  
