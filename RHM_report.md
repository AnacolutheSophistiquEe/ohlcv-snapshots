...
**Generated** : 2026-08-20T21:36:11.916221+00:00  
**Santé technique** : 5/10 — **Rating** : Neutral  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : range · volatilite low · €1162.20  

> 🟡 **WAIT-FOR-DIP** — spot +1.3 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot €1162.20 (+1.3% vs entrée) · entrée €1147.02 · stop €1096.56 · T1 €1179.14 · R/R 0.64  
> ↳ P(T1 av. stop) 80 % _(réel 5 s)_ · EV/risk 0.211 _(réel 5 s)_ (GBM -0.016) · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈215) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : €1140.60–€1153.44 (mid €1147.02)
- Spot actuel : €1162.20 (+1.3% au-dessus de la zone — repli à attendre)
- Stop : €1096.56 (stop swing_plan-based (-5.65%))
- Targets : T1 €1179.14 · R/R 0.64 | T2 €1211.25 · R/R 1.27 | T3 €1243.37 · R/R 1.91
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous €1096.56


## Risque mesuré — ce qui borne (et ce qui ne borne pas) la perte

- 🟠 **Régime de gap : intermediaire** — p_breach(-3 %)=1.73 % — entre les deux regimes ; ni queue pure ni franchissement ordinaire
- **Au stop du plan (5.65 %)** : le gap seul le franchit 0.236 % des séances (3 fois sur 1273).
   - exécution **2.202 pt plus bas** dans le cas TYPIQUE (médiane), 13.864 au p90, **16.779 au pire**
   - perte réelle **12.114 %** en moyenne _(tirée par la queue)_, jusqu'à **22.429 %** — au lieu des 5.65 % annoncés par la distance
   - coût AMORTI sur toutes les séances : 0.0152 % _(ce que le gap coûte en moyenne, pas ce qu'il coûte le jour où il frappe)_
...
- **P(stop avant cible)** _(source : daily, 1274 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   ...
   - deep : **0.5195** [0.4669 ; 0.5718] _(largeur 10.5 pt, n_eff 345.8)_
- ⚠ **5 s — échantillon insuffisant sur : intraday (31.7 pt), swing (29.5 pt), deep (33.2 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
...
- **β de baisse : 0.5007** (β de hausse 0.5854, asymétrie 0.8553) vs GDAXI — 601 séances de repli, historique complet
   - ⚠ le β de baisse récent vaut 2.227× celui de l'historique complet : la sensibilité du titre au marché a changé.


## Edge, scénarios & sizing

- EV/risk : -0.016 | EV/share : €-0.810 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 56 % | T2 34 % | T3 21 %
...
- Régime probabiliste (posterior HMM, swing) : bull 39.9 | bear 24.8 | side 35.3  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.592% → cible +1.252% / stop −2.0%, p_fill 82%, n_eff≈34.8) : P(cible|rempli) **58%** · **EV/risk +0.046** (×p_fill ; si rempli +0.11% du capital)
  - **swing** (entrée dip −1.309% → cible +2.8% / stop −4.399%, p_fill 63%, n_eff≈26.5) : P(cible|rempli) **80%** · **EV/risk +0.211** (×p_fill ; si rempli +1.47% du capital)
  - **deep** (entrée dip −2.018% → cible +3.96% / stop −6.646%, p_fill 60%, n_eff≈23.3) : P(cible|rempli) **76%** · **EV/risk +0.122** (×p_fill ; si rempli +1.36% du capital)
...
- **MACD** : hist 2.37  _(pas de croisement recent)_
...
- **MA** : MA20 1147.74 · MA50 1096.62 · MA200 1423.57  _(prix > MA20)_
- **Dist MA** : MA20 +1.3% · MA50 +6.0% · MA200 -18.4%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (601027 bytes source)._  
