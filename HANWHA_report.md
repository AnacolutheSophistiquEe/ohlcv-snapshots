...
**Generated** : 2026-09-14T00:27:05.565349+00:00  
**Santé technique** : 7/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · ₩1081000.00  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-09-16 — US FOMC Rate Decision (J-1 sess · macro taux)  
> ↳ spot ₩1081000.00 (+0.9% vs entrée) · entrée ₩1071303.22 · stop ₩985598.96 · T1 ₩1088785.02 · R/R 0.2  
> ↳ P(T1 av. stop) 57 % _(réel 5 s)_ · EV/risk -0.048 _(réel 5 s)_ (GBM -0.105) · ¼-Kelly 0.041 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩1067806.86–₩1074799.58 (mid ₩1071303.22)
- Spot actuel : ₩1081000.00 (+0.9% au-dessus de la zone — repli à attendre)
- Stop : ₩985598.96 (stop swing_plan-based (-6.76%))
- Targets : T1 ₩1088785.02 · R/R 0.2 | T2 ₩1106266.82 · R/R 0.41 | T3 ₩1123748.63 · R/R 0.61
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩985598.96


## Risque mesuré — ce qui borne (et ce qui ne borne pas) la perte

- 🟠 **Régime de gap : intermediaire** — p_breach(-3 %)=1.48 % — entre les deux regimes ; ni queue pure ni franchissement ordinaire
- **Au stop du plan (6.76 %)** : le gap seul le franchit 0.411 % des séances (5 fois sur 1217).
   - exécution **2.201 pt plus bas** dans le cas TYPIQUE (médiane), 6.434 au p90, **6.459 au pire**
   - perte réelle **9.925 %** en moyenne _(tirée par la queue)_, jusqu'à **13.219 %** — au lieu des 6.76 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1218 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.0557** [0.0286 ; 0.0974] _(largeur 6.9 pt, n_eff 173.1)_
   - swing : **0.4003** [0.3497 ; 0.4526] _(largeur 10.3 pt, n_eff 345.6)_
   - deep : **0.4252** [0.3739 ; 0.4778] _(largeur 10.4 pt, n_eff 345.6)_
- ⚠ 5 s / deep : probabilite(s) EXACTEMENT nulle(s) : p_no_touch. Ce n'est PAS « jamais » — c'est « aucune occurrence sur 29.9 observations effectives », dont la borne haute a 95 % vaut environ 10.0 %.
- ⚠ **5 s — échantillon insuffisant sur : intraday (32.6 pt), swing (33.5 pt), deep (33.8 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
- **VaR/CVaR à 1 j (fenêtre adaptative, 720 séances)** : VaR **-5.73 %** | CVaR **-7.64 %** | vol 3.95 %/j
   - _fenêtre arrêtée : rupture de regime a 780 seances en arriere (volatilite 2.51 % contre 4.02 % aujourd'hui, rapport 0.62)_
...
- **β de baisse : 0.5231** (β de hausse 0.2919, asymétrie 1.7922) vs KS11 — 554 séances de repli, historique complet
   - ⚠ le β de baisse récent vaut 0.338× celui de l'historique complet : la sensibilité du titre au marché a changé.


## Edge, scénarios & sizing

- EV/risk : -0.105 | EV/share : ₩-8965.638 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 58.2 | bear 5.0 | side 36.8  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.902% → cible +1.632% / stop −8.0%, p_fill 84%, n_eff≈33.0) : P(cible|rempli) **57%** · **EV/risk -0.048** (×p_fill ; si rempli -0.46% du capital)
  - **swing** (entrée dip −1.969% → cible +3.649% / stop −4.887%, p_fill 74%, n_eff≈30.5) : P(cible|rempli) **60%** · **EV/risk +0.012** (×p_fill ; si rempli +0.08% du capital)
  - **deep** (entrée dip −3.055% → cible +5.16% / stop −7.412%, p_fill 75%, n_eff≈29.9) : P(cible|rempli) **60%** · **EV/risk +0.001** (×p_fill ; si rempli +0.01% du capital)
...
- **MACD** : hist -6818.354  _(pas de croisement recent)_
- **BB** : %B 0.43 · largeur 18.2%
- **ATR** : 51785.71 (27.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV rising · CMF -0.105  _(distribution)_
- **Vol ratio** : 0.67  _(volume normal)_
- **Choppiness** : 57.5  _(transition)_
- **MA** : MA20 1094200.0 · MA50 1034740.0 · MA200 1155725.52  _(prix < MA20)_
- **Dist MA** : MA20 -1.2% · MA50 +4.5% · MA200 -6.5%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (480866 bytes source)._  
