...
**Generated** : 2026-09-17T00:27:01.138520+00:00  
**Santé technique** : 4/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : indeterminate · volatilite normal · ₩1055000.00  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot ₩1055000.00 (+0.3% vs entrée) · entrée ₩1051412.08 · stop ₩967299.12 · T1 ₩1071239.68 · R/R 0.24  
> ↳ P(T1 av. stop) 53 % _(réel 5 s)_ · EV/risk -0.093 _(réel 5 s)_ (GBM -0.109) · ¼-Kelly 0.035 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩1047824.17–₩1055000.00 (mid ₩1051412.08)
- Spot actuel : ₩1055000.00 (+0.3% au-dessus de la zone — repli à attendre)
- Stop : ₩967299.12 (stop swing_plan-based (-5.88%))
- Targets : T1 ₩1071239.68 · R/R 0.24 | T2 ₩1091067.27 · R/R 0.47 | T3 ₩1110894.87 · R/R 0.71
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩967299.12
...
- **P(stop avant cible)** _(source : daily, 1218 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.0578** [0.0301 ; 0.1001] _(largeur 7.0 pt, n_eff 173.1)_
   - swing : **0.4196** [0.3684 ; 0.4721] _(largeur 10.4 pt, n_eff 345.6)_
   - deep : **0.4477** [0.3959 ; 0.5004] _(largeur 10.4 pt, n_eff 345.6)_
- ⚠ **5 s — échantillon insuffisant sur : intraday (31.5 pt), swing (31.6 pt), deep (32.0 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
- **VaR/CVaR à 1 j (fenêtre adaptative, 720 séances)** : VaR **-5.93 %** | CVaR **-7.65 %** | vol 3.96 %/j
   - _fenêtre arrêtée : rupture de regime a 780 seances en arriere (volatilite 2.49 % contre 4.05 % aujourd'hui, rapport 0.62)_
...
- **β de baisse : 0.5106** (β de hausse 0.2923, asymétrie 1.7471) vs KS11 — 555 séances de repli, historique complet
   - ⚠ le β de baisse récent vaut 0.305× celui de l'historique complet : la sensibilité du titre au marché a changé.


## Edge, scénarios & sizing

- EV/risk : -0.109 | EV/share : ₩-9136.208 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 49 % | T2 30 % | T3 19 %
...
- Régime probabiliste (posterior HMM, intraday) : bull 67.9 | bear 5.0 | side 27.1  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.337% → cible +1.886% / stop −8.0%, p_fill 90%, n_eff≈36.2) : P(cible|rempli) **53%** · **EV/risk -0.093** (×p_fill ; si rempli -0.83% du capital)
  - **swing** (entrée dip −0.755% → cible +4.217% / stop −5.164%, p_fill 89%, n_eff≈35.6) : P(cible|rempli) **55%** · **EV/risk -0.032** (×p_fill ; si rempli -0.18% du capital)
  - **deep** (entrée dip −1.102% → cible +5.963% / stop −7.774%, p_fill 88%, n_eff≈35.0) : P(cible|rempli) **50%** · **EV/risk -0.095** (×p_fill ; si rempli -0.84% du capital)
...
- **MACD** : hist -3155.858  _(pas de croisement recent)_
- **BB** : %B 0.34 · largeur 15.9%
- **ATR** : 54071.43 (28.0e pct 1a)  _(volatilite normale)_
- **OBV/CMF** : OBV rising · CMF -0.076  _(distribution)_
- **Vol ratio** : 0.89  _(volume normal)_
- **Choppiness** : 59.1  _(transition)_
- **MA** : MA20 1082800.0 · MA50 1030840.0 · MA200 1158658.74  _(prix < MA20)_
- **Dist MA** : MA20 -2.6% · MA50 +2.3% · MA200 -8.9%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (478917 bytes source)._  
