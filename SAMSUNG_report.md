...
**Generated** : 2026-08-31T00:15:50.733088+00:00  
...
> ↳ P(T1 av. stop) 5 % _(réel 5 s)_ · EV/risk -0.116 _(réel 5 s)_ (GBM 0.204) · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈207) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩237729.72–₩246494.83 (mid ₩242112.28)
- Spot actuel : ₩257000.00 (+6.1% au-dessus de la zone — repli à attendre)
- Stop : ₩214231.51 (stop swing_plan-based (-16.64%))
- Targets : T1 ₩297873.81 · R/R 2.0 | T2 ₩302762.61 · R/R 2.18 | T3 ₩307651.41 · R/R 2.35
...
- **P(stop avant cible)** _(source : daily, 1218 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   ...
   - deep : **0.2045** [0.1645 ; 0.2494] _(largeur 8.5 pt, n_eff 345.6)_
- ⚠ **5 s — échantillon insuffisant sur : intraday (36.5 pt), swing (37.5 pt), deep (38.6 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
...
- EV/risk : 0.204 | EV/share : ₩5686.747 | p_fill : —
...
- Régime probabiliste (posterior HMM, swing) : bull 53.3 | bear 8.3 | side 38.5  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −2.629% → cible +5.075% / stop −2.537%, p_fill 54%, n_eff≈26.3) : P(cible|rempli) **5%** · **EV/risk -0.193** (×p_fill ; si rempli -0.90% du capital)
  - **swing** (entrée dip −5.791% → cible +23.031% / stop −11.516%, p_fill 45%, n_eff≈20.9) : P(cible|rempli) **5%** · **EV/risk -0.116** (×p_fill ; si rempli -2.95% du capital)
  - **deep** (entrée dip −8.949% → cible +12.761% / stop −10.577%, p_fill 50%, n_eff≈23.1) : P(cible|rempli) **42%** · **EV/risk +0.006** (×p_fill ; si rempli +0.12% du capital)
...
- **MACD** : hist 2314.619  _(pas de croisement recent)_
- **BB** : %B 0.55 · largeur 24.4%
- **ATR** : 16500.0 (69.0e pct 1a)  _(volatilite au-dessus de la moyenne (tiers haut))_
- **OBV/CMF** : OBV rising · CMF 0.02  _(neutre)_
- **Vol ratio** : 0.59  _(volume atone)_
- **Choppiness** : 50.8  _(transition)_
- **MA** : MA20 254200.0 · MA50 274916.72 · MA200 207474.95  _(prix > MA20)_
- **Dist MA** : MA20 +1.1% · MA50 -6.5% · MA200 +23.9%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (617792 bytes source)._  
