...
**Generated** : 2026-09-09T00:23:25.356328+00:00  
...
> ↳ spot ₩269500.00 (+0.6% vs entrée) · entrée ₩267857.96 · stop ₩246429.32 · T1 ₩274567.17 · R/R 0.31  
> ↳ P(T1 av. stop) 37 % _(réel 5 s)_ · EV/risk -0.053 _(réel 5 s)_ (GBM -0.064) · ¼-Kelly 0.05 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : ₩266516.11–₩269199.80 (mid ₩267857.96)
- Spot actuel : ₩269500.00 (+0.6% au-dessus de la zone — repli à attendre)
- Stop : ₩246429.32 (stop swing_plan-based (-6.48%))
- Targets : T1 ₩274567.17 · R/R 0.31 | T2 ₩281276.38 · R/R 0.63 | T3 ₩287985.59 · R/R 0.94
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩246429.32
...
- **Au stop du plan (6.48 %)** : le gap seul le franchit 0.247 % des séances (3 fois sur 1217).
   - exécution **1.331 pt plus bas** dans le cas TYPIQUE (médiane), 3.836 au p90, **4.462 au pire**
   - perte réelle **8.848 %** en moyenne _(tirée par la queue)_, jusqu'à **10.942 %** — au lieu des 6.48 % annoncés par la distance
...
- **P(stop avant cible)** _(source : daily, 1218 séances — à préférer au 5 s sur swing et deep, où celui-ci ne dispose que d'une trentaine d'observations effectives)_ :
   - intraday : **0.0417** [0.0191 ; 0.0794] _(largeur 6.0 pt, n_eff 173.1)_
   - swing : **0.3049** [0.2581 ; 0.3549] _(largeur 9.7 pt, n_eff 345.6)_
   - deep : **0.2579** [0.2139 ; 0.3059] _(largeur 9.2 pt, n_eff 345.6)_
...
- ⚠ **5 s — échantillon insuffisant sur : intraday (30.4 pt), swing (31.2 pt), deep (32.1 pt).** Ces chiffres peuvent être CITÉS, jamais servir à dimensionner ni à arbitrer entre deux plans.
- **VaR/CVaR à 1 j (fenêtre adaptative, 250 séances)** : VaR **-7.71 %** | CVaR **-9.83 %** | vol 4.72 %/j
   - _fenêtre arrêtée : rupture de regime a 240 seances en arriere (volatilite 2.62 % contre 5.81 % aujourd'hui, rapport 0.45)_
...
- **β de baisse : 1.169** (β de hausse 1.337, asymétrie 0.8743) vs KS11 — 551 séances de repli, historique complet


## Edge, scénarios & sizing

- EV/risk : -0.064 | EV/share : ₩-1367.186 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 47.3 | bear 5.8 | side 46.9  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.609% → cible +2.505% / stop −8.0%, p_fill 86%, n_eff≈36.8) : P(cible|rempli) **37%** · **EV/risk -0.053** (×p_fill ; si rempli -0.50% du capital)
  - **swing** (entrée dip −1.338% → cible +5.601% / stop −5.212%, p_fill 82%, n_eff≈35.3) : P(cible|rempli) **39%** · **EV/risk -0.192** (×p_fill ; si rempli -1.22% du capital)
  - **deep** (entrée dip −2.067% → cible +7.921% / stop −7.876%, p_fill 83%, n_eff≈33.6) : P(cible|rempli) **31%** · **EV/risk -0.304** (×p_fill ; si rempli -2.89% du capital)
...
- **MACD** : hist 1428.208  _(pas de croisement recent)_
- **BB** : %B 0.71 · largeur 15.6%
- **ATR** : 13857.14 (65.0e pct 1a)  _(volatilite au-dessus de la moyenne (tiers haut))_
- **OBV/CMF** : OBV rising · CMF 0.128  _(accumulation)_
- **Vol ratio** : 1.05  _(volume normal)_
- **Choppiness** : 58.0  _(transition)_
- **MA** : MA20 261050.0 · MA50 262930.0 · MA200 213047.21  _(prix > MA20)_
- **Dist MA** : MA20 +3.2% · MA50 +2.5% · MA200 +26.5%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (483996 bytes source)._  
