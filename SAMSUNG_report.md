...
- **Au stop du plan (9.05 %)** : le gap seul le franchit 0.082 % des séances ; quand il le franchit, l'exécution est **1.892 points plus bas** → perte réelle **10.942 %** _(et non 9.05 %)_
