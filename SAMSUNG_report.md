...
- Entry (zone de repli) : ₩249383.90–₩253866.10 (mid ₩251625.00)
- Spot actuel : ₩255500.00 (+1.5% au-dessus de la zone — repli à attendre)
- Stop : ₩244547.14 (stop swing_plan-based (-14.14%))
- Targets : T1 ₩262931.82 · R/R 1.6 | T2 ₩274035.71 · R/R 3.17 | T3 ₩285139.59 · R/R 4.74
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous ₩244547.14


## Edge, scénarios & sizing

- EV/risk : -0.118 | EV/share : ₩-838.630 | p_fill : —
...
- Régime probabiliste (posterior HMM, intraday) : bull 41.2 | bear 25.8 | side 33.1  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −1.52% → cible +4.494% / stop −2.813%, p_fill 84%, n_eff≈33.5) : P(cible|rempli) **8%** · **EV/risk -0.389** (×p_fill ; si rempli -1.30% du capital)
  - **swing** (entrée dip −3.34% → cible +22.347% / stop −11.174%, p_fill 78%, n_eff≈28.5) : P(cible|rempli) **6%** · **EV/risk -0.335** (×p_fill ; si rempli -4.79% du capital)
  - **deep** (entrée dip −5.159% → cible +14.04% / stop −14.604%, p_fill 73%, n_eff≈26.3) : P(cible|rempli) **13%** · **EV/risk -0.416** (×p_fill ; si rempli -8.35% du capital)
...
- **MACD** : hist 3257.139  _(pas de croisement recent)_
- **BB** : %B 0.65 · largeur 31.4%
- **ATR** : 23592.86 (84.0e pct 1a)  _(volatilite elevee)_
- **OBV/CMF** : OBV rising · CMF -0.199  _(distribution)_
- **Vol ratio** : 0.91  _(volume normal)_
- **Choppiness** : 54.8  _(transition)_
- **MA** : MA20 244075.0 · MA50 288827.2 · MA200 198487.68  _(prix > MA20)_
- **Dist MA** : MA20 +4.7% · MA50 -11.5% · MA200 +28.7%
