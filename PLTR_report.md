...
**Subtitle** : strong_trend · volatilite high · $179.01  

> 🟡 **WAIT-FOR-DIP** — spot +10.8 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot $179.01 (+10.8% vs entrée) · entrée $161.57 · stop $151.75 · T1 $175.21 · R/R 1.39  
> ↳ P(T1 av. stop) 49 % · EV/risk 0.096 · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈214) · non recalibrée track-record (n=0)_  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal 386 % hors [0,100] (R² max 0.40). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- 🔴 **Santé haussière vs sur-extension** — Santé technique 10/10 élevée alors que : RSI 79.1 > 70 (surachat) ; extension extrême (≥3×ATR, confluence MA20/50) — le score mesure la santé durable, PAS le timing ; entrée au prix actuel défavorable.
...
- Entry (zone de repli) : $158.84–$164.30 (mid $161.57)
- Spot actuel : $179.01 (+10.8% au-dessus de la zone — repli à attendre)
- Stop : $151.75 (stop swing_plan-based (-15.23%))
- Targets : T1 $175.21 · R/R 1.39 | T2 $188.84 · R/R 2.78 | T3 $202.48 · R/R 4.17
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $151.75


## Edge, scénarios & sizing

- EV/risk : 0.015 | EV/share : $0.150 | p_fill : —
...
- Régime probabiliste (posterior HMM, swing) : bull 5.0 | bear 13.8 | side 81.2  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 537.0 (= 3 part(s) × prix) · cible 640.0
...
- **RSI** : 79.1  _(surachat)_
- **ADX** : 27.1  _(tendance etablie)_
- **MACD** : hist 4.753  _(pas de croisement recent)_
- **BB** : %B 0.9 · largeur 61.4%
- **ATR** : 9.82 (93.0e pct 1a)  _(volatilite elevee)_
- **OBV/CMF** : OBV rising · CMF 0.22  _(accumulation)_
- **Vol ratio** : 0.77  _(volume normal)_
- **Choppiness** : 30.2  _(marche directionnel)_
- **MA** : MA20 143.45 · MA50 134.35 · MA200 152.17  _(prix > MA20)_
- **Dist MA** : MA20 +24.8% · MA50 +33.2% · MA200 +17.6%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (89766 bytes source)._  
