...
**Generated** : 2026-08-20T00:21:50.966336+00:00  
...
**Subtitle** : strong_trend · volatilite high · $175.19  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot $175.19 (+9.6% vs entrée) · entrée $159.85 · stop $150.71 · T1 $172.95 · R/R 1.43  
> ↳ P(T1 av. stop) 37 % · EV/risk -0.038 · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈214) · non recalibrée track-record (n=0)_  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal 122 % hors [0,100] (R² max 0.32). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- 🔴 **Santé haussière vs sur-extension** — Santé technique 9/10 élevée alors que : RSI 79.5 > 70 (surachat) ; extension étirée (≥2×ATR au-dessus de la MA20) — le score mesure la santé durable, PAS le timing ; entrée au prix actuel défavorable.
...
- Entry (zone de repli) : $157.23–$162.47 (mid $159.85)
- Spot actuel : $175.19 (+9.6% au-dessus de la zone — repli à attendre)
- Stop : $150.71 (stop swing_plan-based (-13.97%))
- Targets : T1 $172.95 · R/R 1.43 | T2 $186.05 · R/R 2.87 | T3 $199.15 · R/R 4.3
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $150.71


## Edge, scénarios & sizing

- EV/risk : -0.02 | EV/share : $-0.186 | p_fill : —
...
- **RSI** : 79.5  _(surachat)_
- **ADX** : 30.8  _(tendance etablie)_
- **MACD** : hist 1.829  _(pas de croisement recent)_
- **BB** : %B 0.75 · largeur 62.5%
- **ATR** : 9.14 (87.0e pct 1a)  _(volatilite elevee)_
- **OBV/CMF** : OBV falling · CMF 0.201  _(accumulation)_
- **Vol ratio** : 0.77  _(volume normal)_
- **Choppiness** : 28.3  _(marche directionnel)_
- **MA** : MA20 151.89 · MA50 137.1 · MA200 151.77  _(prix > MA20)_
- **Dist MA** : MA20 +15.3% · MA50 +27.8% · MA200 +15.4%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (106295 bytes source)._  
