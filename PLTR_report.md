...
**Generated** : 2026-09-04T00:28:11.652260+00:00  
**Santé technique** : 8/10 — **Rating** : Pass  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : trending · volatilite normal · $182.48  

> 🟡 **WAIT-FOR-DIP** — spot +5.1 % au-dessus de la zone d'entrée — attendre le repli  
> ↳ spot $182.48 (+5.1% vs entrée) · entrée $173.68 · stop $171.07 · T1 $177.33 · R/R 1.4  
> ↳ P(T1 av. stop) 44 % · EV/risk 0.067 · ¼-Kelly 0.014 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −1.5% cohérent avec le bruit 5 s (EV-optimal ≈ −1.5%)  

> ⚠ **QA flags (2, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §12 Options — Max-pain gap affiché +4.7 % ≠ (strike 177.5 − spot 182.48)/spot = -2.7 %. Probable spot d'options périmé vs spot courant.
...
- Entry (zone de repli) : $172.95–$174.41 (mid $173.68)
- Spot actuel : $182.48 (+5.1% au-dessus de la zone — repli à attendre)
- Stop : $171.07 (stop swing_plan-based (-14.94%))
- Targets : T1 $177.33 · R/R 1.4 | T2 $180.98 · R/R 2.8 | T3 $184.63 · R/R 4.2
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $171.07
...
- **Au stop du plan (14.94 %)** : le gap seul le franchit 0.08 % des séances (1 fois sur 1253).
   - exécution **2.992 pt plus bas** dans le cas TYPIQUE (médiane), 2.992 au p90, **2.992 au pire**
   - perte réelle **17.932 %** en moyenne _(tirée par la queue)_, jusqu'à **17.932 %** — au lieu des 14.94 % annoncés par la distance
...
- **β de baisse : 1.7062** (β de hausse 1.4034, asymétrie 1.2158) vs IWM — 602 séances de repli, historique complet


## Echelle Warden — OU poser le stop

- **Verdict : AUCUN couple (stop, cible) ne tient les contraintes. Ce n'est pas un defaut du calcul : la structure est trop loin sous le spot pour qu'un stop structurel soit rentable a ces cibles. Le levier de fond n'est PAS la distance du stop mais la TAILLE de la ligne — voir `min_target_for_rr` pour savoir a partir de quelle cible chaque stop redeviendrait defendable. **MAIS ON POSE QUAND MEME** : `best_effort` porte le moins mauvais couple, non conforme et marque comme tel. Laisser la ligne NUE est pire — la perte y est non bornee.**
- **Couple retenu** : stop 160.778 sur atr_grid (2.75 ATR, 11.893 %) — p(stop avant cible) 0.1789 [0.14 ; 0.22], R/R 0.311, perte reelle 14.376 % (gap inclus), CVaR 11.901 %, EV 0.0626 % — **NON CONFORME (best_effort — proposition de derniere main)**
   - viole : R/R 0.31 < plancher 3.00 (mesure vs SPOT, gap inclus)
- Budget de queue : **12.0 %** du notionnel — ⚠ VALEUR FIGEE (valeur de repli (ligne absente de l'allocation)), PAS une mesure. L'allocation derivee de la contrainte du compte n'etait pas disponible.
- Candidats (la structure propose, la statistique elimine) :
   - ⚪ atr_based a 1.5 ATR (stop 6.487 %) — p(stop avant cible) 0.3232 [0.28 ; 0.37], R/R 0.434, perte reelle 10.298 % (gap inclus), EV -0.4806 % — **REFUSE**
      - refuse : R/R 0.43 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.48 %) : P(cible) 63.1 % x 4.47 % + P(rien) 4.6 % x 0.61 % ne couvrent pas P(stop) 32.3 % x 10.30 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ swing_based a 1.92 ATR (stop 10.426 %) — p(stop avant cible) 0.2211 [0.18 ; 0.27], R/R 0.325, perte reelle 13.763 % (gap inclus), EV -0.2615 % — **REFUSE**
      - refuse : R/R 0.32 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.26 %) : P(cible) 66.8 % x 4.47 % + P(rien) 11.1 % x -1.81 % ne couvrent pas P(stop) 22.1 % x 13.76 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ sr_based a 4.56 ATR (stop 21.846 %) — p(stop avant cible) 0.0302 [0.02 ; 0.05], R/R 0.205, perte reelle 21.846 % (gap inclus), EV 0.6849 % — **REFUSE**
      - refuse : R/R 0.20 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 21.85 % > budget 12.00 %
   - 🟢 support a 8.18 ATR (stop 37.515 %) — p(stop avant cible) 0.0 [0.00 ; 0.01], R/R 0.119, perte reelle 37.515 % (gap inclus), EV 0.8523 % — **REFUSE**
      - refuse : R/R 0.12 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 37.51 % > budget 12.00 %
   - 🟢 support a 9.64 ATR (stop 43.828 %) — p(stop avant cible) 0.0 [0.00 ; 0.01], R/R 0.102, perte reelle 43.828 % (gap inclus), EV 0.8505 % — **REFUSE**
      - refuse : R/R 0.10 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 43.83 % > budget 12.00 %
   - ⚪ atr_grid a 0.25 ATR (stop 1.081 %) — p(stop avant cible) 0.8028 [0.76 ; 0.84], R/R 1.763, perte reelle 2.535 % (gap inclus), EV -1.1538 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.15 %) : P(cible) 19.7 % x 4.47 % + P(rien) 0.0 % x 0.00 % ne couvrent pas P(stop) 80.3 % x 2.54 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.5 ATR (stop 2.162 %) — p(stop avant cible) 0.6636 [0.61 ; 0.71], R/R 1.149, perte reelle 3.89 % (gap inclus), EV -1.078 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.08 %) : P(cible) 33.6 % x 4.47 % + P(rien) 0.0 % x 0.00 % ne couvrent pas P(stop) 66.4 % x 3.89 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 0.75 ATR (stop 3.243 %) — p(stop avant cible) 0.5578 [0.51 ; 0.61], R/R 0.822, perte reelle 5.44 % (gap inclus), EV -1.0582 % — **REFUSE**
      ...
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.06 %) : P(cible) 44.2 % x 4.47 % + P(rien) 0.0 % x 0.00 % ne couvrent pas P(stop) 55.8 % x 5.44 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.0 ATR (stop 4.325 %) — p(stop avant cible) 0.4668 [0.41 ; 0.52], R/R 0.612, perte reelle 7.302 % (gap inclus), EV -1.0515 % — **REFUSE**
      - refuse : R/R 0.61 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-1.05 %) : P(cible) 52.8 % x 4.47 % + P(rien) 0.5 % x -0.68 % ne couvrent pas P(stop) 46.7 % x 7.30 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 1.25 ATR (stop 5.406 %) — p(stop avant cible) 0.3866 [0.34 ; 0.44], R/R 0.487, perte reelle 9.186 % (gap inclus), EV -0.9273 % — **REFUSE**
      - refuse : R/R 0.49 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.93 %) : P(cible) 58.4 % x 4.47 % + P(rien) 3.0 % x 0.53 % ne couvrent pas P(stop) 38.7 % x 9.19 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ grid_snapped a 1.92 ATR (stop 9.604 %) — p(stop avant cible) 0.2344 [0.19 ; 0.28], R/R 0.34, perte reelle 13.126 % (gap inclus), EV -0.225 % — **REFUSE**
      - refuse : R/R 0.34 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - 🚩 **LIGNE_EV_NEGATIVE** — le meilleur bracket disponible perd de l'argent en esperance (-0.22 %) : P(cible) 66.6 % x 4.47 % + P(rien) 9.9 % x -1.27 % ne couvrent pas P(stop) 23.4 % x 13.13 %.
        -> l'alternative dominante n'est pas un autre stop mais la REDUCTION ou la CLOTURE de la ligne. A remonter a l'etage portefeuille, pas a traiter en assouplissant les contraintes.
   - ⚪ atr_grid a 2.75 ATR (stop 11.893 %) — p(stop avant cible) 0.1789 [0.14 ; 0.22], R/R 0.311, perte reelle 14.376 % (gap inclus), EV 0.0626 % — **REFUSE**
      - refuse : R/R 0.31 < plancher 3.00 (mesure vs SPOT, gap inclus)
   - ⚪ atr_grid a 3.0 ATR (stop 12.974 %) — p(stop avant cible) 0.1394 [0.11 ; 0.18], R/R 0.274, perte reelle 16.302 % (gap inclus), EV 0.0972 % — **REFUSE**
      - refuse : R/R 0.27 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 12.98 % > budget 12.00 %
   - ⚪ atr_grid a 3.5 ATR (stop 15.136 %) — p(stop avant cible) 0.1011 [0.07 ; 0.14], R/R 0.249, perte reelle 17.932 % (gap inclus), EV 0.2555 % — **REFUSE**
      - refuse : R/R 0.25 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 15.14 % > budget 12.00 %
   - ⚪ atr_grid a 4.0 ATR (stop 17.299 %) — p(stop avant cible) 0.0831 [0.06 ; 0.12], R/R 0.249, perte reelle 17.932 % (gap inclus), EV 0.4563 % — **REFUSE**
      - refuse : R/R 0.25 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 17.30 % > budget 12.00 %
   - ⚪ grid_snapped a 4.56 ATR (stop 21.024 %) — p(stop avant cible) 0.0318 [0.02 ; 0.05], R/R 0.213, perte reelle 21.024 % (gap inclus), EV 0.6852 % — **REFUSE**
      - refuse : R/R 0.21 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 21.02 % > budget 12.00 %
   - ⚪ atr_grid a 5.5 ATR (stop 23.786 %) — p(stop avant cible) 0.0071 [0.00 ; 0.02], R/R 0.188, perte reelle 23.786 % (gap inclus), EV 0.8003 % — **REFUSE**
      - refuse : R/R 0.19 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 23.79 % > budget 12.00 %
   - ⚪ atr_grid a 6.0 ATR (stop 25.948 %) — p(stop avant cible) 0.0051 [0.00 ; 0.02], R/R 0.172, perte reelle 25.948 % (gap inclus), EV 0.8081 % — **REFUSE**
      - refuse : R/R 0.17 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 25.95 % > budget 12.00 %
   - ⚪ atr_grid a 6.5 ATR (stop 28.11 %) — p(stop avant cible) 0.0029 [0.00 ; 0.01], R/R 0.159, perte reelle 28.11 % (gap inclus), EV 0.8422 % — **REFUSE**
      - refuse : R/R 0.16 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 28.11 % > budget 12.00 %
   - ⚪ atr_grid a 7.0 ATR (stop 30.273 %) — p(stop avant cible) 0.0029 [0.00 ; 0.01], R/R 0.148, perte reelle 30.273 % (gap inclus), EV 0.8357 % — **REFUSE**
      - refuse : R/R 0.15 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 30.27 % > budget 12.00 %
   - ⚪ atr_grid a 7.5 ATR (stop 32.435 %) — p(stop avant cible) 0.0014 [0.00 ; 0.01], R/R 0.138, perte reelle 32.435 % (gap inclus), EV 0.8482 % — **REFUSE**
      - refuse : R/R 0.14 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 32.44 % > budget 12.00 %
   - 🟢 grid_snapped a 8.18 ATR (stop 36.693 %) — p(stop avant cible) 0.0001 [0.00 ; 0.01], R/R 0.122, perte reelle 36.693 % (gap inclus), EV 0.8489 % — **REFUSE**
      - refuse : R/R 0.12 < plancher 3.00 (mesure vs SPOT, gap inclus)
      - refuse : CVaR 95 % 36.69 % > budget 12.00 %
...
- Reference : spot 182.48, ATR14 7.8916 (4.325 % du cours). **Les prix ci-dessous sont ancres sur ce spot de cloture : les REANCRER sur le prix vivant avant de poser.**
...
|---|---|---|---|---|---|---|---|---|
| 0.05 ATR | 0