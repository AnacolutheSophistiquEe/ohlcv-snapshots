...
**Generated** : 2026-08-14T22:02:46.935568+00:00  
...
**Subtitle** : strong_trend · volatilite high · $174.04  

> ⛔ **STAND-DOWN** — EV/risque ≤ 0 — pas d'engagement statistiquement justifié (vérité terrain 5 s)  
> ↳ spot $174.04 (+9.2% vs entrée) · entrée $159.33 · stop $149.73 · T1 $172.85 · R/R 1.41  
> ↳ P(T1 av. stop) 35 % · EV/risk -0.091 · ¼-Kelly 0.0 · _first-passage empirique daily (historique réel, n≈214) · non recalibrée track-record (n=0)_  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal 361 % hors [0,100] (R² max 0.40). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- 🔴 **Santé haussière vs sur-extension** — Santé technique 10/10 élevée alors que : RSI 72.9 > 70 (surachat) ; extension étirée (≥2×ATR au-dessus de la MA20) — le score mesure la santé durable, PAS le timing ; entrée au prix actuel défavorable.
...
- Entry (zone de repli) : $156.63–$162.04 (mid $159.33)
- Spot actuel : $174.04 (+9.2% au-dessus de la zone — repli à attendre)
- Stop : $149.73 (stop swing_plan-based (-13.97%))
- Targets : T1 $172.85 · R/R 1.41 | T2 $186.37 · R/R 2.82 | T3 $199.88 · R/R 4.22
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $149.73


## Edge, scénarios & sizing

- EV/risk : 0.015 | EV/share : $0.139 | p_fill : —
...
- Régime probabiliste (posterior HMM, swing) : bull 5.0 | bear 15.0 | side 80.0  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −3.836% → cible +3.794% / stop −2.5%, p_fill 16%, n_eff≈8.8) : P(cible|rempli) **0%** · **EV/risk -0.027** (×p_fill ; si rempli -0.43% du capital)
...
- **MACD** : hist 4.023  _(pas de croisement recent)_
- **BB** : %B 0.81 · largeur 62.9%
- **ATR** : 9.6 (92.0e pct 1a)  _(volatilite elevee)_
- **OBV/CMF** : OBV rising · CMF 0.193  _(accumulation)_
- **Vol ratio** : 0.51  _(volume atone)_
- **Choppiness** : 29.1  _(marche directionnel)_
- **MA** : MA20 145.53 · MA50 134.99 · MA200 152.09  _(prix > MA20)_
- **Dist MA** : MA20 +19.6% · MA50 +28.9% · MA200 +14.4%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (90604 bytes source)._  
