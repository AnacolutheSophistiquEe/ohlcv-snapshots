...
**Generated** : 2026-07-13T00:34:14.271515+00:00  
**Santé technique** : 8/10 — **Rating** : Pass (negative EV)  
_(score = santé technique durable ; le rating = tradabilité/EV. Timing d'entrée distinct ci-dessous — audit §A3.)_  
**Subtitle** : trending · volatilite low · $18.78  

> ❄️ **EVENT-FROZEN** — horizon gelé jusqu'au 2026-07-14 — US CPI (headline) (J-1 sess · macro taux)  
> ↳ spot $18.78 (+0.3% vs entrée) · entrée $18.72 · stop $18.07 · T1 $19.11 · R/R 0.6  
> ↳ P(T1 av. stop) 40 % _(réel 5 s)_ · EV/risk -0.095 _(réel 5 s)_ (GBM 0.003) · ¼-Kelly 0.035 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
> ↳ stop −3.5% cohérent avec le bruit 5 s (EV-optimal ≈ −3.5%)  

> ⚠ **QA flags (1, dont 0 high)** — champs SUSPECTS (la section data fraîche prime) :
>   - **[MEDIUM]** §04 Pitchfork — Position dans le canal -360 % hors [0,100] (R² max 0.93). Canal dégénéré (bornes possiblement sous le prix) — à ne pas interpréter.
...
- Entry (zone de repli) : $18.67–$18.78 (mid $18.72)
- Spot actuel : $18.78 (+0.3% au-dessus de la zone — repli à attendre)
- Stop : $18.07 (stop swing_plan-based (-5.03%))
- Targets : T1 $19.11 · R/R 0.6 | T2 $19.34 · R/R 0.95 | T3 $19.56 · R/R 1.29
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $18.07


## Edge, scénarios & sizing

- EV/risk : 0.003 | EV/share : $0.002 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 47 % | T2 31 % | T3 16 %
...
- Régime probabiliste (posterior HMM, intraday) : bull 40.4 | bear 15.5 | side 44.1  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
- Sizing : notional réel 394.0 (= 21 part(s) × prix) · cible 400.0


## Microstructure intraday (5 s réel · 80 séances)

- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −0.3% → cible +2.067% / stop −3.5%, p_fill 82%, n_eff≈36.0) : P(cible|rempli) **40%** · **EV/risk -0.095** (×p_fill ; si rempli -0.41% du capital)
  - **swing** (entrée dip −0.48% → cible +9.144% / stop −4.572%, p_fill 93%, n_eff≈38.6) : P(cible|rempli) **19%** · **EV/risk +0.102** (×p_fill ; si rempli +0.50% du capital)
  - **deep** (entrée dip −0.621% → cible +4.728% / stop −2.363%, p_fill 88%, n_eff≈37.8) : P(cible|rempli) **29%** · **EV/risk -0.182** (×p_fill ; si rempli -0.49% du capital)
...
- **MA** : MA20 17.73 · MA50 16.85 · MA200 22.08  _(prix > MA20)_
- **Dist MA** : MA20 +5.9% · MA50 +11.5% · MA200 -14.9%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (87176 bytes source)._  
