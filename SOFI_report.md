...
**Generated** : 2026-08-20T00:29:51.630578+00:00  
...
> ↳ spot $18.42 (+3.5% vs entrée) · entrée $17.79 · stop $17.53 · T1 $18.20 · R/R 1.58  
> ↳ P(T1 av. stop) 49 % · EV/risk 0.071 · ¼-Kelly 0.008 · _first-passage 5 s RÉEL intra-séance (vrai ordre intrabar, n=80 séances) · non recalibrée track-record (n=0)_  
...
- Entry (zone de repli) : $17.71–$17.87 (mid $17.79)
- Spot actuel : $18.42 (+3.5% au-dessus de la zone — repli à attendre)
- Stop : $17.53 (stop swing_plan-based (-11.44%))
- Targets : T1 $18.20 · R/R 1.58 | T2 $18.60 · R/R 3.12 | T3 $19.00 · R/R 4.65
- Activation : entree LMT en attente de touche de zone
- Invalidation : close sous $17.53


## Edge, scénarios & sizing

- EV/risk : 0.019 | EV/share : $0.005 | p_fill : —
- P(cible avant stop) _(first-passage MC, la proba OCO)_ : T1 42 % | T2 15 % | T3 11 %
...
- Régime probabiliste (posterior HMM, intraday) : bull 79.0 | bear 11.6 | side 9.4  _(probas d'ÉTAT de régime, bornées [5,85]% ; ≠ Monte-Carlo de l'EV ci-dessus)_
...
- **First-passage & EV RÉELS par horizon** _(vérité terrain 5 s, **pondérés par récence** demi-vie ≈15.0 séances → régime des ~2-3 dernières semaines dominant ; entrée au DIP ; n_eff = échantillon effectif ; à comparer à l'EV GBM — le GBM tend à sur-estimer)_ :
  - **intraday** (entrée dip −3.401% → cible +2.26% / stop −1.5%, p_fill 20%, n_eff≈9.1) : P(cible|rempli) **35%** · **EV/risk +0.053** (×p_fill ; si rempli +0.40% du capital)
...
- **BB** : %B 0.72 · largeur 21.8%
- **ATR** : 0.73 (3.0e pct 1a)  _(volatilite basse)_
- **OBV/CMF** : OBV rising · CMF 0.002  _(neutre)_
- **Vol ratio** : 0.62  _(volume normal)_
- **Choppiness** : 44.9  _(transition)_
- **MA** : MA20 17.57 · MA50 17.58 · MA200 20.63  _(prix > MA20)_
- **Dist MA** : MA20 +4.8% · MA50 +4.8% · MA200 -10.7%


---

_Bulletin compact généré depuis `<TICKER>_report_data.json` (101018 bytes source)._  
